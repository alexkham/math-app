  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.learnmathclass.com/visual-tools/matrix-transposition" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.learnmathclass.com/visual-tools/matrix-transposition" />
        <meta property="og:title" content="Matrix Transposition Calculator | LearnMathClass.com" />
        <meta property="og:description" content={description} />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://www.learnmathclass.com/visual-tools/matrix-transposition" />

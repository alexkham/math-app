...
// export default function SquareRootVisualizerPage() {
...
//       const keyWords=['square root','rational root','irrational root',
//         'perfect squares','non perfect square','imperfect square',
...
//    <h1 className='title' style={{marginTop:'-20px',marginBottom:'-30px'}}>Square Root Visualizer</h1>

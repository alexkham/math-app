...
// //   const keyWords=['units converter','mathematical units',
// //     'radians to degree','degree to radians']
...
// //             content:"Convert degrees to radians and radians to degrees.See explanations, concersion formulas and visual illustrations "
// //           },
// //     ]
// //   return (
// //     <>
...
// export default function ConvertersPage() {
//   const keyWords = ['units converter', 'mathematical units', 'radians to degree', 'degree to radians']
...
//           <h2 className="section-title">Understanding Mathematical Units and Conversions</h2>
//           <p className="section-text">
//             Mathematical units are standardized quantities used to measure and express various physical and mathematical properties. Whether you're working in engineering, physics, mathematics, or everyday calculations, the ability to convert between different units is essential for accurate problem-solving and communication.
//           </p>
//         </section>

//         <section className="content-section">
//           <div className="feature-box">
//             <h2 className="section-title">Why Convert Between Units?</h2>
//             <p className="section-text">
//               Different fields and regions often use different units to measure the same quantity. For instance, while mathematicians and physicists commonly work with radians for angle measurements, engineers and designers frequently use degrees. Converting between units allows us to:
//             </p>
//             <ul className="feature-list">
//               <li>Maintain precision across different measurement systems</li>
//               <li>Collaborate effectively across disciplines and regions</li>
//               <li>Solve complex problems that involve multiple unit types</li>
//               <li>Translate theoretical concepts into practical applications</li>
//             </ul>
//           </div>
//         </section>

//         <section className="content-section">
//           <h2 className="section-title">Available Converters</h2>
//           <div className="feature-box">
//             <h3 className="section-title">
//               <Link href="/converters/degree-radians" className="converter-link" style={{textDecoration: 'none', color: '#2563eb'}}>
//                 Angle Converter
//               </Link>
//             </h3>
            
//             <p className="section-text">
//               Our angle converter provides a dynamic, interactive tool for converting between degrees and radians, the two primary units used to measure angles. This intuitive converter features:
//             </p>
            
//             <ul className="feature-list">
//               <li>Real-time conversion as you type</li>
//               <li>Visual representation of angles with an interactive diagram</li>
//               <li>Support for multiple rotations and negative angles</li>
//               <li>Clear conversion formulas and explanations</li>
//               <li>Common angle reference values</li>
//               <li>Built-in normalization for angles exceeding 360°</li>
//             </ul>
            
//             <p className="section-text">
//               The converter helps you understand the relationship between these crucial angular measurements, making it invaluable for students, professionals, and anyone working with geometric calculations or trigonometry.
//             </p>
//             <Link href="/converters/degree-radians" className="converter-link" style={{textDecoration: 'none', color: '#2563eb'}}>
...
//             More converters coming soon! Our collection will expand to include various mathematical and scientific unit conversions, each with detailed explanations and interactive features.
//           </p>
//         </section>
//       </div>

...
export async function getStaticProps() {
  ...
  const symbolsData = {
    "differentiation": [
      ...
      {"symbol": "$D^n f(x)$", "latex_code": "D^n f(x)", "explanation": "nth derivative of \( f(x) \)"},
    ...
    "integration": [
      ...
      {"symbol": "$∫_a^b f(x) dx$", "latex_code": "\\int_a^b f(x)\\, dx", "explanation": "Definite integral of \( f(x) \) from \( a \) to \( b \)"},
      ...
      {"symbol": "$∫_C f ds$", "latex_code": "\\int_C f\\, ds", "explanation": "Integral along a curve \( C \)"}
    ],
    "limits": [
      {"symbol": "$lim_{x → c} f(x)$", "latex_code": "\\lim_{x \\to c} f(x)", "explanation": "Limit of \( f(x) \) as \( x \) approaches \( c \)"},
      {"symbol": "$lim_{x → ∞} f(x)$", "latex_code": "\\lim_{x \\to \\infty} f(x)", "explanation": "Limit of \( f(x) \) as \( x \) approaches infinity"},
      {"symbol": "$lim_{x → c^-} f(x)$", "latex_code": "\\lim_{x \\to c^-} f(x)", "explanation": "Left-hand limit of \( f(x) \) as \( x \) approaches \( c \)"},
      {"symbol": "$lim_{x → c^+} f(x)$", "latex_code": "\\lim_{x \\to c^+} f(x)", "explanation": "Right-hand limit of \( f(x) \) as \( x \) approaches \( c \)"}
    ],
    "series": [
      {"symbol": "$∑_{n=1}^∞ a_n$", "latex_code": "\\sum_{n=1}^\\infty a_n", "explanation": "Infinite series"},
      {"symbol": "$∑_{n=0}^N a_n$", "latex_code": "\\sum_{n=0}^N a_n", "explanation": "Finite series up to \( N \) terms"},
      {"symbol": "$Π_{n=1}^∞ a_n$", "latex_code": "\\prod_{n=1}^\\infty a_n", "explanation": "Infinite product"},
      {"symbol": "$a₀ + ∑_{n=1}^∞ a_n x^n$", "latex_code": "a_0 + \\sum_{n=1}^\\infty a_n x^n", "explanation": "Power series representation of a function"}
    ],
    "vector_calculus": [
      {"symbol": "∇⋅F", "latex_code": "\\nabla \\cdot \\mathbf{F}", "explanation": "Divergence of a vector field \( \\mathbf{F} \)"},
      {"symbol": "∇×F", "latex_code": "\\nabla \\times \\mathbf{F}", "explanation": "Curl of a vector field \( \\mathbf{F} \)"},
      {"symbol": "∬_S F ⋅ dS", "latex_code": "\\iint_S \\mathbf{F} \\cdot \\mathbf{dS}", "explanation": "Flux of \( \\mathbf{F} \) through a surface \( S \)"},
      {"symbol": "∮_C F ⋅ dr", "latex_code": "\\oint_C \\mathbf{F} \\cdot \\mathbf{dr}", "explanation": "Line integral of \( \\mathbf{F} \) along a curve \( C \)"}
    ],
    "other_notations": [
    ...
    "advanced_integration": [
      {"symbol": "$∭_V f dV$", "latex_code": "\\iiint_V f\\, dV", "explanation": "Triple integral over a volume \( V \)"},
      {"symbol": "$∯_S f dS$", "latex_code": "\\iint_S f\\, dS", "explanation": "Surface integral over surface \( S \)"},
      {"symbol": "$∮_C f dx$", "latex_code": "\\oint_C f\\, dx", "explanation": "Closed line integral"},
      {"symbol": "$∫_a^b |f(x)| dx$", "latex_code": "\\int_a^b |f(x)|\\, dx", "explanation": "Integral of absolute value of \( f(x) \)"},

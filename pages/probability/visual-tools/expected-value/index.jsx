...
//    <br/>
//    <br/>
//    <h1 className='title' style={{marginTop:'0px',marginBottom:'10px'}}>Expected Value Visualizations</h1>
//    <br/>
//    <br/>
...
const hubMeta = {
  ...
  svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="42" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="9" y="38" width="6" height="8" fill="#85B7EB" stroke="#185FA5" stroke-width="0.6"/><rect x="17" y="30" width="6" height="16" fill="#85B7EB" stroke="#185FA5" stroke-width="0.6"/><rect x="25" y="26" width="6" height="20" fill="#85B7EB" stroke="#185FA5" stroke-width="0.6"/><line x1="7" y1="46" x2="35" y2="46" stroke="#B5D4F4" stroke-width="1"/><path d="M 21 48 L 16 56 L 26 56 Z" fill="#FAC775" stroke="#854F0B" stroke-width="1"/><line x1="45" y1="34" x2="73" y2="34" stroke="#B5D4F4" stroke-width="1.6"/><rect x="48" y="26" width="6" height="8" fill="#85B7EB" stroke="#0C447C" stroke-width="0.7"/><rect x="57" y="22" width="8" height="12" fill="#97C459" stroke="#27500A" stroke-width="0.7"/><rect x="68" y="28" width="5" height="6" fill="#ED93B1" stroke="#72243E" stroke-width="0.7"/><path d="M 59 36 L 54 48 L 64 48 Z" fill="#FAC775" stroke="#854F0B" stroke-width="1"/><text x="40" y="70" font-family="Georgia,serif" font-size="10" fill="#E6F1FB" text-anchor="middle" font-style="italic">E[X]</text></svg>`,
}

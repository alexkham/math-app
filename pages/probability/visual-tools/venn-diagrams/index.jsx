...
// import VennSelectorFrame from '@/app/components/probability/venn-explorer/VennSelectorFrame'
...
// const vennModes = [
//   { queryParam: 'two-sets', mode: 2, label: '2 Parameters' },
//   { queryParam: 'three-sets', mode: 3, label: '3 Parameters' },
// //   { queryParam: 'four-sets', mode: 4, label: '4 Parameters' }
// ];
...
// export default function VennDiagramsPage({seoData,sectionsContent , introContent,vennModes}) {
...
//    <br/>
//    <br/>
//    <h1 className='title' style={{marginTop:'-10px',marginBottom:'0px'}}>Venn Diagrams</h1>
//    <br/>
//   <VennSelectorFrame modes={vennModes} defaultMode={2} />
//    <br/>
  ...
  const genericSections=[
    {
        id:'1',
        title:'What are Venn Diagrams?',
        link:'#what-are-venn-diagrams',
        content: sectionsContent.obj1.content
    },
    {
        id:'2',
        title:'Types of Venn Diagrams',
        link:'#types-of-venn-diagrams',
        content: sectionsContent.obj2.content
    },
    {
        id:'3',
        title:'Applications in Probability',
        link:'#applications-in-probability',

...
const hubMeta = {
  ...
  svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="42" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><circle cx="16" cy="36" r="11" fill="#85B7EB" fill-opacity="0.45" stroke="#0C447C" stroke-width="1.1"/><circle cx="26" cy="36" r="11" fill="#FAC775" fill-opacity="0.45" stroke="#854F0B" stroke-width="1.1"/><circle cx="54" cy="31" r="9" fill="#85B7EB" fill-opacity="0.4" stroke="#0C447C" stroke-width="1"/><circle cx="64" cy="31" r="9" fill="#FAC775" fill-opacity="0.4" stroke="#854F0B" stroke-width="1"/><circle cx="59" cy="41" r="9" fill="#97C459" fill-opacity="0.4" stroke="#27500A" stroke-width="1"/><text x="40" y="70" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">2 &#183; 3 sets</text></svg>`,
}

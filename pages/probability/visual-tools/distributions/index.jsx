...
const hubMeta = {
  svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="18" width="22" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="29" y="18" width="22" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="54" y="18" width="22" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="8" y="42" width="4" height="10" fill="#85B7EB" stroke="#185FA5" stroke-width="0.6"/><rect x="13" y="34" width="4" height="18" fill="#85B7EB" stroke="#185FA5" stroke-width="0.6"/><rect x="18" y="38" width="4" height="14" fill="#85B7EB" stroke="#185FA5" stroke-width="0.6"/><line x1="6" y1="52" x2="24" y2="52" stroke="#B5D4F4" stroke-width="0.9"/><path d="M 31 52 C 35 52, 36 26, 40 26 C 44 26, 45 52, 49 52" fill="none" stroke="#FAC775" stroke-width="1.8"/><line x1="31" y1="52" x2="49" y2="52" stroke="#B5D4F4" stroke-width="0.9"/><path d="M 57 26 C 61 42, 66 50, 74 52" fill="none" stroke="#97C459" stroke-width="1.8"/><line x1="56" y1="52" x2="74" y2="52" stroke="#B5D4F4" stroke-width="0.9"/><text x="40" y="70" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">nine distributions</text></svg>`,
}

...
const hubMeta = {
  ...
  svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="42" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><path d="M 28 40.5 C 31 46, 34 50, 36 50 L 28 50 Z" fill="#ED93B1" fill-opacity="0.7"/><path d="M 7 50 C 13 50, 15 22, 20 22 C 26 22, 31 46, 36 50" fill="none" stroke="#85B7EB" stroke-width="1.7"/><line x1="28" y1="18" x2="28" y2="50" stroke="#ED93B1" stroke-width="1.1" stroke-dasharray="2.5,2"/><line x1="6" y1="50" x2="37" y2="50" stroke="#B5D4F4" stroke-width="1"/><path d="M 45 50 C 48 50, 50 42, 51.5 36 L 51.5 50 Z" fill="#ED93B1" fill-opacity="0.7"/><path d="M 66.5 36 C 68 42, 70 50, 73 50 L 66.5 50 Z" fill="#ED93B1" fill-opacity="0.7"/><path d="M 45 50 C 51 50, 54 22, 59 22 C 64 22, 67 50, 73 50" fill="none" stroke="#85B7EB" stroke-width="1.7"/><line x1="51.5" y1="18" x2="51.5" y2="50" stroke="#ED93B1" stroke-width="1" stroke-dasharray="2.5,2"/><line x1="66.5" y1="18" x2="66.5" y2="50" stroke="#ED93B1" stroke-width="1" stroke-dasharray="2.5,2"/><line x1="44" y1="50" x2="75" y2="50" stroke="#B5D4F4" stroke-width="1"/><text x="40" y="70" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">tail bounds</text></svg>`,
}

...
const hubMeta = {
  svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="12" width="32" height="26" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="42" y="12" width="32" height="26" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="6" y="40" width="32" height="26" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="42" y="40" width="32" height="26" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><line x1="13" y1="25" x2="25" y2="19" stroke="#B5D4F4" stroke-width="1"/><line x1="13" y1="25" x2="25" y2="31" stroke="#B5D4F4" stroke-width="1"/><circle cx="12" cy="25" r="2.6" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><circle cx="27" cy="19" r="2.2" fill="#85B7EB" stroke="#0C447C" stroke-width="0.8"/><circle cx="27" cy="31" r="2.2" fill="#97C459" stroke="#27500A" stroke-width="0.8"/><circle cx="54" cy="25" r="8" fill="#85B7EB" fill-opacity="0.45" stroke="#0C447C" stroke-width="0.9"/><circle cx="62" cy="25" r="8" fill="#FAC775" fill-opacity="0.5" stroke="#854F0B" stroke-width="0.9"/><g stroke="#185FA5" stroke-width="0.5"><rect x="12" y="44" width="6" height="6" fill="#FAC775"/><rect x="19" y="44" width="6" height="6" fill="#FAC775"/><rect x="26" y="44" width="6" height="6" fill="#E6F1FB"/><rect x="12" y="51" width="6" height="6" fill="#FAC775"/><rect x="19" y="51" width="6" height="6" fill="#E6F1FB"/><rect x="26" y="51" width="6" height="6" fill="#E6F1FB"/><rect x="12" y="58" width="6" height="6" fill="#85B7EB"/><rect x="19" y="58" width="6" height="6" fill="#E6F1FB"/><rect x="26" y="58" width="6" height="6" fill="#E6F1FB"/></g><g stroke="#185FA5" stroke-width="0.7"><rect x="48" y="46" width="11" height="8" fill="#85B7EB" fill-opacity="0.5"/><rect x="59" y="46" width="11" height="8" fill="#E6F1FB"/><rect x="48" y="54" width="11" height="8" fill="#E6F1FB"/><rect x="59" y="54" width="11" height="8" fill="#C0DD97" fill-opacity="0.6"/></g><text x="40" y="76" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">P(A | B)</text></svg>`,
}

...
const hubMeta = {
  svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><rect x="42" y="16" width="34" height="40" rx="2" fill="#ffffff" fill-opacity="0.07" stroke="#B5D4F4" stroke-width="0.9"/><line x1="11" y1="32" x2="11" y2="50" stroke="#AFA9EC" stroke-width="1.4"/><line x1="19" y1="24" x2="19" y2="50" stroke="#AFA9EC" stroke-width="1.4"/><line x1="27" y1="36" x2="27" y2="50" stroke="#AFA9EC" stroke-width="1.4"/><circle cx="11" cy="32" r="2.6" fill="#AFA9EC" stroke="#3C3489" stroke-width="0.9"/><circle cx="19" cy="24" r="2.6" fill="#AFA9EC" stroke="#3C3489" stroke-width="0.9"/><circle cx="27" cy="36" r="2.6" fill="#AFA9EC" stroke="#3C3489" stroke-width="0.9"/><line x1="6" y1="50" x2="36" y2="50" stroke="#B5D4F4" stroke-width="1"/><path d="M 45 50 C 51 50, 53 24, 59 24 C 65 24, 67 50, 73 50 Z" fill="#FAC775" fill-opacity="0.45"/><path d="M 45 50 C 51 50, 53 24, 59 24 C 65 24, 67 50, 73 50" fill="none" stroke="#FAC775" stroke-width="1.8"/><line x1="44" y1="50" x2="75" y2="50" stroke="#B5D4F4" stroke-width="1"/><text x="40" y="70" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">PMF &#183; PDF</text></svg>`,
}

...
Probability is widely applied in science, engineering, finance, and everyday decision-making. It forms the basis for statistics, enabling data-driven insights and predictions, and supports fields like machine learning, risk analysis, and quantum mechanics. By studying probability, students develop skills to reason about uncertainty and draw conclusions from incomplete information.`
  ...
  const canonicalUrl = 'https://www.learnmathclass.com/probability/basics'
...
export default function ProbabilityBasicsPage({ 
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Probability Basics - Learn Mathematics",
  ...
  const pageTitle = "Probability Basics: Concepts, Rules & Distributions | Learn Math Class"
  const pageDescription = "The full conceptual tour of probability: sample spaces, events, axioms, rules, combinatorial counting, random variables, distributions, conditional probability, and the probability function - with diagrams and interactive lists."
    ...
    <>
      ...
      <main>
        <h1 className='title' style={{marginTop:'0px',marginBottom:'10px'}}>
          Probability Basics: Concepts, Rules, and Distributions
        </h1>

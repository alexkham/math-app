  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><g transform="translate(3.2 22.2) scale(0.42)"><circle cx="29" cy="31" r="18" fill="#ffffff" fill-opacity="0.12" stroke="#B5D4F4" stroke-width="2.6"/><circle cx="51" cy="31" r="18" fill="#ffffff" fill-opacity="0.12" stroke="#B5D4F4" stroke-width="2.6"/><circle cx="40" cy="49" r="18" fill="#ffffff" fill-opacity="0.12" stroke="#B5D4F4" stroke-width="2.6"/><path d="M 33.05 32.40 A 18 18 0 0 1 46.95 32.40 A 18 18 0 0 1 40 45.25 A 18 18 0 0 1 33.05 32.40 Z" fill="#FAC775" stroke="#854F0B" stroke-width="2.6"/></g><g transform="translate(43.2 22.2) scale(0.42)"><circle cx="29" cy="31" r="18" fill="#ffffff" fill-opacity="0.12" stroke="#B5D4F4" stroke-width="2.6"/><circle cx="51" cy="31" r="18" fill="#ffffff" fill-opacity="0.12" stroke="#B5D4F4" stroke-width="2.6"/><circle cx="40" cy="49" r="18" fill="#ffffff" fill-opacity="0.12" stroke="#B5D4F4" stroke-width="2.6"/><path d="M 33.05 32.40 A 18 18 0 0 1 46.95 32.40 A 18 18 0 0 1 40 45.25 A 18 18 0 0 1 33.05 32.40 Z" fill="#FAC775" stroke="#854F0B" stroke-width="2.6"/></g><text x="40" y="43" font-family="Georgia,serif" font-size="13" fill="#E6F1FB" text-anchor="middle">=</text><circle cx="40" cy="68" r="7" fill="#97C459" stroke="#27500A" stroke-width="1.2"/><path d="M36.5 68 L39 71 L43.5 64.5" fill="none" stroke="#173404" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>`
      },
    }
  }
}

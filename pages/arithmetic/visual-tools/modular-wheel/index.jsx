...
The square cup $\\sqcup$ is a union carrying a promise: it is written in place of $\\cup$ precisely when the pieces are known to be disjoint, so the line asserts both that the classes cover $\\mathbb{Z}$ and that they never overlap. Ordinary $\\cup$ would be equally true here and would say less.

  ...
  return {
    props: {
      ...
      seoData: {
        ...
        subCategory: "",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="5" y="9" width="52" height="14" rx="3" fill="#E6F1FB" stroke="#185FA5" stroke-width="1"/><text x="31" y="18.5" font-family="Georgia,serif" font-size="7" fill="#042C53" text-anchor="middle">48 = 1·30 + 18</text><rect x="60" y="11" width="15" height="10" rx="5" fill="#FAC775" stroke="#854F0B" stroke-width="1"/><text x="67.5" y="18.3" font-family="Georgia,serif" font-size="6.5" fill="#412402" text-anchor="middle">18</text><line x1="40" y1="24" x2="40" y2="31" stroke="#B5D4F4" stroke-width="1" stroke-dasharray="2,1.5"/><rect x="5" y="32" width="52" height="14" rx="3" fill="#E6F1FB" stroke="#185FA5" stroke-width="1"/><text x="31" y="41.5" font-family="Georgia,serif" font-size="7" fill="#042C53" text-anchor="middle">30 = 1·18 + 12</text><rect x="60" y="34" width="15" height="10" rx="5" fill="#FAC775" stroke="#854F0B" stroke-width="1"/><text x="67.5" y="41.3" font-family="Georgia,serif" font-size="6.5" fill="#412402" text-anchor="middle">12</text><line x1="40" y1="47" x2="40" y2="54" stroke="#B5D4F4" stroke-width="1" stroke-dasharray="2,1.5"/><rect x="5" y="55" width="70" height="17" rx="3" fill="#CECBF6" stroke="#534AB7" stroke-width="1.2"/><text x="40" y="67" font-family="Georgia,serif" font-size="9" fill="#26215C" text-anchor="middle" font-style="italic">gcd = 6</text></svg>`
      },
    }
  }
}

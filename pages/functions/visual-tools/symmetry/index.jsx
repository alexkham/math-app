  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><line x1="8" y1="56" x2="74" y2="56" stroke="#B5D4F4" stroke-width="0.9"/><line x1="40" y1="10" x2="40" y2="64" stroke="#B5D4F4" stroke-width="1.1" stroke-dasharray="3,2.5"/><path d="M 14 20 Q 27 41 40 41" fill="none" stroke="#97C459" stroke-width="2"/><path d="M 40 41 Q 53 41 66 20" fill="none" stroke="#FAC775" stroke-width="2"/><path d="M 24 16 L 20 16 L 22 13 M 20 16 L 22 19" fill="none" stroke="#B5D4F4" stroke-width="1"/><path d="M 56 16 L 60 16 L 58 13 M 60 16 L 58 19" fill="none" stroke="#B5D4F4" stroke-width="1"/><line x1="20" y1="16" x2="60" y2="16" stroke="#B5D4F4" stroke-width="0.9" stroke-dasharray="2.5,2"/><text x="40" y="72" font-family="Georgia,serif" font-size="8" fill="#E6F1FB" text-anchor="middle" font-style="italic">even</text></svg>`,
        name: "Function Symmetry Visualizer",

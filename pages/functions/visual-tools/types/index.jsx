  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="14" width="22" height="24" rx="2" fill="#ffffff" fill-opacity="0.08" stroke="#B5D4F4" stroke-width="0.8"/><rect x="29" y="14" width="22" height="24" rx="2" fill="#ffffff" fill-opacity="0.08" stroke="#B5D4F4" stroke-width="0.8"/><rect x="52" y="14" width="22" height="24" rx="2" fill="#ffffff" fill-opacity="0.08" stroke="#B5D4F4" stroke-width="0.8"/><rect x="6" y="42" width="22" height="24" rx="2" fill="#ffffff" fill-opacity="0.08" stroke="#B5D4F4" stroke-width="0.8"/><rect x="29" y="42" width="22" height="24" rx="2" fill="#ffffff" fill-opacity="0.08" stroke="#B5D4F4" stroke-width="0.8"/><rect x="52" y="42" width="22" height="24" rx="2" fill="#ffffff" fill-opacity="0.08" stroke="#B5D4F4" stroke-width="0.8"/><line x1="9" y1="34" x2="25" y2="18" stroke="#85B7EB" stroke-width="1.6"/><path d="M 32 34 Q 40 14 48 34" fill="none" stroke="#FAC775" stroke-width="1.6"/><path d="M 55 32 C 59 36, 61 18, 65 22 C 68 25, 70 18, 71 17" fill="none" stroke="#97C459" stroke-width="1.6"/><path d="M 9 63 C 17 63, 21 58, 25 45" fill="none" stroke="#AFA9EC" stroke-width="1.6"/><path d="M 32 54 C 35 45, 38 45, 40 54 C 42 63, 45 63, 48 54" fill="none" stroke="#ED93B1" stroke-width="1.6"/><path d="M 55 63 C 59 62, 61 59, 62 54" fill="none" stroke="#F0997B" stroke-width="1.6"/><path d="M 64 50 C 65 47, 67 45, 71 44" fill="none" stroke="#F0997B" stroke-width="1.6"/></svg>`,
        name: "Functions Families Gallery",

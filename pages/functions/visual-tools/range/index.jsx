  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><line x1="16" y1="56" x2="74" y2="56" stroke="#B5D4F4" stroke-width="0.9"/><line x1="40" y1="10" x2="40" y2="68" stroke="#B5D4F4" stroke-width="0.9"/><path d="M 18 26 Q 40 62 66 26" fill="none" stroke="#85B7EB" stroke-width="1.9"/><rect x="37" y="14" width="6" height="30" rx="3" fill="#AFA9EC" fill-opacity="0.6" stroke="#3C3489" stroke-width="1"/><line x1="10" y1="10" x2="10" y2="68" stroke="#B5D4F4" stroke-width="0.9"/><line x1="10" y1="14" x2="10" y2="44" stroke="#AFA9EC" stroke-width="3"/><circle cx="10" cy="44" r="2.6" fill="#AFA9EC" stroke="#3C3489" stroke-width="1"/><circle cx="10" cy="28" r="2.6" fill="#FAC775" stroke="#854F0B" stroke-width="1"/></svg>`,
        name: "Range of a Function Visualizer",

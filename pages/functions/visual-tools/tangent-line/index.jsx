  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><line x1="8" y1="52" x2="74" y2="52" stroke="#B5D4F4" stroke-width="0.9"/><line x1="14" y1="8" x2="14" y2="56" stroke="#B5D4F4" stroke-width="0.9"/><line x1="38.82" y1="28" x2="38.82" y2="62" stroke="#B5D4F4" stroke-width="0.9" stroke-dasharray="2.5,2"/><path d="M 16 46 Q 40 10 70 30" fill="none" stroke="#85B7EB" stroke-width="1.9"/><line x1="26" y1="30.13" x2="52" y2="19.61" stroke="#FAC775" stroke-width="1.8"/><circle cx="38.82" cy="24.94" r="3" fill="#FAC775" stroke="#854F0B" stroke-width="1.2"/><line x1="14" y1="66" x2="70" y2="66" stroke="#B5D4F4" stroke-width="2.6" stroke-linecap="round"/><circle cx="38.82" cy="66" r="4.2" fill="#FAC775" stroke="#854F0B" stroke-width="1.3"/><text x="38.82" y="77" font-family="Georgia,serif" font-size="7" fill="#E6F1FB" text-anchor="middle" font-style="italic">x&#8320;</text></svg>`,
        name: "Tangent Line Visualizer",

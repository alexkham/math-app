...
export async function getStaticProps(){
  ...
  const schemas = {
    webApplication: {
      ...
      "@type": "WebApplication",
      "name": "Common Derivatives Table and Practice Tool",
      "description": "Reference table of 22 common derivative identities across polynomial, linear, exponential, logarithmic, trigonometric, and inverse trigonometric functions, with search, filters, a drag puzzle, and a quiz.",
      "url": "https://www.learnmathclass.com/tables/common-derivatives",
      "applicationCategory": "EducationalApplication",
      "operatingSystem": "Any",
      "offers": {
        "@type": "Offer",
      ...
      "featureList": [
        "Four-mode search: look up a derivative by f(x), by f-prime(x), by entry name, or by category",
        "Reference table of 22 common derivative identities across polynomial, linear, exponential, logarithmic, trigonometric, and inverse trigonometric functions",
        "Six category filters plus a reciprocal-forms filter that highlights derivatives whose result is a fraction",
        ...
        "Reference panel covering the four structural differentiation rules: linearity, product rule, quotient rule, and chain rule",
        "Three-type rotating quiz (derivative, antiderivative, category) with a running score, plus print, copy-CSV, and download-CSV actions"
      ],
      "author": {
        "@type": "Organization",
        "name": "Learn Math Class"
    ...
    breadcrumb: {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Common Derivatives",
          "item": "https://www.learnmathclass.com/tables/common-derivatives"
        }
      ]
    },
   ...
   return {
      props:{
         ...
         seoData: {
           title: "Common Derivatives Table & Puzzle | Learn Math Class",
           description: "Look up 22 common derivatives by f(x) or f-prime(x). Polynomial, exponential, log, trig, and inverse trig identities with a drag puzzle and quiz.",
           keywords: keyWords.join(", "),
           url: "/tables/common-derivatives",
           name: "Common Derivatives Table and Practice Tool",
           hubDescription: "Look up 22 common derivatives by f(x), by f-prime(x), by name, or by category. Polynomial, linear, exponential, logarithmic, trigonometric, and inverse trigonometric identities organized in cards or rows, with a drag-puzzle mode for drilling, a three-type rotating quiz, and one-click print, copy, or CSV export.",
           category: "Calculus",
           subCategory: ""
         }
       }

...
const probabilityTables = [
  ...
  },
  {
    ...
    icon: BinomialIcon,
    path: '/probability/tables/binomial-distribution'
  },
 ...
 
  {
    ...
    icon: PoissonIcon,
    path: '/probability/tables/poisson-distribution'
  },

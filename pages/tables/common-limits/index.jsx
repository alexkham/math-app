...
// //    <br/>
// //    <br/>
// //    <h1 className='title' style={{marginTop:'0px',marginBottom:'0px'}}>Common Limits </h1>
// //    <br/>
...
// import KeyTermsCard from '@/app/components/page-components/KeyTermsCard'
// import GenericTableExplorer from '../../../app/components/tables/table-explorer/GenericTableExplorer'
// import LIMITS_DATASET from '../../../app/components/tables/table-explorer/data/limitsDataset'
...
export async function getStaticProps(){
  ...
  const schemas = {
    webApplication: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "Common Limits Table and Practice Tool",
      "description": "Reference table of 28 common limit identities across basic, trigonometric, exponential, logarithmic, at-infinity, and one-sided categories, with search, filters, a drag puzzle, and a quiz.",
      "url": "https://www.learnmathclass.com/tables/common-limits",
      ...
      "featureList": [
        "Four-mode search: look up a limit by expression, by value, by entry name, or by category",
        "Reference table of 28 common limit identities across basic, trigonometric, exponential, logarithmic, at-infinity, and one-sided categories",
        ...
        "Reference panel covering six limit laws and theorems: sum and difference, product and constant multiple, quotient, the squeeze theorem, L Hopital's rule, and continuity",
        "Three-type rotating quiz (value, expression, category) with a running score, plus print, copy-CSV, and download-CSV actions"
      ],
      "author": {
        "@type": "Organization",
        "name": "Learn Math Class"
    ...
    breadcrumb: {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Common Limits",
          "item": "https://www.learnmathclass.com/tables/common-limits"
        }
      ]
    },
   ...
   return {
      props:{
         ...
         staticDataset,
          seoData: {
        title: "Common Limits Table & Puzzle | Learn Math Class",
        description: "Look up 28 common limits by expression or value. Basic, trigonometric, exponential, log, infinity, and one-sided limits with a drag puzzle and quiz.",
        keywords: keyWords.join(", "),
        url: "/tables/common-limits",
         name: "Common Limits Table and Practice Tool",
         hubDescription: "Look up 28 common limit identities by expression, by value, by name, or by category. Basic, trigonometric, exponential, logarithmic, at-infinity, and one-sided limits organized in cards or rows, with a drag-puzzle mode for drilling, a three-type rotating quiz, and one-click print, copy, or CSV export.",
         category: "Calculus",
         subCategory: ""
      },

...
export async function getStaticProps() {
  ...
  const contradictionExplanations = {
    ...
    '(P → Q) ∧ (P → ¬Q) ∧ P': {
      text: "This formula creates a contradiction by asserting that P implies both Q and not-Q, while also asserting that P is true. When P is true, the implications force Q to be both true and false simultaneously, which is impossible. This contradiction demonstrates how inconsistent premises lead to logical impossibility.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    '(P ∨ Q) ∧ ¬P ∧ ¬Q': {
      text: "This contradiction asserts that either P or Q must be true (through the disjunction P∨Q), while simultaneously claiming that both P and Q are false (through the conjunctions with ¬P and ¬Q). These claims directly contradict each other, making the entire formula unsatisfiable under any assignment of truth values.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    'P ↔ ¬P': {
      text: "This formula states that P is logically equivalent to its own negation, which is impossible. For the biconditional to be true, P and ¬P would need to have the same truth value. However, P and ¬P always have opposite truth values by definition, making this formula a contradiction in all possible interpretations.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    '(P ∧ Q) ∧ (¬P ∨ ¬Q)': {
      text: "This contradiction first asserts that both P and Q are true, then claims that at least one of them is false. These claims are mutually exclusive. The formula can be rewritten using De Morgan's laws to show that it's equivalent to claiming that P∧Q∧¬(P∧Q), which is clearly contradictory.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    '(P → Q) ∧ (Q → R) ∧ P ∧ ¬R': {
      text: "This formula creates a contradiction through a chain of implications. It states that P implies Q, and Q implies R, while asserting that P is true and R is false. Following the chain: if P is true, then Q must be true; if Q is true, then R must be true. But the formula also claims R is false, creating an irreconcilable contradiction.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    '(P → Q) ∧ (Q → R) ∧ ¬R ∧ P': {
      text: "Similar to the previous contradiction, this formula establishes a chain of implications from P to R, while simultaneously asserting that P is true and R is false. The chain of implications forces R to be true when P is true, directly contradicting the claim that R is false.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    '(P ↔ Q) ∧ (P ↔ ¬Q)': {
      text: "This contradiction asserts that P is logically equivalent to both Q and not-Q. This would require Q and not-Q to have the same truth value, which is impossible. The formula forces P to simultaneously equal both a statement and its negation, creating an irreconcilable logical conflict.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    '(P ∧ Q) ∧ (P ∧ ¬Q)': {
      text: "This formula directly contradicts itself by claiming that Q is both true and false while P is true. The first conjunction asserts that P and Q are both true, while the second conjunction claims that P is true and Q is false. Since Q cannot be simultaneously true and false, this formula is a contradiction.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    },
    '(¬(P → Q)) ∧ (P ∧ Q)': {
      text: "This contradiction arises from the definition of material implication. The negation of (P→Q) is true only when P is true and Q is false. However, the second part of the formula asserts that both P and Q are true. These conditions cannot be satisfied simultaneously, making the formula a contradiction.",
      links: [{ title: "Generate Your Own Logical Expressions and See the Truth Tables", link: "/logic/truth-tables" },
        { title: "Check our logic equivalence validator", link: "/logic/propositional-logic/equivalence-validator" }
      ]
    }

...
export default function ImplicationsTruthTablesPage({ seoData, keyWords, implicationExplanations }) {
  ...
  return {
    props: {
      ...
      implicationExplanations,
       seoData: {
      title: "Implications Truth Tables - Logical Implication P→Q | Learn Math Class",
      description: "Complete truth tables for logical implications including P→Q, contrapositive, converse, and negated forms with detailed explanations.",
      keywords: keyWords.join(", "),
      url: "/tables/truth-tables/implications",

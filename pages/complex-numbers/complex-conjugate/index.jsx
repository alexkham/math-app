...
const faqQuestions = {
  obj1: {
    question: "What do the notations z̄ and z* mean?",
    answer: "Both denote the conjugate of z, obtained by flipping the sign of the imaginary part. The overbar dominates in mathematics while the asterisk is standard in physics and engineering, and some texts write conj(z). All three name the same operation, so the choice signals the field rather than any difference in meaning.",
    sectionId: "notation"
  },
  obj2: {
    question: "What is z multiplied by its conjugate equal to?",
    answer: "The square of the modulus, which is always a real, non-negative number. For a + bi the cross terms cancel and what remains is a² + b². This single fact is why the conjugate clears denominators in division and why it links directly to distance in the complex plane.",
    sectionId: "4"
  },
  obj3: {
    question: "Is the conjugate the same as negation?",
    answer: "No. Negating flips both components, sending a + bi to −a − bi, which reflects the point through the origin. Conjugating flips only the imaginary part, reflecting across the horizontal axis instead. The two coincide only for pure imaginary numbers, where there is no real part to distinguish them.",
    sectionId: "1"
  },
  obj4: {
    question: "How do you tell if a complex number is real or pure imaginary using its conjugate?",
    answer: "A number equals its own conjugate exactly when it is real, since flipping a zero imaginary part changes nothing. It equals the negative of its conjugate exactly when it is pure imaginary. These two tests turn a question about components into a single equation, which is often easier to apply inside a proof.",
    sectionId: "5"
  },
  obj5: {
    question: "Why do complex roots of real polynomials come in conjugate pairs?",
    answer: "Because conjugation passes through addition and multiplication unchanged, so conjugating the whole polynomial equation leaves the real coefficients alone while turning a root into its conjugate. If one satisfies the equation the other must too. This is why real polynomials always have an even number of non-real roots.",
    sectionId: "8"
  }
}

  ...
  const explanations = {
   ...
   return {
      props:{
        ...
        keywords: keyWords.join(", "),
        url: "/complex-numbers/visual-tools/polar-rectangular",
        hubDescription: "Convert between rectangular form a + bi and polar form r·eⁱᶿ interactively. Drag a point on the Argand plane to see modulus, argument, and live conversion formulas update in real time, with the right triangle bridging both representations.",
        category: "Plane & Representation",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><line x1="8" y1="48" x2="74" y2="48" stroke="#B5D4F4" stroke-width="0.9"/><line x1="34" y1="12" x2="34" y2="60" stroke="#B5D4F4" stroke-width="0.9"/><line x1="34" y1="48" x2="58" y2="48" stroke="#85B7EB" stroke-width="1.2" stroke-dasharray="2.5,2"/><line x1="58" y1="48" x2="58" y2="24" stroke="#97C459" stroke-width="1.2" stroke-dasharray="2.5,2"/><line x1="34" y1="48" x2="58" y2="24" stroke="#FAC775" stroke-width="1.9"/><path d="M 44 48 A 10 10 0 0 0 41.07 40.93" fill="none" stroke="#FAC775" stroke-width="1.2"/><circle cx="58" cy="24" r="3" fill="#FAC775" stroke="#854F0B" stroke-width="1.2"/><text x="46" y="34" font-family="Georgia,serif" font-size="6.5" fill="#FAC775" text-anchor="middle" font-style="italic">r</text><text x="45" y="45" font-family="Georgia,serif" font-size="5.5" fill="#FAC775" text-anchor="middle" font-style="italic">&#952;</text><rect x="3" y="63" width="32" height="13" rx="3" fill="#E6F1FB" stroke="#185FA5" stroke-width="1"/><text x="19" y="72" font-family="Georgia,serif" font-size="7" fill="#042C53" text-anchor="middle" font-style="italic">a + bi</text><rect x="45" y="63" width="32" height="13" rx="3" fill="#FAC775" stroke="#854F0B" stroke-width="1"/><text x="61" y="72" font-family="Georgia,serif" font-size="7" fill="#412402" text-anchor="middle" font-style="italic">r, &#952;</text><path d="M 37 67 L 43 67 M 41.5 65.5 L 43 67 L 41.5 68.5" fill="none" stroke="#E6F1FB" stroke-width="0.9"/><path d="M 43 72 L 37 72 M 38.5 70.5 L 37 72 L 38.5 73.5" fill="none" stroke="#E6F1FB" stroke-width="0.9"/></svg>`,
         name: "Polar-Rectangular Complex Number Converter"
      },

...
//       "Four equivalent characterizations of pure imaginary numbers"
//     ],
...
// export default function ImaginaryNumbersPage({
//   seoData,
//   sectionsContent,
//   introContent,
//   obj2Table,
...
const faqQuestions = {
  obj1: {
    question: "What is the imaginary unit i?",
    answer: "It is the number defined by the property that its square equals −1. No real number does this, since squaring any real gives a non-negative result, so i is introduced as a new object rather than discovered among existing numbers. Everything else about imaginary and complex numbers is built from this single definition.",
    sectionId: "1"
  },
  obj2: {
    question: "Why doesn't the rule √a · √b = √(ab) work for negative numbers?",
    answer: "Because that rule requires both values to be non-negative. Ignoring the condition gives √(−1)·√(−1) = √1 = 1, when the correct answer is −1. Convert each negative root to the form bi first, then multiply. Skipping that conversion is the most common error with square roots of negatives.",
    sectionId: "2"
  },
  obj3: {
    question: "How do you calculate i to a large power?",
    answer: "Divide the exponent by 4 and keep only the remainder, since the powers repeat in a cycle of four: i, −1, −i, 1. A remainder of 0 gives 1, of 1 gives i, of 2 gives −1, and of 3 gives −i. So i to the 2026 has remainder 2 and equals −1. Watch the cycle turn on the [powers of i explorer](!/complex-numbers/visual-tools/i-powers).",
    sectionId: "5"
  },
  obj4: {
    question: "Is zero a pure imaginary number?",
    answer: "It depends on the convention, which is why the question causes trouble. Zero can be written as 0i, so it satisfies the form, but many texts require a pure imaginary number to have a non-zero imaginary part and exclude it. Zero is the only number that is simultaneously real and imaginary under the looser definition.",
    sectionId: "4"
  },
  obj5: {
    question: "What are imaginary numbers actually used for?",
    answer: "They describe anything that rotates or oscillates. Alternating current, signal processing, control systems, and quantum mechanics all run on them, because rotation in the plane is exactly what multiplication by a complex number does. The name is a historical accident from a period when mathematicians distrusted them; nothing about them is less real than negative numbers.",
    sectionId: "1"
  }
}

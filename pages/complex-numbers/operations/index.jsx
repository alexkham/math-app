...
// **Forgetting that** $i^2 = -1$**:** The most frequent error in multiplication. After expanding $(a + bi)(c + di)$, the term $bdi^2$ must become $-bd$, not $+bd$. Every $i^2$ in any calculation converts to $-1$ without exception.
...
const faqQuestions = {
  obj1: {
    ...
    answer: "Because a number times its conjugate gives a real result, which clears i out of the denominator. Multiplying numerator and denominator by the conjugate of the denominator leaves the value unchanged while turning the bottom into a plain real number. The result can then be split back into standard form. Try it on the [division explorer](!/complex-numbers/visual-tools/division).",
    sectionId: "4"
  },
  obj2: {
    question: "Why isn't (a + bi)(c + di) just ac + bdi?",
    answer: "Because multiplication expands over all four pairs, not component by component. Every term multiplies every other, and the product of the two imaginary terms contains i squared, which collapses to −1 and moves into the real part. That extra contribution is exactly what makes complex multiplication a rotation rather than a stretch.",
    sectionId: "3"
  },
  obj3: {
    question: "How do you square a complex number?",
    answer: "Expand as you would any binomial, then replace i squared with −1. For a + bi the result is a² − b² for the real part and 2ab for the imaginary part. Squaring in polar form is faster: square the modulus and double the argument. Explore both on the [multiplication tool](!/complex-numbers/visual-tools/multiplication).",
    sectionId: "3"
  },
  obj4: {
    question: "Do the ordinary rules of algebra apply to complex numbers?",
    answer: "Yes. Addition and multiplication remain commutative and associative, multiplication still distributes over addition, and every non-zero number still has a reciprocal. The one rule that does not carry over is ordering: complex numbers cannot be arranged as greater or smaller, so inequalities have no meaning between them.",
    sectionId: "5"
  }
}

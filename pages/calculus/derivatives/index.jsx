...
export async function getStaticProps(){
  ...
  const introContent = {
    ...
    content: `Derivatives are one of the core ideas in calculus and are closely tied to two other fundamental concepts: [limits](!/claculus/limits) and [integrals](!/calculus/integrals).As discussed in the section [“Limits, Derivatives, and Integrals”](!/calculus#three_concepts) these three notions are interconnected—limits provide the mathematical precision needed to define both derivatives and integrals, which are essentially opposite processes—one describes how quantities change, while the other measures how they accumulate.

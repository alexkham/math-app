...
export async function getStaticProps() {
  // Content defined here for static generation
  const keyWords = [
    'propositional logic',
...
Whether you're working on simplifying complex logical statements, converting expressions to normal forms, or building formal proofs, these laws provide the essential toolkit for manipulating propositional logic expressions with confidence and precision.`
  ...
  const canonicalUrl = 'https://www.learnmathclass.com/logic/propositional-logic'
  const lastModified = new Date().toISOString()
...
export default function PropositionalLogicPage({ 
  ...
  // Sections defined here in the component, accessing content via keys
  const propositionalLogicSections = [
    {
      id: "laws",
      title: sectionContent.laws.title,
      link: sectionContent.laws.link,
      content: sectionContent.laws.description
    },
    {
      id: "equivalences",
      title: sectionContent.equivalences.title,
      link: sectionContent.equivalences.link,
      content: sectionContent.laws.content
    }
  ...
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "Propositional Logic - Learn Mathematics",
    "description": "Comprehensive guide to propositional logic covering syntax, semantics, equivalences, inference rules, and proof techniques.",
    "keywords": keyWords.join(", "),
    "url": canonicalUrl,
    "dateModified": lastModified,
    "inLanguage": "en-US",

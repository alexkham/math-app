  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="28" width="10" height="10" fill="#85B7EB" stroke="#185FA5" stroke-width="0.8"/><rect x="14" y="28" width="10" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="4" y="38" width="10" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="14" y="38" width="10" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><text x="27" y="42" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">+</text><rect x="30" y="28" width="10" height="10" fill="#85B7EB" stroke="#185FA5" stroke-width="0.8"/><rect x="40" y="28" width="10" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="30" y="38" width="10" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="40" y="38" width="10" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><text x="53" y="42" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">=</text><rect x="56" y="28" width="10" height="10" fill="#EF9F27" stroke="#854F0B" stroke-width="0.9"/><rect x="66" y="28" width="10" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="56" y="38" width="10" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="66" y="38" width="10" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><text x="40" y="64" font-family="Georgia,serif" font-size="8" fill="#E6F1FB" text-anchor="middle" font-style="italic">A + B</text></svg>`,
        name: "Matrix Addition and Subtraction Visualizer",

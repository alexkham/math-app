  ...
  return {
    props: {
      ...
      seoData: {
        ...
        keywords: keyWords.join(", "),
        url: "/linear-algebra/visual-tools/vector-addition",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><path d="M 12 18 L 8 18 L 8 58 L 12 58" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><path d="M 20 18 L 24 18 L 24 58 L 20 58" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><rect x="10" y="22" width="12" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><rect x="10" y="33" width="12" height="10" fill="#85B7EB" stroke="#185FA5" stroke-width="0.9"/><rect x="10" y="44" width="12" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><text x="30" y="42" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">+</text><path d="M 40 18 L 36 18 L 36 58 L 40 58" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><path d="M 48 18 L 52 18 L 52 58 L 48 58" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><rect x="38" y="22" width="12" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><rect x="38" y="33" width="12" height="10" fill="#85B7EB" stroke="#185FA5" stroke-width="0.9"/><rect x="38" y="44" width="12" height="10" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><text x="57" y="42" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">=</text><path d="M 66 18 L 62 18 L 62 58 L 66 58" fill="none" stroke="#854F0B" stroke-width="1.2"/><path d="M 74 18 L 78 18 L 78 58 L 74 58" fill="none" stroke="#854F0B" stroke-width="1.2"/><rect x="64" y="22" width="12" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.8"/><rect x="64" y="33" width="12" height="10" fill="#EF9F27" stroke="#854F0B" stroke-width="1"/><rect x="64" y="44" width="12" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.8"/><text x="40" y="70" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">u + v = w</text></svg>`,
        name: "Vector Addition and Subtraction Visualizer",

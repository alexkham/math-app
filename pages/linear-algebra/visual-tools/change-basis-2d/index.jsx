  ...
  const introContent = {
   ...
   return {
      props:{
        ...
        keywords: keyWords.join(", "),
        url: "/linear-algebra/visual-tools/change-basis-2d",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><line x1="24" y1="54" x2="46" y2="54" stroke="#85B7EB" stroke-width="2"/><path d="M 48 54 L 44 52 L 44 56 Z" fill="#85B7EB"/><line x1="24" y1="54" x2="24" y2="32" stroke="#85B7EB" stroke-width="2"/><path d="M 24 30 L 22 34 L 26 34 Z" fill="#85B7EB"/><line x1="24" y1="54" x2="42" y2="42" stroke="#FAC775" stroke-width="2.2"/><path d="M 44 40.6 L 39.5 41 L 41.5 44.5 Z" fill="#FAC775"/><line x1="24" y1="54" x2="34" y2="32" stroke="#FAC775" stroke-width="2.2"/><path d="M 35 30 L 31.5 33.5 L 35.5 34.5 Z" fill="#FAC775"/><circle cx="52" cy="30" r="3.2" fill="#ED93B1" stroke="#72243E" stroke-width="1.2"/><line x1="24" y1="54" x2="52" y2="30" stroke="#ED93B1" stroke-width="1" stroke-dasharray="2.5,2"/><rect x="4" y="64" width="30" height="12" rx="3" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.9"/><text x="19" y="72.5" font-family="Georgia,serif" font-size="6.5" fill="#042C53" text-anchor="middle" font-style="italic">e&#8321;, e&#8322;</text><rect x="46" y="64" width="30" height="12" rx="3" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><text x="61" y="72.5" font-family="Georgia,serif" font-size="6.5" fill="#412402" text-anchor="middle" font-style="italic">b&#8321;, b&#8322;</text><path d="M 36 70 L 44 70 M 42 68 L 44 70 L 42 72" fill="none" stroke="#E6F1FB" stroke-width="1"/></svg>`,
        name: "Change of Basis 2D Visualizer",

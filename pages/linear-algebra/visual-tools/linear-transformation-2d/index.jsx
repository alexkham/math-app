  ...
  const introContent = {
   ...
   return {
      props:{
        ...
        keywords: keyWords.join(", "),
        url: "/linear-algebra/visual-tools/linear-transformation-2d",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="34" width="24" height="24" fill="none" stroke="#B5D4F4" stroke-width="1.2" stroke-dasharray="3,2.5"/><line x1="8" y1="58" x2="20" y2="58" stroke="#85B7EB" stroke-width="2"/><path d="M 22 58 L 18 56 L 18 60 Z" fill="#85B7EB"/><line x1="8" y1="58" x2="8" y2="46" stroke="#97C459" stroke-width="2"/><path d="M 8 44 L 6 48 L 10 48 Z" fill="#97C459"/><path d="M 36 46 L 45 46 M 43 44 L 45 46 L 43 48" fill="none" stroke="#E6F1FB" stroke-width="1.3"/><path d="M 48 58 L 64 58 L 74 34 L 58 34 Z" fill="#FAC775" fill-opacity="0.3" stroke="#854F0B" stroke-width="1.3"/><line x1="48" y1="58" x2="61" y2="58" stroke="#85B7EB" stroke-width="2"/><path d="M 63 58 L 59 56 L 59 60 Z" fill="#85B7EB"/><line x1="48" y1="58" x2="54" y2="46" stroke="#97C459" stroke-width="2"/><path d="M 55 44 L 51.5 47 L 55.5 48 Z" fill="#97C459"/><text x="40" y="72" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">T(x) = Ax</text></svg>`,
        name: "Linear Transformation 2D Visualizer",

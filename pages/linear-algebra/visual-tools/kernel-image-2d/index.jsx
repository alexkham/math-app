  ...
  const introContent = {
   ...
   return {
      props:{
        ...
        keywords: keyWords.join(", "),
        url: "/linear-algebra/visual-tools/kernel-image-2d",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="14" x2="40" y2="66" stroke="#B5D4F4" stroke-width="1" stroke-dasharray="3,2.5"/><line x1="6" y1="40" x2="36" y2="40" stroke="#B5D4F4" stroke-width="0.9"/><line x1="21" y1="18" x2="21" y2="62" stroke="#B5D4F4" stroke-width="0.9"/><line x1="9" y1="56" x2="33" y2="24" stroke="#ED93B1" stroke-width="2" stroke-dasharray="4,2.5"/><circle cx="21" cy="40" r="2.4" fill="#ED93B1" stroke="#72243E" stroke-width="1"/><line x1="44" y1="40" x2="74" y2="40" stroke="#B5D4F4" stroke-width="0.9"/><line x1="59" y1="18" x2="59" y2="62" stroke="#B5D4F4" stroke-width="0.9"/><line x1="47" y1="52" x2="71" y2="28" stroke="#97C459" stroke-width="2.2"/><circle cx="59" cy="40" r="2.4" fill="#97C459" stroke="#27500A" stroke-width="1"/><text x="21" y="72" font-family="Georgia,serif" font-size="7" fill="#ED93B1" text-anchor="middle" font-style="italic">ker</text><text x="59" y="72" font-family="Georgia,serif" font-size="7" fill="#C0DD97" text-anchor="middle" font-style="italic">im</text></svg>`,
        name: "Kernel and Image 2D Visualizer",

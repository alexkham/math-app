  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><text x="6" y="30" font-family="Georgia,serif" font-size="9" fill="#85B7EB" font-style="italic">a</text><rect x="12" y="16" width="9" height="9" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><rect x="21" y="16" width="9" height="9" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><rect x="12" y="25" width="9" height="9" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><rect x="21" y="25" width="9" height="9" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><text x="34" y="30" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">+</text><text x="40" y="30" font-family="Georgia,serif" font-size="9" fill="#97C459" font-style="italic">b</text><rect x="47" y="16" width="9" height="9" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="56" y="16" width="9" height="9" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="47" y="25" width="9" height="9" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="56" y="25" width="9" height="9" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><text x="27" y="52" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">=</text><rect x="34" y="42" width="10" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="44" y="42" width="10" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="34" y="52" width="10" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="44" y="52" width="10" height="10" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><text x="40" y="74" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">aA + bB</text></svg>`,
        name: "Linear Combination of Matrices Visualizer",

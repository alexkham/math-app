  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><path d="M 14 20 L 10 20 L 10 56 L 14 56" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><path d="M 24 20 L 28 20 L 28 56 L 24 56" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><rect x="12" y="24" width="14" height="9" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><rect x="12" y="33" width="14" height="9" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><rect x="12" y="42" width="14" height="9" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.7"/><circle cx="34" cy="38" r="1.8" fill="#E6F1FB"/><path d="M 44 20 L 40 20 L 40 56 L 44 56" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><path d="M 54 20 L 58 20 L 58 56 L 54 56" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><rect x="42" y="24" width="14" height="9" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="42" y="33" width="14" height="9" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="42" y="42" width="14" height="9" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><text x="63" y="41" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">=</text><rect x="68" y="31" width="11" height="14" rx="2" fill="#FAC775" stroke="#854F0B" stroke-width="1.2"/><text x="73.5" y="41" font-family="Georgia,serif" font-size="8" fill="#412402" text-anchor="middle">s</text><text x="40" y="68" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">one scalar</text></svg>`,
        name: "Inner Product Visualizer",

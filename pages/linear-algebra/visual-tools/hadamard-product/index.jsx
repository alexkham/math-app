  ...
  return {
    props: {
      ...
      seoData: {
        ...
        keywords: keyWords.join(", "),
        url: "/linear-algebra/visual-tools/hadamard-product",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="30" width="9.5" height="9.5" fill="#85B7EB" stroke="#185FA5" stroke-width="0.7"/><rect x="11.5" y="30" width="9.5" height="9.5" fill="#FAC775" stroke="#854F0B" stroke-width="0.7"/><rect x="2" y="39.5" width="9.5" height="9.5" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="11.5" y="39.5" width="9.5" height="9.5" fill="#F4C0D1" stroke="#72243E" stroke-width="0.7"/><circle cx="25" cy="40" r="4" fill="none" stroke="#E6F1FB" stroke-width="1.1"/><circle cx="25" cy="40" r="1.4" fill="#E6F1FB"/><rect x="29" y="30" width="9.5" height="9.5" fill="#85B7EB" stroke="#185FA5" stroke-width="0.7"/><rect x="38.5" y="30" width="9.5" height="9.5" fill="#FAC775" stroke="#854F0B" stroke-width="0.7"/><rect x="29" y="39.5" width="9.5" height="9.5" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="38.5" y="39.5" width="9.5" height="9.5" fill="#F4C0D1" stroke="#72243E" stroke-width="0.7"/><text x="53" y="44" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">=</text><rect x="58" y="30" width="9.5" height="9.5" fill="#378ADD" stroke="#0C447C" stroke-width="0.7"/><rect x="67.5" y="30" width="9.5" height="9.5" fill="#EF9F27" stroke="#854F0B" stroke-width="0.7"/><rect x="58" y="39.5" width="9.5" height="9.5" fill="#97C459" stroke="#27500A" stroke-width="0.7"/><rect x="67.5" y="39.5" width="9.5" height="9.5" fill="#ED93B1" stroke="#72243E" stroke-width="0.7"/><text x="40" y="64" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">element-wise</text></svg>`,
        name: "Hadamard Product Visualizer",

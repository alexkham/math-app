  ...
  return {
    props: {
      ...
      seoData: {
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><text x="9" y="46" font-family="Georgia,serif" font-size="14" fill="#FAC775" text-anchor="middle" font-style="italic">k</text><rect x="18" y="30" width="11" height="11" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="29" y="30" width="11" height="11" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="18" y="41" width="11" height="11" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="29" y="41" width="11" height="11" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><text x="47" y="46" font-family="Georgia,serif" font-size="9" fill="#E6F1FB" text-anchor="middle">=</text><rect x="54" y="30" width="11" height="11" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="65" y="30" width="11" height="11" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="54" y="41" width="11" height="11" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><rect x="65" y="41" width="11" height="11" fill="#FAC775" stroke="#854F0B" stroke-width="0.9"/><text x="40" y="66" font-family="Georgia,serif" font-size="8" fill="#E6F1FB" text-anchor="middle" font-style="italic">k &#183; A</text></svg>`,
        name: "Matrix Scalar Multiplication Visualizer",

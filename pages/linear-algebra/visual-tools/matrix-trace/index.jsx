  ...
  return {
    props: {
      ...
      seoData: {
        ...
        keywords: keyWords.join(", "),
        url: "/linear-algebra/visual-tools/matrix-trace",
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="16" y="14" width="16" height="16" fill="#FAC775" stroke="#854F0B" stroke-width="1.1"/><rect x="32" y="14" width="16" height="16" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="48" y="14" width="16" height="16" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="16" y="30" width="16" height="16" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="32" y="30" width="16" height="16" fill="#FAC775" stroke="#854F0B" stroke-width="1.1"/><rect x="48" y="30" width="16" height="16" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="16" y="46" width="16" height="16" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="32" y="46" width="16" height="16" fill="#E6F1FB" stroke="#185FA5" stroke-width="0.8"/><rect x="48" y="46" width="16" height="16" fill="#FAC775" stroke="#854F0B" stroke-width="1.1"/><text x="24" y="26" font-family="Georgia,serif" font-size="9" fill="#412402" text-anchor="middle">3</text><text x="40" y="42" font-family="Georgia,serif" font-size="9" fill="#412402" text-anchor="middle">5</text><text x="56" y="58" font-family="Georgia,serif" font-size="9" fill="#412402" text-anchor="middle">2</text><text x="40" y="74" font-family="Georgia,serif" font-size="7.5" fill="#FAC775" text-anchor="middle" font-style="italic">tr(A) = 10</text></svg>`,
        name: "Matrix Trace Visualizer",

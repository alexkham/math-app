...
// All of these formulas are built from a handful of [combinatorial symbols](!/math-symbols/combinatorics) — the factorial $n!$, the arrangement count $P(n,r)$, the binomial coefficient $\\binom{n}{r}$ — each listed in the symbols reference with the [LaTeX](!/latex) code that produces it, and the [mathematical keyboard](!/keyboard) lets you type them directly.
// `,
//     before: `
...
//     "description": "Combinatorics fundamentals on one page: counting principles, inclusion-exclusion, permutations, combinations, the ten standard scenarios, binomial coefficient, and the binomial theorem.",
//     "url": "https://www.learnmathclass.com/combinatorics/basics",
//     "inLanguage": "en-US",
...
//         "position": 3,
//         "name": "Basics",
//         "item": "https://www.learnmathclass.com/combinatorics/basics"
//       }
//     ]
//   },
...
//          /> 
//    <Breadcrumb/>
//    <h1 className='title' style={{marginTop:'0px',marginBottom:'10px'}}>Combinatorics Basics: Counting Rules and Scenarios</h1>
//    <br/>
...
const faqQuestions = {
  obj1: {
    question: "What is combinatorics actually used for?",
    answer: "Counting things that are too numerous to list. It underpins probability, where you need the size of a sample space, and appears throughout cryptography, network design, scheduling, and algorithm analysis. Anywhere a question asks how many arrangements, selections, or configurations exist, combinatorics supplies the method for answering it without enumeration.",
    sectionId: "1"
  },
  obj2: {
    question: "How do you tell whether order matters in a counting problem?",
    answer: "Ask whether swapping two chosen items produces a different outcome. Assigning first and second place gives different results when swapped, so order matters. Picking two people for a committee does not, since the same pair results either way. This single test decides which family of formulas applies before any arithmetic starts.",
    sectionId: "3"
  },
  obj3: {
    question: "Why are combinatorics problems hard even when the formulas are simple?",
    answer: "Because the difficulty is recognition, not calculation. The formulas are short, but choosing among them requires deciding whether order matters, whether repetition is allowed, and whether the items are distinguishable. Two problems with almost identical wording can need entirely different approaches, which is why practice focuses on classifying rather than computing.",
    sectionId: "4"
  }
}

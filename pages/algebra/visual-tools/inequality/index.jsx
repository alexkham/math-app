  ...
  return {
    props: {
      ...
      seoData: {
        ...
        category: "",
        subCategory: "",
        // Staged card preview, currently dormant: getVisualType checks image
        // before svg, so the photo below still wins. Delete the image line to
        // switch this card over to the diagram.
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><path d="M 16 20 Q 21 30 26.32 34 L 16 34 Z" fill="#C0DD97" fill-opacity="0.45"/><path d="M 57.68 34 Q 63 30 68 20 L 68 34 Z" fill="#C0DD97" fill-opacity="0.45"/><line x1="8" y1="52" x2="74" y2="52" stroke="#B5D4F4" stroke-width="1"/><line x1="14" y1="10" x2="14" y2="58" stroke="#B5D4F4" stroke-width="0.9"/><line x1="10" y1="34" x2="74" y2="34" stroke="#FAC775" stroke-width="1.4" stroke-dasharray="3,2.5"/><path d="M 16 20 Q 42 64 68 20" fill="none" stroke="#85B7EB" stroke-width="1.9"/><line x1="10" y1="52" x2="26.32" y2="52" stroke="#97C459" stroke-width="3.4"/><line x1="57.68" y1="52" x2="74" y2="52" stroke="#97C459" stroke-width="3.4"/><circle cx="26.32" cy="52" r="3" fill="#2c5d99" stroke="#27500A" stroke-width="1.6"/><circle cx="57.68" cy="52" r="3" fill="#2c5d99" stroke="#27500A" stroke-width="1.6"/><rect x="10" y="60" width="16.32" height="5" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><rect x="26.32" y="60" width="31.36" height="5" fill="#F4C0D1" stroke="#72243E" stroke-width="0.7"/><rect x="57.68" y="60" width="16.32" height="5" fill="#C0DD97" stroke="#3B6D11" stroke-width="0.7"/><text x="18" y="72" font-family="Georgia,serif" font-size="7" fill="#C0DD97" text-anchor="middle">+</text><text x="42" y="72" font-family="Georgia,serif" font-size="7" fill="#F4C0D1" text-anchor="middle">&#8722;</text><text x="66" y="72" font-family="Georgia,serif" font-size="7" fill="#C0DD97" text-anchor="middle">+</text><text x="42" y="16" font-family="Georgia,serif" font-size="7.5" fill="#E6F1FB" text-anchor="middle" font-style="italic">f(x) &gt; n</text></svg>`,

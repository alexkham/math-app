...
export async function getStaticProps({ params }) {
  ...
  const viewConfig = {
    ...
    'square-of-sum': {
      ...
      category: "Algebraic Identities",
      subCategory: "",
      svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="8" width="44" height="44" fill="#85B7EB" stroke="#0C447C" stroke-width="1.2"/><rect x="52" y="8" width="20" height="44" fill="#FAC775" stroke="#854F0B" stroke-width="1.2"/><rect x="8" y="52" width="44" height="20" fill="#FAC775" stroke="#854F0B" stroke-width="1.2"/><rect x="52" y="52" width="20" height="20" fill="#F4C0D1" stroke="#72243E" stroke-width="1.2"/><text x="30" y="34" font-family="Georgia,serif" font-size="13" fill="#042C53" text-anchor="middle" font-style="italic">a²</text><text x="62" y="33" font-family="Georgia,serif" font-size="9" fill="#412402" text-anchor="middle" font-style="italic">ab</text><text x="30" y="66" font-family="Georgia,serif" font-size="9" fill="#412402" text-anchor="middle" font-style="italic">ab</text><text x="62" y="65" font-family="Georgia,serif" font-size="9" fill="#4B1528" text-anchor="middle" font-style="italic">b²</text></svg>`,
      h1: "Square of a Sum  (a+b)²",
      introTitle: `Visualizing (a+b)² as Four Pieces of a Square`,
      introContent: `This visualizer turns the identity $(a+b)^2 = a^2 + 2ab + b^2$ into a geometric proof you can step through. A square of side $a+b$ is built, its sides split into $a$ and $b$, internal lines extend the splits across the square, and the resulting four rectangles colour in to show exactly where each term comes from. The two $ab$ rectangles are visibly identical pieces — the source of the $2ab$ middle term that students often memorize without ever seeing.`,
      keywords: [
...
**Polynomials** — Theory of polynomial expansion and standard form, in which the square of a sum identity plays a constant role.`,
    ...
    'square-of-difference': {
      ...
      category: "Algebraic Identities",
      subCategory: "",
      svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="8" width="64" height="64" fill="#E6F1FB" stroke="#185FA5" stroke-width="1.2"/><rect x="8" y="8" width="64" height="20" fill="#FAC775" fill-opacity="0.75" stroke="#854F0B" stroke-width="1"/><rect x="52" y="8" width="20" height="64" fill="#FAC775" fill-opacity="0.75" stroke="#854F0B" stroke-width="1"/><rect x="52" y="8" width="20" height="20" fill="#ED93B1" stroke="#72243E" stroke-width="1.2"/><text x="62" y="22" font-family="Georgia,serif" font-size="9" fill="#4B1528" text-anchor="middle" font-style="italic" font-weight="bold">b²</text><text x="30" y="55" font-family="Georgia,serif" font-size="11" fill="#042C53" text-anchor="middle" font-style="italic">(a−b)²</text></svg>`,
      h1: "Square of a Difference  (a-b)²",
      introTitle: `Visualizing (a-b)² as a Sum-Minus-Overlap`,
      introContent: `This visualizer turns the identity $(a-b)^2 = a^2 - 2ab + b^2$ into a geometric argument you can step through. Starting from a square of side $a$, two $ab$ strips are laid down to cover most of it. The strips overlap on a small $b^2$ corner, which has been counted twice and must be subtracted. What remains uncovered is the $(a-b)^2$ square — and the equation falls out of summing the pieces correctly.`,
      keywords: [
...
**Factoring** — Recognising perfect square trinomials of the form $a^2 - 2ab + b^2$ allows them to be re-factored as $(a-b)^2$.`,
    ...
    'square-of-trinomial': {
      ...
      category: "Algebraic Identities",
      subCategory: "",
      svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="8" width="22" height="22" fill="#85B7EB" stroke="#0C447C" stroke-width="1"/><rect x="30" y="8" width="18" height="22" fill="#FAC775" stroke="#854F0B" stroke-width="1"/><rect x="48" y="8" width="24" height="22" fill="#F0997B" stroke="#712B13" stroke-width="1"/><rect x="8" y="30" width="22" height="18" fill="#FAC775" stroke="#854F0B" stroke-width="1"/><rect x="30" y="30" width="18" height="18" fill="#97C459" stroke="#27500A" stroke-width="1"/><rect x="48" y="30" width="24" height="18" fill="#AFA9EC" stroke="#3C3489" stroke-width="1"/><rect x="8" y="48" width="22" height="24" fill="#F0997B" stroke="#712B13" stroke-width="1"/><rect x="30" y="48" width="18" height="24" fill="#AFA9EC" stroke="#3C3489" stroke-width="1"/><rect x="48" y="48" width="24" height="24" fill="#F4C0D1" stroke="#72243E" stroke-width="1"/><text x="19" y="22" font-family="Georgia,serif" font-size="8" fill="#042C53" text-anchor="middle" font-style="italic">a²</text><text x="39" y="42" font-family="Georgia,serif" font-size="8" fill="#173404" text-anchor="middle" font-style="italic">b²</text><text x="60" y="64" font-family="Georgia,serif" font-size="8" fill="#4B1528" text-anchor="middle" font-style="italic">c²</text></svg>`,
      h1: "Square of a Trinomial  (a+b+c)²",
      introTitle: `Visualizing (a+b+c)² as a 3×3 Grid`,
      introContent: `This visualizer extends the square-of-a-sum dissection to three terms. A square of side $a+b+c$ is split into nine rectangles arranged as a 3×3 grid: three squared terms on the diagonal and six cross-product rectangles in three matched pairs. The full identity $(a+b+c)^2 = a^2 + b^2 + c^2 + 2ab + 2ac + 2bc$ falls out of summing the nine pieces — and the explosion view at the end separates them so each one can be seen on its own.`,
      keywords: [
...
**Powers Table** — Reference for integer powers, useful when checking trinomial expansions at specific values.`,
    ...
    'difference-of-squares': {
      ...
      category: "Algebraic Identities",
      subCategory: "",
      svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><path d="M 8 8 L 72 8 L 72 28 L 52 28 L 52 72 L 8 72 Z" fill="#85B7EB" stroke="#0C447C" stroke-width="1.2"/><rect x="52" y="8" width="20" height="20" fill="none" stroke="#993556" stroke-width="1.2" stroke-dasharray="3,2"/><line x1="52" y1="8" x2="72" y2="28" stroke="#993556" stroke-width="1" opacity="0.6"/><line x1="72" y1="8" x2="52" y2="28" stroke="#993556" stroke-width="1" opacity="0.6"/><text x="30" y="48" font-family="Georgia,serif" font-size="11" fill="#042C53" text-anchor="middle" font-style="italic">a²−b²</text><text x="62" y="22" font-family="Georgia,serif" font-size="8" fill="#4B1528" text-anchor="middle" font-style="italic">b²</text></svg>`,
      h1: "Difference of Squares  a² − b²",
      introTitle: `Visualizing a² − b² as a Cut-and-Rearrange Rectangle`,
      introContent: `This visualizer turns the factoring identity $a^2 - b^2 = (a+b)(a-b)$ into a slice-and-rearrange proof. A small square of side $b$ is removed from a square of side $a$, leaving an L-shape. The L is split horizontally into two rectangles; the upper strip lifts, rotates 90°, and drops next to the lower rectangle. The result is a rectangle of dimensions $(a+b)$ by $(a-b)$, exactly the factored form.`,
      keywords: [

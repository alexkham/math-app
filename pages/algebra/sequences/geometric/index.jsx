...
export default function GeometricSequencesPage({seoData, sectionsContent, introContent, faqQuestions, schemas}) {
 ...
 <Head>
  ...
  />
   ...
   <br/>
   <br/>
   <h1 className='title' style={{marginTop:'-50px',marginBottom:'0px'}}>Geometric Sequences</h1>
   <br/>
   <br/>

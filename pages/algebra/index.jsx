 ...
 * /pages/algebra/index.js
 *
 * Demonstrates the new `customSections` option of buildSectionData.
 * Static content only (markdown / HTML strings) — serializes cleanly
...
/* ================================================================
   CUSTOM SECTIONS
   ----------------------------------------------------------------
   Per-section overrides. Four behaviors are available:
     - augment      : custom prose + auto-generated grid
     - replace      : custom prose INSTEAD of the auto-generated grid
                      (header / footer-link / nav still render)
     - prose-only   : a brand-new section that does NOT exist on disk
                      (use insertAfter / insertBefore to position)
     - (omitted)    : pure auto-generation (current default)
   ================================================================ */
...
const customSections = {
 ...
 'identities': {
  ...
  position: 'before',
  body: `
    <p>Algebraic identities are equations that hold true for every value of their variables — not just for specific solutions, but universally. The expression (a+b)<sup>2</sup> = a<sup>2</sup> + 2ab + b<sup>2</sup> isn&apos;t a problem to solve; it&apos;s a structural fact about how squaring distributes over addition. When you treat an identity as a transformation rule rather than an equation to be balanced, algebra opens up.</p>

    <p>Identities serve three roles. First, they <strong>compress</strong>: rather than expanding (a+b)(a&minus;b) every time, you recognize the difference of squares and write a<sup>2</sup>&minus;b<sup>2</sup> instantly. Second, they <strong>reveal structure</strong>: factoring x<sup>3</sup>&minus;y<sup>3</sup> as (x&minus;y)(x<sup>2</sup>+xy+y<sup>2</sup>) exposes a pattern that recurs across number theory and abstract algebra. Third, they <strong>enable substitution</strong> — trigonometric, logarithmic, and exponential identities let you rewrite expressions into forms where new techniques apply.</p>

    <p>The basic binomial identities — squares, cubes, differences, and sums of cubes — form the backbone. Mastering them isn&apos;t memorization; it&apos;s pattern recognition. Once (a+b)<sup>2</sup> lives in your head as a geometric square dissected into four pieces (a<sup>2</sup>, ab, ab, b<sup>2</sup>), you no longer expand it mechanically. You see it.</p>

    <p>Below, each identity is presented with its algebraic form, geometric intuition where applicable, and the contexts where it does its heaviest work.</p>
  `,
},
...
export async function getStaticProps() {
  // Pass customSections as a second argument. Backwards compatible:
  // pages that omit it (or pass {}) keep their current behavior.
  const { sections, sectionData } = await buildSectionData('/algebra', { customSections });
  console.log('algebra section ids:', sections.map(s => s.id));
  ...
  const schemas = {
    ...
    itemList: {
      ...
      "@type": "ItemList",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "item": { "@type": "WebPage", "name": "Equations", "url": "https://www.learnmathclass.com/algebra/equations", "description": "Theory and methods for solving algebraic equations" } },
        { "@type": "ListItem", "position": 2, "item": { "@type": "WebPage", "name": "Polynomials", "url": "https://www.learnmathclass.com/algebra/polynomials", "description": "Polynomial operations, factoring, and roots" } },
        { "@type": "ListItem", "position": 3, "item": { "@type": "WebPage", "name": "Logarithms", "url": "https://www.learnmathclass.com/algebra/logarithms", "description": "Logarithmic functions, identities, and equations" } },
        { "@type": "ListItem", "position": 4, "item": { "@type": "WebPage", "name": "Powers and Exponents", "url": "https://www.learnmathclass.com/algebra/powers-and-exponents", "description": "Laws of exponents and exponential functions" } },
        { "@type": "ListItem", "position": 5, "item": { "@type": "WebPage", "name": "Roots and Radicals", "url": "https://www.learnmathclass.com/algebra/roots-and-radicals", "description": "Radical expressions, simplification, and rationalization" } },
        { "@type": "ListItem", "position": 6, "item": { "@type": "WebPage", "name": "Inequalities in Algebra", "url": "https://www.learnmathclass.com/algebra/inequalities", "description": "Solving and graphing algebraic inequalities" } },
        { "@type": "ListItem", "position": 7, "item": { "@type": "WebPage", "name": "Basic Binomial Identities", "url": "https://www.learnmathclass.com/algebra/basic-binomial-identities", "description": "Fundamental binomial expansion formulas" } },
        { "@type": "ListItem", "position": 8, "item": { "@type": "WebPage", "name": "Algebra Visual Tools", "url": "https://www.learnmathclass.com/algebra/visual-tools", "description": "Interactive visualizations for algebra concepts" } }
      ]
    },

...
// export default function RootEquationsPage({seoData,sectionsContent , introContent}) {
...
<Head>
  ...
  />
   ...
   <br/>
   <br/>
   <h1 className='title' style={{marginTop:'-10px',marginBottom:'20px'}}>Radical Equations</h1>
   <br/>
   <br/>

...
`
    ...
    return {
      props:{
         seoData: {
      title: "Equations - Types, Components & Solving Methods | Learn Math Class",
      description: "Complete guide to equations including linear, quadratic, polynomial, exponential, and trigonometric equations. Learn equation components and solving techniques.",

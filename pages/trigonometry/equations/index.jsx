...
// **Step 3: Write the solutions within one period.**
...
// **Step 3: Solutions within one period.**
...
//     // obj4: prose + basic-equation comparison table (synthesizes obj2-obj4: sin/cos/tan)
//     {
//         id:'4',
...
//     // obj9: prose + extraneous-solutions aggregation table
//     {
//         id:'9',
...
//     // obj10: NEW capstone — approach by equation form
//     {
//         id:'10',
...
const faqQuestions = {
  obj1: {
    question: "Why does a trigonometric equation have infinitely many solutions?",
    answer: "Because the functions repeat. Once one angle satisfies the equation, adding any whole number of periods gives another angle that satisfies it too. The general solution captures the whole family in one expression using an integer parameter, while a restricted solution lists only those falling inside a stated interval.",
    sectionId: "1"
  },
  obj2: {
    question: "What is the general solution of sin x = a?",
    answer: "It is x = (−1)ⁿα + nπ, where α is the principal angle and n runs over all integers. The alternating sign is needed because sine's two solutions per cycle sit at α and π − α, which are not symmetric about zero. Cosine, whose solutions are symmetric, uses a plus-or-minus instead.",
    sectionId: "2"
  },
  obj3: {
    question: "How do you solve a quadratic trigonometric equation?",
    answer: "Substitute a single letter for the trigonometric expression, solve the resulting quadratic by factoring or formula, then substitute back and solve each simple equation separately. Discard any root outside the range of the function, since values above 1 or below −1 are impossible for sine and cosine.",
    sectionId: "7"
  },
  obj4: {
    question: "Why does squaring both sides create extra solutions?",
    answer: "Squaring destroys sign information, so an equation that failed because two sides had opposite signs will pass once both are squared. The extra roots satisfy the squared version but not the original. Every solution must therefore be substituted back into the original equation and discarded if it does not check out.",
    sectionId: "9"
  },
  obj5: {
    question: "When does a trigonometric equation have no solution?",
    answer: "When it demands a value the function cannot produce. Sine and cosine never leave the interval from −1 to 1, so an equation like cos x = 2 has no solution at all. Tangent has no such bound and can equal any real number, so equations in tangent alone always have solutions.",
    sectionId: "9"
  }
}
...
The safeguard is straightforward: **always substitute solutions back into the original equation.** This verification step is not optional — it is an integral part of the solving process whenever squaring or other non-reversible steps have been used.`,
    ...
    faq: {
      title: `Trigonometric Equations FAQ`,
    },
  }

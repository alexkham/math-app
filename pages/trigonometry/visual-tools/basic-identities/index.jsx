  ...
  const explanations = {
   ...
   return {
      props:{
        ...
        svg: `<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><circle cx="40" cy="40" r="26" fill="none" stroke="#B5D4F4" stroke-width="1.2"/><line x1="12" y1="40" x2="68" y2="40" stroke="#B5D4F4" stroke-width="0.8"/><line x1="40" y1="12" x2="40" y2="68" stroke="#B5D4F4" stroke-width="0.8"/><line x1="40" y1="40" x2="54.91" y2="40" stroke="#85B7EB" stroke-width="2.4"/><line x1="54.91" y1="40" x2="54.91" y2="18.70" stroke="#97C459" stroke-width="2.4"/><line x1="40" y1="40" x2="54.91" y2="18.70" stroke="#FAC775" stroke-width="1.7"/><path d="M 48 40 A 8 8 0 0 0 44.59 33.45" fill="none" stroke="#FAC775" stroke-width="1.1"/><circle cx="54.91" cy="18.70" r="3" fill="#FAC775" stroke="#854F0B" stroke-width="1.1"/><text x="47" y="48" font-family="Georgia,serif" font-size="6.5" fill="#85B7EB" text-anchor="middle">cos</text><text x="64" y="31" font-family="Georgia,serif" font-size="6.5" fill="#C0DD97" text-anchor="middle">sin</text><text x="51" y="36" font-family="Georgia,serif" font-size="6.5" fill="#FAC775" text-anchor="middle" font-style="italic">&#952;</text></svg>`,
        name: "Basic Trigonometric Identities Explorer",

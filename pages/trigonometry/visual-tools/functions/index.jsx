...
//         url: "/trigonometry/visual-tools/functions",
//          name: "name"
//       },
...
//    <br/>
//    <br/>
//    <h1 className='title' style={{marginTop:'-50px',marginBottom:'0px'}}>Trigonomatric Functions Visual Tools</h1>
//    <br/>
//    <br/>
  ...
  const tools = [
    {
      ...
      description: 'Plot and explore the six trigonometric functions interactively. Switch between sin, cos, tan, csc, sec, and cot to see their curves, periods, and asymptotes. Drag the angle slider or type a value to mark any point on the graph and read its exact function value. Toggle between degrees and radians, pan across the x-axis by dragging, and zoom with the mouse wheel to study local behavior. Useful for understanding periodicity, amplitude, domain restrictions, and the relationship between an angle and its function value.',
    ...
    },
    {
      ...
      description: 'Discover why each trigonometric function is positive or negative in each of the four quadrants of the coordinate plane. Click any quadrant to see how the signs of x and y coordinates determine the sign of sin, cos, tan, and their reciprocals. Includes the classic ASTC mnemonic ("All Students Take Calculus") and step-by-step mathematical reasoning for every function-quadrant combination. Essential for solving trig equations, simplifying expressions, and building intuition about the unit circle.',
  ...
  const introContent = {
   ...
   return {
      props:{
         ...
         tools,
          seoData: {
            title: "Trigonometric Functions Visual Tools | Learn Math Class",
            description: "Interactive visual tools for trigonometric functions: explore graphs of sin, cos, tan, csc, sec, cot, and learn function signs across the four quadrants.",
            keywords: keyWords.join(", "),
            url: "/trigonometry/visual-tools/functions",
            name: "Trigonometric Functions Visual Tools"
          },
       }
    }
   }

export default function PageTemplate({seoData, sectionsContent, introContent, tools}) {

  // ============================================================
  // CARD STYLES — wider cards to fit rich descriptions
  // ============================================================
  const cardStyles = {
    container: {
      display: 'flex',
  ...
  />
   ...
   <div style={cardStyles.container}>
     {tools.map(tool => {
       ...
       const cardStyle = isActive ? cardStyles.card : cardStyles.cardDisabled
       const titleStyle = isActive ? cardStyles.title : cardStyles.titleDisabled

       const cardInner = (
         <>
           {!isActive && <span style={cardStyles.badge}>COMING SOON</span>}
           <div style={titleStyle}>{tool.title}</div>
           <div style={cardStyles.description}>{tool.description}</div>
         </>
       )

       if (isActive) {
         return (
           <Link key={tool.id} href={tool.href} style={cardStyle}>
             {cardInner}
           </Link>
         )
       }

...
//     // obj8: prose + domain & range aggregation table
//     {
//         id:'8',
...
//     // obj9: prose + quadrant-signs aggregation table (supports the sign-by-quadrant step)
//     {
//         id:'9',
...
//     // obj11: NEW capstone — six-function character card
//     {
//         id:'11',
...
const faqQuestions = {
  obj1: {
    question: "Why is secant the reciprocal of cosine and not of sine?",
    answer: "The naming looks crossed but is consistent: secant pairs with cosine and cosecant pairs with sine. The co- prefix travels with the reciprocal, so the function whose name starts with co- on one side has a partner without it on the other. Checking the definition rather than the name avoids the swap.",
    sectionId: "7"
  },
  obj2: {
    question: "Why are tangent and secant undefined at certain angles?",
    answer: "Both have cosine in the denominator, and division by zero is undefined. Cosine is zero at 90 degrees and every half rotation from there, so tangent and secant have vertical asymptotes at exactly those angles. Cotangent and cosecant fail the same way wherever sine is zero instead.",
    sectionId: "8"
  },
  obj3: {
    question: "How do you find all six trigonometric values from one known value?",
    answer: "Use the Pythagorean identity to get the partner function, then take reciprocals and quotients for the rest. If sine is known, solve for cosine, then tangent is their quotient and the remaining three are reciprocals. The quadrant decides each sign, so a known value alone is not enough without it.",
    sectionId: "10"
  },
  obj4: {
    question: "What does the n in a general solution stand for?",
    answer: "It is not an unknown to solve for. The letter ranges over every integer, negative values included, and each choice names one member of an infinite family of angles. Dropping the qualifier collapses infinitely many solutions into a single one, which is why the phrase \"for all integers n\" has to stay attached.",
    sectionId: "9"
  },
  obj5: {
    question: "Why do sine and cosine never exceed 1?",
    answer: "Because they are coordinates of a point on a circle of radius 1, and no point on that circle sits further than one unit from the centre in either direction. The bound falls straight out of the Pythagorean identity: if the squares of the two values sum to 1, neither can exceed 1 on its own.",
    sectionId: "8"
  }
}
...
The technique extends to starting from secant, cosecant, or cotangent — the Pythagorean [identities](!/trigonometry/identities) $1 + \\tan^2\\theta = \\sec^2\\theta$ and $1 + \\cot^2\\theta = \\csc^2\\theta$ play the analogous role.`,
    ...
    faq: {
      title: `Trigonometric Functions FAQ`,
    },
  }

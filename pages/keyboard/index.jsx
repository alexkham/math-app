...
Hover over any category button to see a tooltip describing what symbols it contains. Hover over mathematical symbols to see brief explanations of their meaning and usage. The interface updates in real-time as you interact with categories and modes.`,
  ...
  content: `Categories organize symbols by mathematical domain. Click any category button to load its keyboard layout. The active category appears highlighted with a blue background, and you can switch categories at any time without losing your typed content.

**Mathematical Branch Symbols:**
- [Set Theory Symbols](!/math-symbols/set-theory) — ∈, ⊂, ∪, ∩, ∅ for working with sets
- [Trigonometry Symbols](!/math-symbols/trigonometry) — sin, cos, tan and angle notation
- [Combinatorics Symbols](!/math-symbols/combinatorics) — permutations, combinations, and counting notation
- [Probability Symbols](!/math-symbols/probability) — P(A), expected value, variance, and distribution notation
- [Logic and Binary Operators](!/math-symbols/math-logic) — ∧, ∨, ⊕, ¬ for logical expressions
- [Calculus and N-ary Operators](!/math-symbols/calculus) — ∑, ∫, ∏, limits and derivatives
- [Linear Algebra Symbols](!/math-symbols/linear-algebra) — ℝ, ℕ, ℤ and letter-like math symbols
- [Complex Number Symbols](!/math-symbols/complex-numbers) — imaginary unit, modulus, and complex plane notation

**General-Purpose Symbol Sets:**
- **Arithmetic Symbols** — basic operations: +, −, ×, ÷, =, √
- **Greek Letters** — lowercase (α, β, γ, θ, π) and uppercase (Δ, Σ, Ω) used across all fields
- **Relational Operators** — ≤, ≥, ≈, ≡ for comparisons and equivalences
- **Arrow Symbols** — →, ⇒, ↔, ⇔ for implications and mappings
- **Brackets** — parentheses, braces, floor/ceiling, and angle brackets
- **Geometry Symbols** — angles, parallel, perpendicular, and shape notation
- **Negation Symbols** — negated forms of common operators
...
Greek letters integrate seamlessly with all keyboard modes and categories. Hover over unfamiliar symbols to see their names in tooltips.`,
    ...
    obj9: {
      ...
      content: `[Math Symbols Reference](!/math-symbols) provides a comprehensive database of mathematical notation organized by category with LaTeX codes and explanations. Browse hundreds of symbols with their proper names and usage contexts.

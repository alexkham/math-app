    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: '30px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#374151' }}>Distribution Type</label>
            <select 
              value={distribution} 
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#10b981' }}>Mean μ: {mean}</label>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#ef4444' }}>Distance from mean (threshold a): {deviation}</label>
          ...
          <div style={{ padding: '15px', background: '#f3f4f6', borderRadius: '8px', fontSize: '14px' }}>
            <p style={{ margin: '0 0 10px 0' }}><strong>Chebyshev Inequality:</strong> For any distribution with mean μ and variance σ²: P(|X - μ| ≥ a) ≤ σ² / a²</p>
            <p style={{ margin: '0' }}>{isDiscrete ? 'Red bars' : 'Red areas'} show P(X &lt; μ-a) + P(X &gt; μ+a). Bound: {chebyshevBoundPercent}%, Actual: {actualProbPercent}%</p>
          </div>
        </div>
      </div>
    </div>

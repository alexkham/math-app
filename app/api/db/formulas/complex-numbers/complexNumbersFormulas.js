...
//           steps: [
//             { value: '$(r, \\theta)$', operation: 'apply Euler: $e^{i\\theta} = \\cos\\theta + i\\sin\\theta$' },
//             { value: '$r \\cdot e^{i\\theta}$' }
//           ]
//         }
//       ],
...
//     fields: {
//       explanation: [
//         `Multiply the moduli and add the arguments. Geometrically, multiplication by $z_2$ scales by $|z_2|$ and rotates counterclockwise by $\\arg(z_2)$. Dramatically simpler than rectangular multiplication when both factors are in polar form.`,
//         {
//           component: 'FunctionMachineDiagram',
//           steps: [
//             { value: '$(r_1, \\theta_1),\\ (r_2, \\theta_2)$', operation: 'multiply moduli, add arguments' },
//             { value: '$(r_1 r_2,\\ \\theta_1 + \\theta_2)$' }
//           ]
//         }
//       ],
...
//     fields: {
//       explanation: [
//         `Divide the moduli and subtract the arguments. Geometrically, division by $z_2$ shrinks by $1/|z_2|$ and rotates clockwise by $\\arg(z_2)$. The inverse of polar multiplication.`,
//         {
//           component: 'FunctionMachineDiagram',
//           steps: [
//             { value: '$(r_1, \\theta_1),\\ (r_2, \\theta_2)$', operation: 'divide moduli, subtract arguments' },
//             { value: '$(r_1 / r_2,\\ \\theta_1 - \\theta_2)$' }
//           ]
//         }
//       ],
...
const complexNumbersFormulasList = [
    ...
    fields: {
      ...
      explanation: [
        `The standard way of writing a complex number, as a sum of a real part $a$ and an imaginary part $b$ scaled by the imaginary unit $i$. Also called rectangular form or standard form. Every complex number has a unique algebraic form, and every pair of real numbers $(a, b)$ produces exactly one complex number this way.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$a,\\ b$ (real)', operation: 'combine with $i$' },
            { value: '$z = a + bi$' }
          ]
        }
      ],
      // DERIVATION SKIPPED: pure definition of algebraic form notation.
      conditions: `$a, b \\in \\mathbb{R}$ and $i^2 = -1$. When $b = 0$, $z$ is real. When $a = 0$ and $b \\neq 0$, $z$ is pure imaginary.`,
      notation: `Some texts write $a + ib$ instead of $a + bi$; the order is conventional. The set of all complex numbers is denoted $\\mathbb{C}$.`,
      related_formulas: `- [Trigonometric Form](!/complex-numbers/formulas#trigonometric_form)\n- [Exponential Form](!/complex-numbers/formulas#exponential_form)\n- [Real and Imaginary Parts](!/complex-numbers/formulas#real_and_imaginary_parts)\n- [Equality of Complex Numbers](!/complex-numbers/formulas#equality_of_complex_numbers)`,
      related_definitions: `- [Complex Number](!/complex-numbers/definitions#complex_number)\n- [Algebraic Form](!/complex-numbers/definitions#algebraic_form)\n- [Real Part](!/complex-numbers/definitions#real_part)\n- [Imaginary Part](!/complex-numbers/definitions#imaginary_part)`
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Expresses a complex number using its distance $r$ from the origin and its angle $\\theta$ from the positive real axis. Also called polar form. Particularly useful for multiplication, division, and powers, where the geometric meaning becomes transparent.`,
      explanation: [
        `Expresses a complex number using its distance $r$ from the origin and its angle $\\theta$ from the positive real axis. Also called polar form. Particularly useful for multiplication, division, and powers, where the geometric meaning becomes transparent.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$(r, \\theta)$', operation: 'apply $r(\\cos\\theta + i\\sin\\theta)$' },
            { value: '$z$' }
          ]
        }
      ],
      derivation: [
        `Substitute the polar-to-rectangular relations into the algebraic form.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z = a + bi$', operation: 'substitute $a = r\\cos\\theta,\\ b = r\\sin\\theta$' },
            { expr: '$z = r\\cos\\theta + i \\cdot r\\sin\\theta$', operation: 'factor $r$' },
            { expr: '$z = r(\\cos\\theta + i\\sin\\theta)$', tag: 'result' }
          ]
        }
      ],
      conditions: `$r = |z| \\geq 0$ and $\\theta = \\arg(z)$. The argument is determined only up to multiples of $2\\pi$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      derivation: [
        `Apply Euler&apos;s formula to the trigonometric form.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z = r(\\cos\\theta + i\\sin\\theta)$', operation: 'apply $e^{i\\theta} = \\cos\\theta + i\\sin\\theta$' },
            { expr: '$z = r \\cdot e^{i\\theta}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$r = |z| \\geq 0$ and $\\theta = \\arg(z)$. For $z = 0$, the argument is undefined and $r = 0$.`,
    ...
    fields: {
      ...
      explanation: [
        `For $z = a + bi$, the modulus measures the straight-line distance from the origin to $z$ in the complex plane. Direct application of the Pythagorean theorem to the right triangle with legs $|a|$ and $|b|$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$a,\\ b$', operation: 'square and add' },
            { value: '$a^2 + b^2$', operation: 'take square root' },
            { value: '$|z|$' }
          ]
        }
      ],
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `The argument is the angle from the positive real axis to the line segment from the origin to $z$, measured counterclockwise. Determined only up to multiples of $2\\pi$ — the principal argument $\\mathrm{Arg}(z) \\in (-\\pi, \\pi]$ provides the canonical choice.`,
      explanation: [
        `The argument is the angle from the positive real axis to the line segment from the origin to $z$, measured counterclockwise. Determined only up to multiples of $2\\pi$ — the principal argument $\\mathrm{Arg}(z) \\in (-\\pi, \\pi]$ provides the canonical choice.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z = a + bi$', operation: 'apply $\\mathrm{atan2}(b, a)$' },
            { value: '$\\theta$' }
          ]
        }
      ],
      derivation: [
        `Match the algebraic form with the trigonometric form and divide by the modulus.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$a + bi = r(\\cos\\theta + i\\sin\\theta)$', operation: 'match real and imaginary parts' },
            { expr: '$a = r\\cos\\theta,\\ b = r\\sin\\theta$', operation: 'divide by $r = |z|$' },
            { expr: '$\\cos\\theta = \\dfrac{a}{|z|},\\quad \\sin\\theta = \\dfrac{b}{|z|}$', tag: 'result' }
          ]
        }
      ],
      conditions: `Undefined when $z = 0$. For $z \\neq 0$, infinitely many valid arguments exist, all differing by multiples of $2\\pi$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Recovers the rectangular components $a$ and $b$ from polar parameters $r$ and $\\theta$. Direct trigonometric projection: the horizontal leg of the right triangle is $r\\cos\\theta$, the vertical leg is $r\\sin\\theta$.`,
      explanation: [
        `Recovers the rectangular components $a$ and $b$ from polar parameters $r$ and $\\theta$. Direct trigonometric projection: the horizontal leg of the right triangle is $r\\cos\\theta$, the vertical leg is $r\\sin\\theta$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$(r, \\theta)$', operation: 'project via $\\cos, \\sin$' },
            { value: '$(a, b)$' }
          ]
        }
      ],
      derivation: [
        `Read off the components of the trigonometric form.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z = r(\\cos\\theta + i\\sin\\theta)$', operation: 'distribute' },
            { expr: '$z = r\\cos\\theta + i \\cdot r\\sin\\theta$', operation: 'identify real and imaginary parts' },
            { expr: '$a = r\\cos\\theta,\\quad b = r\\sin\\theta$', tag: 'result' }
          ]
        }
      ],
      conditions: `Valid for any $r \\geq 0$ and any real $\\theta$. When $r = 0$, both components are zero regardless of $\\theta$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Extraction functions returning the real components of a complex number. Despite its name, $\\operatorname{Im}(z)$ is itself a real number — it is the coefficient of $i$, not the term $bi$.`,
      explanation: [
        `Extraction functions returning the real components of a complex number. Despite its name, $\\operatorname{Im}(z)$ is itself a real number — it is the coefficient of $i$, not the term $bi$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z = a + bi$', operation: 'extract components' },
            { value: '$\\operatorname{Re}(z) = a,\\ \\operatorname{Im}(z) = b$' }
          ]
        }
      ],
      // DERIVATION SKIPPED: pure definitions of the Re and Im functions.
      conditions: `Both $\\operatorname{Re}$ and $\\operatorname{Im}$ are functions $\\mathbb{C} \\to \\mathbb{R}$.`,
      variants: `Via the conjugate:\n\n$$\\operatorname{Re}(z) = \\frac{z + \\overline{z}}{2}, \\qquad \\operatorname{Im}(z) = \\frac{z - \\overline{z}}{2i}$$\n\nFrom polar form:\n\n$$\\operatorname{Re}(z) = |z|\\cos\\theta, \\qquad \\operatorname{Im}(z) = |z|\\sin\\theta$$`,
      related_formulas: `- [Algebraic Form](!/complex-numbers/formulas#algebraic_form)\n- [Polar to Rectangular Conversion](!/complex-numbers/formulas#polar_to_rectangular_conversion)`,
      related_definitions: `- [Real Part](!/complex-numbers/definitions#real_part)\n- [Imaginary Part](!/complex-numbers/definitions#imaginary_part)`
    ...
    fields: {
      ...
      explanation: [
        `Two complex numbers are equal if and only if both their real parts and their imaginary parts match. A single complex equation thus splits into two independent real equations — a powerful technique for solving complex equations by separation into real and imaginary parts.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$a + bi = c + di$', operation: 'separate real & imaginary parts' },
            { value: '$a = c$ and $b = d$' }
          ]
        }
      ],
      derivation: [
        `Subtract, then use that $1$ and $i$ are linearly independent over $\\mathbb{R}$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$(a + bi) - (c + di) = 0$', operation: 'group real and imaginary parts' },
            { expr: '$(a - c) + (b - d)i = 0$', operation: '$1$ and $i$ are $\\mathbb{R}$-linearly independent' },
            { expr: '$a - c = 0$ and $b - d = 0$', tag: 'result' }
          ]
        }
      ],
      conditions: `$a, b, c, d \\in \\mathbb{R}$.`,
    ...
    fields: {
      ...
      explanation: [
        `Add real parts to real parts and imaginary parts to imaginary parts. The two components are independent — no interaction occurs between them. Geometrically, addition follows the parallelogram rule: place the two complex numbers as vectors from the origin and the sum is the diagonal.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$(a + bi),\\ (c + di)$', operation: 'add real & imaginary parts separately' },
            { value: '$(a + c) + (b + d)i$' }
          ]
        }
      ],
      derivation: [
        `Regroup using commutativity and associativity of real addition, then factor $i$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$(a + bi) + (c + di)$', operation: 'drop parentheses' },
            { expr: '$a + bi + c + di$', operation: 'group real and imaginary terms' },
            { expr: '$(a + c) + (bi + di)$', operation: 'factor $i$' },
            { expr: '$(a + c) + (b + d)i$', tag: 'result' }
          ]
        }
      ],
      conditions: `$a, b, c, d \\in \\mathbb{R}$. Addition is commutative and associative.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Subtract real parts and imaginary parts independently. Equivalently, $z_1 - z_2 = z_1 + (-z_2)$ where $-z_2$ is the additive inverse. Geometrically, $z_1 - z_2$ is the vector from $z_2$ to $z_1$, and its modulus $|z_1 - z_2|$ is the distance between the two points in the complex plane.`,
      explanation: [
        `Subtract real parts and imaginary parts independently. Equivalently, $z_1 - z_2 = z_1 + (-z_2)$ where $-z_2$ is the additive inverse. Geometrically, $z_1 - z_2$ is the vector from $z_2$ to $z_1$, and its modulus $|z_1 - z_2|$ is the distance between the two points in the complex plane.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$(a + bi),\\ (c + di)$', operation: 'subtract real & imaginary parts separately' },
            { value: '$(a - c) + (b - d)i$' }
          ]
        }
      ],
      derivation: [
        `Distribute the minus sign, then regroup.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$(a + bi) - (c + di)$', operation: 'distribute the minus' },
            { expr: '$a + bi - c - di$', operation: 'group real and imaginary terms' },
            { expr: '$(a - c) + (b - d)i$', tag: 'result' }
          ]
        }
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Apply the distributive property (FOIL), then collapse $i^2 = -1$. The four cross-terms collect into a real part $ac - bd$ and an imaginary part $ad + bc$.`,
      explanation: [
        `Apply the distributive property (FOIL), then collapse $i^2 = -1$. The four cross-terms collect into a real part $ac - bd$ and an imaginary part $ad + bc$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$(a + bi)(c + di)$', operation: 'FOIL, apply $i^2 = -1$' },
            { value: '$(ac - bd) + (ad + bc)i$' }
          ]
        }
      ],
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Multiply numerator and denominator by the conjugate of the denominator. The denominator becomes the real number $|z_2|^2 = c^2 + d^2$, converting the quotient to standard algebraic form. This technique is sometimes called rationalizing the denominator.`,
      explanation: [
        `Multiply numerator and denominator by the conjugate of the denominator. The denominator becomes the real number $|z_2|^2 = c^2 + d^2$, converting the quotient to standard algebraic form. This technique is sometimes called rationalizing the denominator.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\frac{a + bi}{c + di}$', operation: 'multiply top and bottom by $\\overline{c + di}$' },
            { value: '$\\frac{(a + bi)(c - di)}{c^2 + d^2}$', operation: 'expand numerator' },
            { value: '$\\frac{(ac + bd) + (bc - ad)i}{c^2 + d^2}$' }
          ]
        }
      ],
      derivation: [
  ...
  },
  {
    ...
    fields: {
      ...
      derivation: [
        `Expand the product and apply the sum formulas for $\\cos$ and $\\sin$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z_1 z_2 = r_1(\\cos\\theta_1 + i\\sin\\theta_1) \\cdot r_2(\\cos\\theta_2 + i\\sin\\theta_2)$', operation: 'FOIL, use $i^2 = -1$' },
            { expr: '$= r_1 r_2 \\bigl[(\\cos\\theta_1\\cos\\theta_2 - \\sin\\theta_1\\sin\\theta_2) + i(\\sin\\theta_1\\cos\\theta_2 + \\cos\\theta_1\\sin\\theta_2)\\bigr]$', operation: 'apply trig sum formulas' },
            { expr: '$z_1 z_2 = r_1 r_2 \\bigl[\\cos(\\theta_1 + \\theta_2) + i\\sin(\\theta_1 + \\theta_2)\\bigr]$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z_1 = r_1(\\cos\\theta_1 + i\\sin\\theta_1)$ and $z_2 = r_2(\\cos\\theta_2 + i\\sin\\theta_2)$ with $r_1, r_2 \\geq 0$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      derivation: [
        `Use the exponential form; the exponent rule gives the result directly.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$\\dfrac{z_1}{z_2} = \\dfrac{r_1 e^{i\\theta_1}}{r_2 e^{i\\theta_2}}$', operation: 'apply exponent rule $e^{a}/e^{b} = e^{a-b}$' },
            { expr: '$= \\dfrac{r_1}{r_2}\\, e^{i(\\theta_1 - \\theta_2)}$', operation: 'apply Euler' },
            { expr: '$= \\dfrac{r_1}{r_2}\\bigl[\\cos(\\theta_1 - \\theta_2) + i\\sin(\\theta_1 - \\theta_2)\\bigr]$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z_2 \\neq 0$ (equivalently $r_2 > 0$).`,
    ...
    fields: {
      ...
      explanation: [
        `Reflects $z$ across the real axis in the complex plane. The real part stays unchanged; the sign of the imaginary part flips. Conjugation is the most important auxiliary operation in complex arithmetic — it underlies division, modulus computation, and classification of real and pure imaginary numbers.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z = a + bi$', operation: 'flip sign of imaginary part' },
            { value: '$\\overline{z} = a - bi$' }
          ]
        }
      ],
      // DERIVATION SKIPPED: pure definition of the conjugation operation.
      conditions: `Defined for every $z \\in \\mathbb{C}$.`,
      notation: `Written $\\overline{z}$ in pure mathematics, $z^*$ in physics and engineering. Both denote the same operation.`,
      related_formulas: `- [Conjugate of a Conjugate](!/complex-numbers/formulas#conjugate_of_a_conjugate)\n- [Conjugate Times Number](!/complex-numbers/formulas#conjugate_times_number)\n- [Modulus of Conjugate](!/complex-numbers/formulas#modulus_of_conjugate)\n- [Real Number Test](!/complex-numbers/formulas#real_number_test)\n- [Pure Imaginary Test](!/complex-numbers/formulas#pure_imaginary_test)`,
      related_definitions: `- [Complex Conjugate](!/complex-numbers/definitions#complex_conjugate)`
    ...
    fields: {
      ...
      explanation: [
        `Conjugation is an involution: applying it twice returns the original number. Geometrically, reflecting twice across the same axis brings every point back to its starting position.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z$', operation: 'conjugate' },
            { value: '$\\overline{z}$', operation: 'conjugate again' },
            { value: '$z$' }
          ]
        }
      ],
    ...
    fields: {
      ...
      explanation: [
        `Conjugation distributes over addition. The conjugate of a sum equals the sum of the conjugates. Allows term-by-term conjugation of expressions involving complex sums.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\overline{z_1 + z_2}$', operation: 'distribute conjugation' },
            { value: '$\\overline{z_1} + \\overline{z_2}$' }
          ]
        }
      ],
      derivation: [
        `Write both sides in components with $z_1 = a_1 + b_1 i$, $z_2 = a_2 + b_2 i$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z_1 + z_2 = (a_1 + a_2) + (b_1 + b_2)i$', operation: 'conjugate' },
            { expr: '$\\overline{z_1 + z_2} = (a_1 + a_2) - (b_1 + b_2)i$', operation: 'split into two conjugates' },
            { expr: '$= (a_1 - b_1 i) + (a_2 - b_2 i) = \\overline{z_1} + \\overline{z_2}$', tag: 'result' }
          ]
        }
      ],
      conditions: `Holds for any $z_1, z_2 \\in \\mathbb{C}$.`,
    ...
    fields: {
      ...
      explanation: [
        `Conjugation distributes over multiplication. Allows conjugating each factor independently before multiplying — often simpler than conjugating the full product.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\overline{z_1 \\cdot z_2}$', operation: 'distribute conjugation' },
            { value: '$\\overline{z_1} \\cdot \\overline{z_2}$' }
          ]
        }
      ],
      derivation: [
        `Expand each side with $z_1 = a + bi$, $z_2 = c + di$ and compare.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z_1 z_2 = (ac - bd) + (ad + bc)i$', operation: 'conjugate' },
            { expr: '$\\overline{z_1 z_2} = (ac - bd) - (ad + bc)i$', operation: 'compute $\\overline{z_1}\\,\\overline{z_2}$ directly' },
            { expr: '$\\overline{z_1}\\,\\overline{z_2} = (a - bi)(c - di) = (ac - bd) - (ad + bc)i$', tag: 'result' }
          ]
        }
      ],
      conditions: `Holds for any $z_1, z_2 \\in \\mathbb{C}$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Conjugation distributes over division. Conjugate the numerator and denominator separately.`,
      explanation: [
        `Conjugation distributes over division. Conjugate the numerator and denominator separately.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\overline{\\left(\\frac{z_1}{z_2}\\right)}$', operation: 'distribute conjugation' },
            { value: '$\\frac{\\overline{z_1}}{\\overline{z_2}}$' }
          ]
        }
      ],
      derivation: [
        `Set $w = z_1/z_2$, conjugate both sides of $z_1 = w z_2$, and solve.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z_1 = w \\cdot z_2$', operation: 'conjugate both sides' },
            { expr: '$\\overline{z_1} = \\overline{w \\cdot z_2} = \\overline{w} \\cdot \\overline{z_2}$', operation: 'divide by $\\overline{z_2}$' },
            { expr: '$\\overline{w} = \\dfrac{\\overline{z_1}}{\\overline{z_2}} \\;\\Rightarrow\\; \\overline{\\left(\\dfrac{z_1}{z_2}\\right)} = \\dfrac{\\overline{z_1}}{\\overline{z_2}}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z_2 \\neq 0$.`,
    ...
    fields: {
      ...
      explanation: [
        `Conjugation passes through integer powers. Follows from repeated application of the product rule for positive integers and from the quotient rule for negative integers.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\overline{z^n}$', operation: 'push conjugation inside power' },
            { value: '$(\\overline{z})^n$' }
          ]
        }
      ],
      derivation: [
        `Induction on $n \\geq 1$ using the conjugate-of-product rule.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$n = 1$: $\\overline{z^1} = \\overline{z} = (\\overline{z})^1$', operation: 'inductive step' },
            { expr: '$\\overline{z^{k+1}} = \\overline{z^k \\cdot z} = \\overline{z^k} \\cdot \\overline{z}$', operation: 'apply hypothesis $\\overline{z^k} = (\\overline{z})^k$' },
            { expr: '$= (\\overline{z})^k \\cdot \\overline{z} = (\\overline{z})^{k+1}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$n \\in \\mathbb{Z}$. For negative $n$, additionally require $z \\neq 0$.`,
    ...
    fields: {
      ...
      explanation: [
        `The product of a complex number with its conjugate is always the real, non-negative quantity $|z|^2$. The cornerstone identity of complex arithmetic — it makes division by complex numbers possible by converting complex denominators into real ones.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z,\\ \\overline{z}$', operation: 'multiply' },
            { value: '$|z|^2 = a^2 + b^2$' }
          ]
        }
      ],
    ...
    fields: {
      ...
      explanation: [
        `A complex number is real if and only if it equals its own conjugate. Geometrically, real numbers lie on the real axis — the mirror line for conjugation — so they are fixed under reflection.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z = \\overline{z}$', operation: 'if and only if' },
            { value: '$z \\in \\mathbb{R}$' }
          ]
        }
      ],
    ...
    fields: {
      ...
      explanation: [
        `A complex number is pure imaginary if and only if its conjugate equals its negative. Pure imaginaries lie on the imaginary axis, perpendicular to the mirror, so reflection sends them to their opposites.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\overline{z} = -z$', operation: 'if and only if' },
            { value: '$z$ is pure imaginary' }
          ]
        }
      ],
      derivation: [
...

  {
    ...
    fields: {
      ...
      derivation: [
        `Square the modulus formula.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$|z| = \\sqrt{a^2 + b^2}$', operation: 'square both sides' },
            { expr: '$|z|^2 = a^2 + b^2$', tag: 'result' }
          ]
        }
      ],
      conditions: `Holds for every $z = a + bi \\in \\mathbb{C}$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Conjugation preserves modulus. Reflection across the real axis does not change distance from the origin, so $z$ and $\\overline{z}$ lie on the same circle centered at the origin.`,
      explanation: [
        `Conjugation preserves modulus. Reflection across the real axis does not change distance from the origin, so $z$ and $\\overline{z}$ lie on the same circle centered at the origin.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\overline{z}$', operation: 'take modulus' },
            { value: '$|z|$' }
          ]
        }
      ],
    ...
    fields: {
      ...
      explanation: [
        `The modulus of a product equals the product of the moduli. Reduces modulus calculations on complicated products to multiplication of individual magnitudes.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$|z_1 \\cdot z_2|$', operation: 'distribute modulus' },
            { value: '$|z_1| \\cdot |z_2|$' }
          ]
        }
      ],
      derivation: [
        `Square, use $|z|^2 = z\\overline{z}$, and apply the conjugate-of-product rule.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$|z_1 z_2|^2 = (z_1 z_2)\\overline{(z_1 z_2)} = z_1 z_2 \\overline{z_1}\\,\\overline{z_2}$', operation: 'regroup' },
            { expr: '$= (z_1 \\overline{z_1})(z_2 \\overline{z_2}) = |z_1|^2 |z_2|^2$', operation: 'take square root (both sides $\\geq 0$)' },
            { expr: '$|z_1 z_2| = |z_1| \\cdot |z_2|$', tag: 'result' }
          ]
        }
      ],
      conditions: `Holds for any $z_1, z_2 \\in \\mathbb{C}$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `The modulus of a quotient equals the quotient of the moduli.`,
      explanation: [
        `The modulus of a quotient equals the quotient of the moduli.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\left|\\frac{z_1}{z_2}\\right|$', operation: 'distribute modulus' },
            { value: '$\\frac{|z_1|}{|z_2|}$' }
          ]
        }
      ],
      derivation: [
        `Apply the modulus-of-product rule to the identity $z_1 = (z_1/z_2) \\cdot z_2$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z_1 = \\dfrac{z_1}{z_2} \\cdot z_2$', operation: 'take modulus' },
            { expr: '$|z_1| = \\left|\\dfrac{z_1}{z_2}\\right| \\cdot |z_2|$', operation: 'solve for the quotient' },
            { expr: '$\\left|\\dfrac{z_1}{z_2}\\right| = \\dfrac{|z_1|}{|z_2|}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z_2 \\neq 0$.`,
    ...
    fields: {
      ...
      explanation: [
        `Raising a complex number to the $n$-th power raises its modulus to the $n$-th power. Combined with De Moivre&apos;s theorem, this makes computing moduli of powers trivial.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$|z^n|$', operation: 'pull modulus through power' },
            { value: '$|z|^n$' }
          ]
        }
      ],
      derivation: [
        `Induction on $n \\geq 1$ using the modulus-of-product rule.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$n = 1$: $|z^1| = |z| = |z|^1$', operation: 'inductive step' },
            { expr: '$|z^{k+1}| = |z^k \\cdot z| = |z^k| \\cdot |z|$', operation: 'apply hypothesis $|z^k| = |z|^k$' },
            { expr: '$= |z|^k \\cdot |z| = |z|^{k+1}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$n \\in \\mathbb{Z}$. For negative $n$, additionally require $z \\neq 0$.`,
  ...
  },
  {
    ...
    link: { label: 'Absolute Value', url: '/complex-numbers/absolute-value#5' },
    fields: {
      // FMD SKIPPED: inequality relation, not a linear chain of computation.
      explanation: `The modulus of a sum never exceeds the sum of moduli. Geometrically, one side of a triangle (the direct path from $0$ to $z_1 + z_2$) cannot exceed the sum of the other two sides (the detour through $z_1$ or $z_2$). Foundation for estimation throughout complex analysis.`,
      derivation: [
        `Expand $|z_1 + z_2|^2$ using $|z|^2 = z\\overline{z}$, then bound the cross term with $\\operatorname{Re}(w) \\leq |w|$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$|z_1 + z_2|^2 = (z_1 + z_2)(\\overline{z_1} + \\overline{z_2})$', operation: 'expand' },
            { expr: '$= |z_1|^2 + |z_2|^2 + z_1 \\overline{z_2} + \\overline{z_1} z_2 = |z_1|^2 + |z_2|^2 + 2\\operatorname{Re}(z_1 \\overline{z_2})$', operation: 'apply $\\operatorname{Re}(w) \\leq |w|$' },
            { expr: '$\\leq |z_1|^2 + |z_2|^2 + 2|z_1||z_2| = (|z_1| + |z_2|)^2$', operation: 'take square root' },
            { expr: '$|z_1 + z_2| \\leq |z_1| + |z_2|$', tag: 'result' }
          ]
        }
      ],
      conditions: `Holds for any $z_1, z_2 \\in \\mathbb{C}$. Equality holds if and only if $z_1$ and $z_2$ are non-negative real multiples of each other (i.e., point in the same direction from the origin).`,
    ...
    fields: {
      ...
      explanation: [
        `Raising a unit-modulus complex number to the $n$-th power multiplies its argument by $n$. Reduces high powers of complex numbers to elementary angle arithmetic — no binomial expansion, no tracking powers of $i$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$(\\cos\\theta + i\\sin\\theta)^n$', operation: 'multiply argument by $n$' },
            { value: '$\\cos(n\\theta) + i\\sin(n\\theta)$' }
          ]
        }
      ],
      derivation: [
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Exponential-form statement of De Moivre's theorem. Raises modulus to the $n$-th power and multiplies argument by $n$. Direct consequence of the exponent rule $(e^{i\\theta})^n = e^{in\\theta}$.`,
      explanation: [
        `Exponential-form statement of De Moivre&apos;s theorem. Raises modulus to the $n$-th power and multiplies argument by $n$. Direct consequence of the exponent rule $(e^{i\\theta})^n = e^{in\\theta}$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$(r, \\theta)$', operation: 'raise $r$ to $n$, multiply $\\theta$ by $n$' },
            { value: '$(r^n, n\\theta)$' }
          ]
        }
      ],
      derivation: [
        `Distribute the exponent and apply the standard exponent rule.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z^n = (r e^{i\\theta})^n$', operation: 'distribute the exponent' },
            { expr: '$= r^n \\cdot (e^{i\\theta})^n$', operation: 'apply $(e^{x})^n = e^{nx}$' },
            { expr: '$= r^n e^{in\\theta}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$n \\in \\mathbb{Z}$. For $n < 0$, require $z \\neq 0$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Every nonzero complex number $w = Re^{i\\phi}$ has exactly $n$ distinct $n$-th roots. They share the modulus $R^{1/n}$ and are spaced uniformly around the origin at angular intervals of $2\\pi/n$, forming the vertices of a regular $n$-gon.`,
      explanation: [
        `Every nonzero complex number $w = Re^{i\\phi}$ has exactly $n$ distinct $n$-th roots. They share the modulus $R^{1/n}$ and are spaced uniformly around the origin at angular intervals of $2\\pi/n$, forming the vertices of a regular $n$-gon.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$w = Re^{i\\phi},\\ n$', operation: 'take $n$-th root of $R$, divide angle, enumerate $k$' },
            { value: '$n$ roots $z_0, z_1, \\ldots, z_{n-1}$' }
          ]
        }
      ],
      derivation: [
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `The $n$ solutions to $z^n = 1$. All lie on the unit circle, equally spaced at angles $2\\pi/n$ apart, forming the vertices of a regular $n$-gon with one vertex at $1$.`,
      explanation: [
        `The $n$ solutions to $z^n = 1$. All lie on the unit circle, equally spaced at angles $2\\pi/n$ apart, forming the vertices of a regular $n$-gon with one vertex at $1$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$n$', operation: 'distribute $n$ points around unit circle at spacing $2\\pi/n$' },
            { value: '$n$ roots $z_0, z_1, \\ldots, z_{n-1}$' }
          ]
        }
      ],
      derivation: [
        `Apply the $n$-th roots formula to $w = 1$ (so $R = 1$, $\\phi = 0$).`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$w = 1 = 1 \\cdot e^{i \\cdot 0}$', operation: 'apply $n$-th roots formula' },
            { expr: '$z_k = 1^{1/n} \\cdot e^{i(0 + 2\\pi k)/n}$', operation: 'simplify' },
            { expr: '$z_k = e^{i \\, 2\\pi k / n}, \\quad k = 0, 1, \\ldots, n-1$', tag: 'result' }
          ]
        }
      ],
      conditions: `$n$ is a positive integer.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `The sum of all $n$-th roots of unity is zero whenever $n \\geq 2$. Geometrically, the roots form a regular polygon centered at the origin — placed tip-to-tail as vectors, they return to the starting point. Algebraically, this is a finite geometric series with ratio $\\omega \\neq 1$.`,
      explanation: [
        `The sum of all $n$-th roots of unity is zero whenever $n \\geq 2$. Geometrically, the roots form a regular polygon centered at the origin — placed tip-to-tail as vectors, they return to the starting point. Algebraically, this is a finite geometric series with ratio $\\omega \\neq 1$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$n$-th roots of unity ($n \\geq 2$)', operation: 'sum' },
            { value: '$0$' }
          ]
        }
      ],
    ...
    fields: {
      ...
      explanation: [
        `Connects exponential and trigonometric functions through the imaginary unit. Foundation of the exponential form of complex numbers and of every operation in polar coordinates.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$e^{i\\theta}$', operation: 'apply Euler' },
            { value: '$\\cos\\theta + i\\sin\\theta$' }
          ]
        }
      ],
      derivation: [
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Special case of Euler's formula at $\\theta = \\pi$. Connects five fundamental constants — $e$, $i$, $\\pi$, $1$, and $0$ — in a single equation. Often cited as the most elegant equation in mathematics.`,
      explanation: [
        `Special case of Euler&apos;s formula at $\\theta = \\pi$. Connects five fundamental constants — $e$, $i$, $\\pi$, $1$, and $0$ — in a single equation. Often cited as the most elegant equation in mathematics.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\theta = \\pi$ in $e^{i\\theta}$', operation: 'evaluate: $\\cos\\pi + i\\sin\\pi = -1$' },
            { value: '$e^{i\\pi} + 1 = 0$' }
          ]
        }
      ],
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Powers of $i$ cycle through four values with period 4. To compute $i^k$ for any integer $k$, divide $k$ by 4 and use the remainder.`,
      explanation: [
        `Powers of $i$ cycle through four values with period 4. To compute $i^k$ for any integer $k$, divide $k$ by 4 and use the remainder.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$i^1 = i$', operation: '$\\times i$' },
            { value: '$i^2 = -1$', operation: '$\\times i$' },
            { value: '$i^3 = -i$', operation: '$\\times i$' },
            { value: '$i^4 = 1$ (cycle repeats)' }
          ]
        }
      ],
      derivation: [
        `Start from $i^2 = -1$ and multiply by $i$ repeatedly.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$i^2 = -1$', operation: 'multiply by $i$' },
            { expr: '$i^3 = i^2 \\cdot i = -i$', operation: 'multiply by $i$' },
            { expr: '$i^4 = i^3 \\cdot i = -i \\cdot i = -i^2 = 1$', operation: 'multiply by $i$' },
            { expr: '$i^5 = i^4 \\cdot i = i$ — cycle length 4', tag: 'result' }
          ]
        }
      ],
      conditions: `$k \\in \\mathbb{Z}$. The cycle extends to negative exponents: $i^{-1} = -i$, $i^{-2} = -1$, etc.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Extracts the imaginary unit from the square root of a negative real number. Verification: $(i\\sqrt{a})^2 = i^2 \\cdot a = -a$.`,
      explanation: [
        `Extracts the imaginary unit from the square root of a negative real number. Verification: $(i\\sqrt{a})^2 = i^2 \\cdot a = -a$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\sqrt{-a}$ ($a > 0$)', operation: 'extract $i$' },
            { value: '$i\\sqrt{a}$' }
          ]
        }
      ],
      derivation: [
        `Verify by squaring the candidate value.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$(i\\sqrt{a})^2 = i^2 \\cdot (\\sqrt{a})^2$', operation: 'use $i^2 = -1$ and $(\\sqrt{a})^2 = a$' },
            { expr: '$= -1 \\cdot a = -a$', operation: 'therefore $i\\sqrt{a}$ is a square root of $-a$' },
            { expr: '$\\sqrt{-a} = i\\sqrt{a}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$a > 0$. The standard product rule $\\sqrt{xy} = \\sqrt{x}\\sqrt{y}$ does NOT hold when both factors are negative — always extract $i$ from each negative radicand before multiplying.`,
...

  {
    ...
    fields: {
      ...
      // explanation: `Multiplying complex numbers adds their arguments. Geometrically, multiplication by $z_2$ rotates by $\\arg(z_2)$. Equality holds modulo $2\\pi$ since arguments are determined only up to multiples of $2\\pi$.`,
      explanation: [
        `Multiplying complex numbers adds their arguments. Geometrically, multiplication by $z_2$ rotates by $\\arg(z_2)$. Equality holds modulo $2\\pi$ since arguments are determined only up to multiples of $2\\pi$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\arg(z_1 \\cdot z_2)$', operation: 'add arguments' },
            { value: '$\\arg(z_1) + \\arg(z_2)$' }
          ]
        }
      ],
      derivation: [
        `Multiply in exponential form and read off the argument.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z_1 z_2 = r_1 e^{i\\theta_1} \\cdot r_2 e^{i\\theta_2}$', operation: 'exponent rule' },
            { expr: '$= r_1 r_2 \\, e^{i(\\theta_1 + \\theta_2)}$', operation: 'read argument' },
            { expr: '$\\arg(z_1 z_2) = \\theta_1 + \\theta_2 = \\arg(z_1) + \\arg(z_2)$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z_1, z_2 \\neq 0$. When using the principal argument $\\mathrm{Arg}$, the result may need normalization to stay in $(-\\pi, \\pi]$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Dividing complex numbers subtracts their arguments. Geometrically, division by $z_2$ rotates clockwise by $\\arg(z_2)$. Modulo $2\\pi$.`,
      explanation: [
        `Dividing complex numbers subtracts their arguments. Geometrically, division by $z_2$ rotates clockwise by $\\arg(z_2)$. Modulo $2\\pi$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\arg(z_1 / z_2)$', operation: 'subtract arguments' },
            { value: '$\\arg(z_1) - \\arg(z_2)$' }
          ]
        }
      ],
      derivation: [
        `Divide in exponential form and read off the argument.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$\\dfrac{z_1}{z_2} = \\dfrac{r_1 e^{i\\theta_1}}{r_2 e^{i\\theta_2}}$', operation: 'exponent rule' },
            { expr: '$= \\dfrac{r_1}{r_2} \\, e^{i(\\theta_1 - \\theta_2)}$', operation: 'read argument' },
            { expr: '$\\arg(z_1/z_2) = \\theta_1 - \\theta_2 = \\arg(z_1) - \\arg(z_2)$', tag: 'result' }
          ]
        }
      ],
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Raising to the $n$-th power multiplies the argument by $n$. Direct consequence of the product rule applied $n$ times. Underlies De Moivre's theorem.`,
      explanation: [
        `Raising to the $n$-th power multiplies the argument by $n$. Direct consequence of the product rule applied $n$ times. Underlies De Moivre&apos;s theorem.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\arg(z^n)$', operation: 'multiply argument by $n$' },
            { value: '$n \\cdot \\arg(z)$' }
          ]
        }
      ],
      derivation: [
        `Compute in exponential form.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z^n = (r e^{i\\theta})^n = r^n e^{in\\theta}$', operation: 'read argument' },
            { expr: '$\\arg(z^n) = n\\theta = n \\cdot \\arg(z)$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z \\neq 0$ and $n \\in \\mathbb{Z}$. Modulo $2\\pi$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Conjugation reflects across the real axis, negating the angle. The modulus is preserved.`,
      explanation: [
        `Conjugation reflects across the real axis, negating the angle. The modulus is preserved.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\arg(\\overline{z})$', operation: 'negate argument' },
            { value: '$-\\arg(z)$' }
          ]
        }
      ],
      derivation: [
        `Conjugate the trigonometric form and use $\\cos(-\\theta) = \\cos\\theta$, $\\sin(-\\theta) = -\\sin\\theta$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z = r(\\cos\\theta + i\\sin\\theta)$', operation: 'conjugate' },
            { expr: '$\\overline{z} = r(\\cos\\theta - i\\sin\\theta) = r(\\cos(-\\theta) + i\\sin(-\\theta))$', operation: 'read argument' },
            { expr: '$\\arg(\\overline{z}) = -\\theta = -\\arg(z)$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z \\neq 0$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Negation rotates by $180°$. Geometrically, $-z$ is the diametrically opposite point through the origin.`,
      explanation: [
        `Negation rotates by $180°$. Geometrically, $-z$ is the diametrically opposite point through the origin.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$\\arg(-z)$', operation: 'add $\\pi$ to argument' },
            { value: '$\\arg(z) + \\pi$' }
          ]
        }
      ],
      derivation: [
        `Write $-1 = e^{i\\pi}$ and apply the argument-of-product rule.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$-z = e^{i\\pi} \\cdot z = e^{i\\pi} \\cdot r e^{i\\theta}$', operation: 'combine exponents' },
            { expr: '$= r e^{i(\\theta + \\pi)}$', operation: 'read argument' },
            { expr: '$\\arg(-z) = \\theta + \\pi = \\arg(z) + \\pi$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z \\neq 0$. Modulo $2\\pi$.`,
...

  {
    ...
    fields: {
      ...
      // explanation: `The unique complex number satisfying $z + (-z) = 0$. Both real and imaginary parts negate. Geometrically, reflection through the origin (rotation by $180°$).`,
      explanation: [
        `The unique complex number satisfying $z + (-z) = 0$. Both real and imaginary parts negate. Geometrically, reflection through the origin (rotation by $180°$).`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z = a + bi$', operation: 'negate both parts' },
            { value: '$-z = -a - bi$' }
          ]
        }
      ],
      derivation: [
        `Verify that $-a - bi$ satisfies the defining equation $z + (-z) = 0$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z + (-a - bi) = (a + bi) + (-a - bi)$', operation: 'add real and imaginary parts' },
            { expr: '$= (a + (-a)) + (b + (-b))i = 0 + 0i$', operation: 'therefore $-a - bi$ is the additive inverse' },
            { expr: '$-z = -a - bi$', tag: 'result' }
          ]
        }
      ],
      conditions: `Defined for every $z \\in \\mathbb{C}$. The number $0$ is its own additive inverse.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `The unique complex number satisfying $z \\cdot z^{-1} = 1$. Found by multiplying $1/z$ by $\\overline{z}/\\overline{z}$, which converts the denominator to the real number $|z|^2$.`,
      explanation: [
        `The unique complex number satisfying $z \\cdot z^{-1} = 1$. Found by multiplying $1/z$ by $\\overline{z}/\\overline{z}$, which converts the denominator to the real number $|z|^2$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z$', operation: 'divide $\\overline{z}$ by $|z|^2$' },
            { value: '$z^{-1} = \\frac{\\overline{z}}{|z|^2}$' }
          ]
        }
      ],
      derivation: [
    ...
    fields: {
      ...
      explanation: [
        `The modulus of the inverse is the reciprocal of the modulus. Numbers far from the origin have inverses close to the origin, and vice versa. Numbers on the unit circle have inverses also on the unit circle.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$|z^{-1}|$', operation: 'take reciprocal of modulus' },
            { value: '$\\frac{1}{|z|}$' }
          ]
        }
      ],
      derivation: [
        `Apply modulus to $z \\cdot z^{-1} = 1$ and use the product rule.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z \\cdot z^{-1} = 1$', operation: 'take modulus, apply product rule' },
            { expr: '$|z| \\cdot |z^{-1}| = 1$', operation: 'solve' },
            { expr: '$|z^{-1}| = \\dfrac{1}{|z|}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$z \\neq 0$.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Euclidean distance between two points in the complex plane. The modulus of the difference equals the straight-line distance — direct application of the Pythagorean theorem to the right triangle with legs $|a_1 - a_2|$ and $|b_1 - b_2|$.`,
      explanation: [
        `Euclidean distance between two points in the complex plane. The modulus of the difference equals the straight-line distance — direct application of the Pythagorean theorem to the right triangle with legs $|a_1 - a_2|$ and $|b_1 - b_2|$.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$z_1,\\ z_2$', operation: 'subtract, take modulus' },
            { value: '$|z_1 - z_2|$' }
          ]
        }
      ],
      derivation: [
        `Subtract in components, then apply the modulus formula.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$z_1 - z_2 = (a_1 - a_2) + (b_1 - b_2)i$', operation: 'take modulus' },
            { expr: '$|z_1 - z_2| = \\sqrt{(a_1 - a_2)^2 + (b_1 - b_2)^2}$', tag: 'result' }
          ]
        }
      ],
      conditions: `Defined for all $z_1, z_2 \\in \\mathbb{C}$. Equals zero if and only if $z_1 = z_2$.`,
...

  {
    ...
    fields: {
      ...
      // explanation: `Every non-constant polynomial with complex coefficients factors completely into linear terms over $\\mathbb{C}$. A polynomial of degree $n$ has exactly $n$ roots, counted with multiplicity. This is what makes $\\mathbb{C}$ algebraically closed — no further extension of the number system is needed to solve polynomial equations.`,
      explanation: [
        `Every non-constant polynomial with complex coefficients factors completely into linear terms over $\\mathbb{C}$. A polynomial of degree $n$ has exactly $n$ roots, counted with multiplicity. This is what makes $\\mathbb{C}$ algebraically closed — no further extension of the number system is needed to solve polynomial equations.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$p(z)$ of degree $n$', operation: 'factor over $\\mathbb{C}$' },
            { value: '$a_n(z - z_1)(z - z_2) \\cdots (z - z_n)$' }
          ]
        }
      ],
      // DERIVATION SKIPPED: proof requires complex analysis (Liouville's theorem) or algebraic topology, beyond scope.
      conditions: `$p(z)$ has degree $n \\geq 1$ with coefficients in $\\mathbb{C}$. The leading coefficient is $a_n \\neq 0$. Roots $z_1, \\ldots, z_n$ may repeat.`,
      notation: `A root with multiplicity $m$ appears $m$ times in the factorization. The total number of roots, counting multiplicity, equals the degree.`,
      related_formulas: `- [Conjugate Root Theorem](!/complex-numbers/formulas#conjugate_root_theorem)\n- [Vieta's Quadratic](!/complex-numbers/formulas#vietas_quadratic)\n- [Quadratic Formula in Complex](!/complex-numbers/formulas#quadratic_formula_in_complex)`,
      related_definitions: `- [Complex Number](!/complex-numbers/definitions#complex_number)`
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `For a polynomial with real coefficients, complex roots come in conjugate pairs. If $z_0$ is a root, so is $\\overline{z_0}$. Consequence: every real polynomial of odd degree has at least one real root.`,
      explanation: [
        `For a polynomial with real coefficients, complex roots come in conjugate pairs. If $z_0$ is a root, so is $\\overline{z_0}$. Consequence: every real polynomial of odd degree has at least one real root.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$p(z_0) = 0$ (real coefficients)', operation: 'conjugate' },
            { value: '$p(\\overline{z_0}) = 0$' }
          ]
        }
      ],
      derivation: [
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `The quadratic formula extends to complex coefficients without modification. Every quadratic equation $az^2 + bz + c = 0$ has exactly two roots in $\\mathbb{C}$ (counting multiplicity), regardless of whether the discriminant is real or complex.`,
      explanation: [
        `The quadratic formula extends to complex coefficients without modification. Every quadratic equation $az^2 + bz + c = 0$ has exactly two roots in $\\mathbb{C}$ (counting multiplicity), regardless of whether the discriminant is real or complex.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$a,\\ b,\\ c$ (complex)', operation: 'compute discriminant $b^2 - 4ac$' },
            { value: '$\\sqrt{\\Delta}$', operation: 'apply $\\pm$, divide by $2a$' },
            { value: '$z_1,\\ z_2$' }
          ]
        }
      ],
      derivation: [
        `Complete the square. Identical to the real derivation; only the square root may be complex.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$az^2 + bz + c = 0$', operation: 'divide by $a$' },
            { expr: '$z^2 + \\dfrac{b}{a}z + \\dfrac{c}{a} = 0$', operation: 'complete the square' },
            { expr: '$\\left(z + \\dfrac{b}{2a}\\right)^2 = \\dfrac{b^2 - 4ac}{4a^2}$', operation: 'take square root' },
            { expr: '$z + \\dfrac{b}{2a} = \\pm\\dfrac{\\sqrt{b^2 - 4ac}}{2a}$', operation: 'solve for $z$' },
            { expr: '$z = \\dfrac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$a, b, c \\in \\mathbb{C}$ and $a \\neq 0$. When the discriminant is complex, computing $\\sqrt{b^2 - 4ac}$ requires the $n$-th roots formula or De Moivre's theorem.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `Relates the roots of a quadratic $az^2 + bz + c = 0$ to its coefficients without solving the equation. Same form as in the real case — Vieta's formulas extend to complex roots unchanged.`,
      explanation: [
        `Relates the roots of a quadratic $az^2 + bz + c = 0$ to its coefficients without solving the equation. Same form as in the real case — Vieta&apos;s formulas extend to complex roots unchanged.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: '$a,\\ b,\\ c$', operation: 'compute $-b/a$ and $c/a$' },
            { value: '$z_1 + z_2,\\ z_1 \\cdot z_2$' }
          ]
        }
      ],
      derivation: [
        `Expand $a(z - z_1)(z - z_2)$ and match coefficients with $az^2 + bz + c$.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$a(z - z_1)(z - z_2) = a\\bigl[z^2 - (z_1 + z_2)z + z_1 z_2\\bigr]$', operation: 'identify with $az^2 + bz + c$' },
            { expr: '$-a(z_1 + z_2) = b \\;\\Rightarrow\\; z_1 + z_2 = -\\dfrac{b}{a}$', operation: 'match constant term' },
            { expr: '$a \\cdot z_1 z_2 = c \\;\\Rightarrow\\; z_1 z_2 = \\dfrac{c}{a}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$a \\neq 0$. Coefficients may be real or complex.`,
  ...
  },
  {
    ...
    fields: {
      ...
      // explanation: `For a polynomial of degree $n$, the elementary symmetric sums of its roots equal the coefficients (up to sign and division by $a_n$). The sum of roots and the product of roots are the simplest cases; intermediate symmetric sums correspond to coefficients in between.`,
      explanation: [
        `For a polynomial of degree $n$, the elementary symmetric sums of its roots equal the coefficients (up to sign and division by $a_n$). The sum of roots and the product of roots are the simplest cases; intermediate symmetric sums correspond to coefficients in between.`,
        {
          component: 'FunctionMachineDiagram',
          steps: [
            { value: 'coefficients $a_0, \\ldots, a_n$', operation: 'compute symmetric sums of roots' },
            { value: '$\\sum r_i,\\ \\prod r_i,\\ \\ldots$' }
          ]
        }
      ],
      derivation: [
        `Expand the factored form $p(z) = a_n \\prod_{i=1}^{n}(z - r_i)$ and match coefficients with the standard form.`,
        {
          component: 'MathDerivation',
          items: [
            { expr: '$p(z) = a_n(z - r_1)(z - r_2) \\cdots (z - r_n)$', operation: 'expand' },
            { expr: '$= a_n\\bigl[z^n - (\\textstyle\\sum r_i) z^{n-1} + \\cdots + (-1)^n \\textstyle\\prod r_i\\bigr]$', operation: 'match $z^{n-1}$ coefficient' },
            { expr: '$-a_n \\textstyle\\sum r_i = a_{n-1} \\;\\Rightarrow\\; \\sum r_i = -\\dfrac{a_{n-1}}{a_n}$', operation: 'match constant term' },
            { expr: '$a_n (-1)^n \\textstyle\\prod r_i = a_0 \\;\\Rightarrow\\; \\prod r_i = (-1)^n \\dfrac{a_0}{a_n}$', tag: 'result' }
          ]
        }
      ],
      conditions: `$a_n \\neq 0$. Roots $r_1, \\ldots, r_n$ are the $n$ roots in $\\mathbb{C}$ (with multiplicity).`,

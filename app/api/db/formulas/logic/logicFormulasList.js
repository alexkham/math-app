...

{
  ...
  fields: {
    explanation: [
      `If $P$ already participates in a disjunction, repeating it adds no information. The duplicate is dropped, leaving the simpler $P \\lor Q$.`,
      {
        component: 'FunctionMachineDiagram',
        steps: [
          { value: '$P \\lor (Q \\lor P)$', operation: 'commute, associate' },
          { value: '$(P \\lor P) \\lor Q$', operation: 'idempotent' },
          { value: '$P \\lor Q$' }
        ]
      }
    ],
...

{
  ...
  fields: {
    explanation: [
      `If $P$ already participates in a conjunction, repeating it adds no information. The duplicate is dropped, leaving the simpler $P \\land Q$.`,
      {
        component: 'FunctionMachineDiagram',
        steps: [
          { value: '$P \\land (Q \\land P)$', operation: 'commute, associate' },
          { value: '$(P \\land P) \\land Q$', operation: 'idempotent' },
          { value: '$P \\land Q$' }
        ]
      }
    ],
...

{
  ...
  fields: {
    explanation: [
      `A conditional is logically equivalent to its contrapositive — both parts negated and swapped. This equivalence is the basis for proof by contraposition: to prove $P \\to Q$, one may instead prove $\\neg Q \\to \\neg P$.`,
      {
        component: 'FunctionMachineDiagram',
        steps: [
          { value: '$P \\to Q$', operation: 'Material Implication' },
          { value: '$\\neg P \\lor Q$', operation: 'commute, Double Negation' },
          { value: '$\\neg Q \\to \\neg P$' }
        ]
      }
    ],
  ...
  fields: {
    explanation: [
      `The negation of a conditional is a conjunction, not another conditional. To deny "if $P$ then $Q$" is to assert that $P$ holds while $Q$ fails — the one case in which the implication is broken.`,
      {
        component: 'FunctionMachineDiagram',
        steps: [
          { value: '$\\neg(P \\to Q)$', operation: 'Material Implication' },
          { value: '$\\neg(\\neg P \\lor Q)$', operation: 'De Morgan, Double Negation' },
          { value: '$P \\land \\neg Q$' }
        ]
      }
    ],

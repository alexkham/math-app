...

{
  ...
  fields: {
    explanation: [
      `An input $x$ is valid for $f \\circ g$ only if two conditions both hold: $x$ must be in the domain of the inner function $g$, and the output $g(x)$ must be a valid input for the outer function $f$. Either failure removes $x$ from the composite domain.`,
      {
        component: 'FunctionMachineDiagram',
        steps: [
          { value: '$x$', operation: 'check $x \\in \\text{Dom}(g)$' },
          { value: '$g(x)$', operation: 'check $g(x) \\in \\text{Dom}(f)$' },
          { value: '$x \\in \\text{Dom}(f \\circ g)$' }
        ]
      }
    ],
...

{
 ...
 link: { label: "Inverse of a Composition", url: "/functions/composition#7" },
...

{
  ...
  category: 'Inverse Functions',
  formula: `$$(f^{-1})^{-1} = f$$`,
 link: { label: "Inverse of an Inverse", url: "/functions/inverse#1" },
    ...
    explanation: [
      `The master transformation form. Four parameters control how the parent graph is reshaped: $h$ shifts horizontally, $k$ shifts vertically, $a$ scales/reflects vertically, $b$ scales/reflects horizontally. Inside-the-function operations affect $x$; outside-the-function operations affect $y$.`,
      {
        ...
        steps: [
          ...
          { value: '$f(b(x - h))$', operation: 'scale & shift: $a\\,\\cdot + k$' },
          { value: '$g(x)$' }
        ]
      }
    ],
...

{
 ...
 link: { label: "Point Slope Form", url: "/functions/families#4" },
...

{
  ...
  category: 'Linear Function Forms',
  formula: `$$Ax + By = C$$`,
  link: { label: "Standard Form Linear", url: "/functions/families#4" },
  // TODO: target /functions/families — formula not currently displayed on site
  fields: {
...

{
  ...
  link: { label: "Slope Formula", url: "/functions/families#4" },
  // TODO: target /functions/families — formula not currently displayed on site
...

{
 ...
 link: { label: "Perpendicular Slopes", url: "/functions/families#4" },
  // TODO: target /functions/families — formula not currently displayed on site
  fields: {
...

{
  ...
  link: { label: "Factored Form Quadratic", url: "/functions/families#5" },
  // TODO: target /functions/families — formula not currently displayed on site
  fields: {
...

{
  ...
  link: { label: "Difference Quotient", url: "/functions/properties#17" },

...
- [Complement](!/set-theory/definitions#complement) — $\\emptyset^c = U$ and $U^c = \\emptyset$
- [Subset](!/set-theory/definitions#subset) — $\\emptyset$ is a subset of every set`,
      "related formulas": `- [Complement Law - Intersection](!/set-theory/formulas#complement)
- [Domination Law - Intersection](!/set-theory/formulas#intersection)
- [Identity Law - Union](!/set-theory/formulas#union)`,
    },
    category: "Fundamentals",
  },
...
- [Complement](!/set-theory/definitions#complement) — defined relative to $U$
- [Set](!/set-theory/definitions#set) — every set is a subset of $U$`,
      "related formulas": `- [Complement Law - Union](!/set-theory/formulas#complement)
- [Domination Law - Union](!/set-theory/formulas#union)
- [Identity Law - Intersection](!/set-theory/formulas#intersection)`,
    },
    category: "Fundamentals",
  },
...
- [Power Set](!/set-theory/definitions#power_set) — the collection of all subsets
- [Equal Sets](!/set-theory/definitions#equal_sets) — mutual subset containment`,
      "related formulas": `- [Set Equality Criterion](!/set-theory/formulas#equal_sets)`,
    },
    category: "Subsets",
  },
...
- [Superset](!/set-theory/definitions#superset) — the inverse relation
- [Empty Set](!/set-theory/definitions#empty_set) — proper subset of every non-empty set`,
      "related formulas": `- [Number of Proper Subsets](!/set-theory/formulas#proper_subset)`,
    },
    category: "Subsets",
  },
...
Four subsets, matching $2^2 = 4$.`,
      "related concepts": `- [Subset](!/set-theory/definitions#subset) — each element of the power set is a subset
- [Cardinality](!/set-theory/definitions#cardinality) — $|\\mathcal{P}(A)| = 2^{|A|}$`,
      "related formulas": `- [Cantor Theorem](!/set-theory/formulas#cardinality)
- [Cardinality of Power Set](!/set-theory/formulas#power_set)`,
    },
    category: "Subsets",
  },
...
- [Partition](!/set-theory/definitions#partition) — built from mutually disjoint subsets
- [Intersection](!/set-theory/definitions#intersection) — disjoint means intersection is empty`,
      "related formulas": `- [Cardinality of Disjoint Union](!/set-theory/formulas#cardinality)`,
    },
    category: "Relationships",
  },
...
- [Set Difference](!/set-theory/definitions#set_difference) — elements in one but not the other
- [Venn Diagram](!/set-theory/definitions#venn_diagram) — union is the total shaded area`,
      "related formulas": `- [De Morgan Law - Union](!/set-theory/formulas#complement)
- [Distributive Law - Intersection over Union](!/set-theory/formulas#intersection)
- [Idempotent Law - Union](!/set-theory/formulas#union)
- [Inclusion-Exclusion - Two Sets](!/set-theory/formulas#cardinality)
- [Symmetric Difference - Union Minus Intersection](!/set-theory/formulas#symmetric_difference)`,
    },
    category: "Operations",
  },
...
- [Overlapping Sets](!/set-theory/definitions#overlapping_sets) — intersection is non-empty`,
      "related formulas": `- [De Morgan Law - Union](!/set-theory/formulas#complement)
- [Difference as Intersection with Complement](!/set-theory/formulas#set_difference)
- [Distributive Law - Union over Intersection](!/set-theory/formulas#union)
- [Idempotent Law - Intersection](!/set-theory/formulas#intersection)
- [Inclusion-Exclusion - Two Sets](!/set-theory/formulas#cardinality)
- [Symmetric Difference - Union Minus Intersection](!/set-theory/formulas#symmetric_difference)`,
    },
    category: "Operations",
...
- [Symmetric Difference](!/set-theory/definitions#symmetric_difference) — combines both one-sided differences
- [Intersection](!/set-theory/definitions#intersection) — $A \\setminus B = A \\cap B^c$`,
      "related formulas": `- [Difference as Intersection with Complement](!/set-theory/formulas#set_difference)
- [Symmetric Difference - Union Minus Intersection](!/set-theory/formulas#symmetric_difference)`,
    },
    category: "Operations",
  },
...
- [Union](!/set-theory/definitions#union) — $A \\triangle B \\subseteq A \\cup B$
- [Disjoint Sets](!/set-theory/definitions#disjoint_sets) — when $A \\cap B = \\emptyset$, $A \\triangle B = A \\cup B$`,
      "related formulas": `- [Symmetric Difference - Union Minus Intersection](!/set-theory/formulas#symmetric_difference)`,
    },
    category: "Operations",
  },
...
- [Equivalent Sets](!/set-theory/definitions#equivalent_sets) — sets with the same cardinality
- [Power Set](!/set-theory/definitions#power_set) — $|\\mathcal{P}(A)| = 2^{|A|}$`,
      "related formulas": `- [Cardinality of Power Set](!/set-theory/formulas#power_set)
- [Inclusion-Exclusion - Two Sets](!/set-theory/formulas#cardinality)
- [Number of Proper Subsets](!/set-theory/formulas#proper_subset)`,
    },
    category: "Cardinality",
  },

...
// // ============================================================================
// // VENN CORE — universal renderer + utilities
// // ============================================================================
// // Exports:
// //   VennDiagram               — set-count agnostic SVG renderer
// //   buildTwoSetDiagram        — 2-set geometry adapter
// //   resolveDiagram            — apply theme + highlight to a geometry result
// //   highlightFromPredicate    — predicate → region keys (default: 2-set table)
// //   highlightsMatch           — set-equality on region key arrays
// //   TWO_SET_REGION_TABLE      — truth table for 2 sets (a,b) → region key
// //
// // To add N-set support later, add another adapter (e.g. buildThreeSetDiagram)
// // and another region table. The renderer and resolver stay unchanged.
// // ============================================================================

// import React, { useState, useMemo, useRef } from 'react';

// // ----------------------------------------------------------------------------
// // Geometry primitives (2-set)
// // ----------------------------------------------------------------------------
...
// // ----------------------------------------------------------------------------
// // 2-set adapter — produces universal diagram input
// // ----------------------------------------------------------------------------
...
// /**
//  * Build a universal diagram input for 2 sets.
//  *
//  * @param {{A: Circle, B: Circle}} circles
//  * @param {Rect} universeRect
//  * @returns {{ regions, arcs, anchors, classification }}
//  *   regions: { [key]: { path } }   — fill/opacity/labels filled in by resolver
//  *   arcs:    [{ id, d, circle, segment, bounds }]
//  *   anchors: { [key]: {x,y}|null }
//  */
...
// // ----------------------------------------------------------------------------
// // Predicate → highlight (generic over any region table)
// // ----------------------------------------------------------------------------
...
// // ----------------------------------------------------------------------------
// // Scenario resolver — universal (no set-count assumptions)
// // ----------------------------------------------------------------------------

// /**
//  * Take a geometry result and apply theme + per-region styling.
//  *
//  * @param {object} geometry      output of buildTwoSetDiagram or similar
//  * @param {string[]} highlight   keys of regions to color with theme
//  * @param {object} theme         { color, opacity, neutralFill, outsideNeutralFill }
//  * @param {object} extras        { labels, tooltips, regionStyles }
//  * @returns regions object ready for VennDiagram
//  */
...
// /**
//  * Universal Venn renderer. Knows nothing about set count.
//  *
//  * Props:
//  *   width, height, backgroundColor
//  *   universe:      { rect: {x,y,width,height}, label, labelPosition, stroke, strokeWidth }
//  *   regions:       { [key]: { path, fill, opacity, label, labelPosition, tooltip, stroke, strokeWidth, hidden } }
//  *   regionOrder:   optional render order for regions
//  *   arcs:          [{ id, d, circle, segment, bounds, stroke, strokeWidth, hidden }]
//  *   circles:       array of { cx, cy, r, label, labelPosition, stroke, strokeWidth, strokeSegments }
//  *                  (used for arc stroke lookup + circle labels)
//  *   autoHideArcs   default false
//  *   enableHover, enableHoverStroke, hoverHighlightStroke, hoverHighlightStrokeWidth
//  *   showTooltip
//  *   onRegionClick, onRegionHover
//  */
// export const Venncore = ({
//   // ---- simple inputs (computed internally if `regions` not provided) ----
//   highlight = null,
//   predicate = null,
//   theme = null,
//   labels = null,
...
//   // ---- advanced inputs (override the auto-computed result) ----
//   universe = null,
...
//   // Auto-compute geometry from simple inputs if `regions` not explicitly passed.
//   // Simple mode: `circles` is an object { A: {...}, B: {...} } and `highlight` is provided.
//   // Advanced mode: `regions` and `arcs` passed explicitly.
//   const { regions, arcs, circlesArr, universeFinal, order } = useMemo(() => {
//     if (regionsProp) {
//       // advanced mode — use what's passed
//       return {
//         regions: regionsProp,
//         arcs: arcsProp || [],
...
//     };
//   }, [regionsProp, arcsProp, regionOrderProp, circles, highlight, theme, labels, tooltips, regionStyles, margin, width, height, universe]);

//   // Map circle config by key/label for arc stroke lookup
...
// // ----------------------------------------------------------------------------
// // Convenience: build everything VennDiagram needs from a 2-set scenario.
// // ----------------------------------------------------------------------------

// /**
//  * One-shot helper: take 2-set scenario inputs, return props ready for VennDiagram.
//  *
//  * @param {object} input
//  *   circles: { A, B }
//  *   universeRect: { x, y, width, height } | null  (computed from canvas if null)
//  *   width, height, margin
//  *   highlight: string[]
//  *   theme: { color, opacity, neutralFill, outsideNeutralFill }
//  *   labels, tooltips, regionStyles
//  *   universe: { label, labelPosition, stroke, strokeWidth, labelColor, labelFontSize }
//  */
...
// export default Venncore;

'use client';

// ============================================================================
// VENN CORE — universal renderer + utilities + ExplanationsPanel
// ============================================================================
// IMPORTANT: fix the processContent import path below to match your project.
// If the path is wrong, the whole module fails to load and both Venncore and
// ExplanationsPanel become undefined in their consumers.
// ============================================================================

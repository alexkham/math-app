...
// //     line-height: 1;
// //   }
// //   .se-tab.active .se-help { background: rgba(59, 91, 219, 0.16); }
// //   .se-help::after {
...
// //   /* ---------- Alerts (teal success for blue theme) ---------- */
// //   .se-alert {
// //     border-radius: 8px;
// //     padding: 12px 16px;
// //     display: flex;
...
//   /* ---------- Tabs: folder shape + solid blue active ---------- */
//   .se-tabs {
//     display: flex;
//     gap: 2px;
...
//   // Hydration-safe gate: processContent (KaTeX) can render differently
//   // between SSR and client. Render math-bearing aside content only after
...
//                 <h3 className="se-aside-heading">How it works</h3>
//                 <div className="se-aside-content">
//                   {mounted ? processContent(modeExp.theory) : null}
//                 </div>
//               </section>
//               <section className="se-aside-section">
//                 <h3 className="se-aside-heading">Walkthrough</h3>
//                 <div className="se-aside-content">
//                   {mounted ? processContent(modeExp.renderWalkthrough(currentResult)) : null}
//                 </div>
//               </section>
//             </>
//           )}

...
// //import styles from './LogicCalculator.module.css'
...
//       />
//       <div>
//         <button className='generate-btn' onClick={handleGenerate} style={{ padding: '10px', margin: '5px' }}>
//           Generate Truth Table
//         </button>
//         <button  className='reset-btn' onClick={clearAll} style={{ padding: '10px', margin: '5px' }}>
//           Reset
//         </button>
//       </div>
...
// //     <div className={styles.latinLetters}>
// //       {letters.map((letter) => (
// //         <button key={letter} onClick={() => insertLetter(letter)} className={styles.button}>
// //           {letter}
// //         </button>
// //       ))}
// //     </div>

// //     <div className={styles.logicOperators}>
// //       {logicalOperators.map((op) => (
// //         <div key={op.symbol} className={styles.operatorContainer}>
// //           <button onClick={() => insertOperator(op.symbol)} className={styles.operatorButton}>
// //             {op.symbol}
// //             <span className={styles.tooltip}>{op.description}</span>
// //           </button>
// //           <span className={styles.infoLink} onClick={(e) => { e.preventDefault(); setSelectedOperator(op.symbol); }}>?</span>
// //         </div>
// //       ))}
// //     </div>
...
// //     />
// //     <div>
// //       <button onClick={handleGenerate} className={`${styles.button} ${styles.primaryButton}`}>
// //         Generate Truth Table
// //       </button>
// //       <button onClick={clearAll} className={`${styles.button} ${styles.primaryButton}`}>
// //         Reset
// //       </button>
// //     </div>
...
// //             <tr key={index}>
// //               {Object.values(row).map((value, i) => (
// //                 <td key={i} className={styles.tableCell}>{value?.toString()}</td>
// //               ))}
// //             </tr>
// //           ))}
// //         </tbody>
...
// //             )}
// //         </div>
// //         <button onClick={() => setSelectedOperator(null)} className={styles.backButton}>Go Back</button>
// //       </div>
// //     )}
// //   </div>
// // );
      ...
      {/* <div className='logic-operators'>
        {logicalOperators.map((op) => (
          ...
          >
            ...
            >
              {op.symbol}
              <span style={{opacity:'1', backgroundColor:'black'}} className="tooltip">{op.description}</span>
            </button>
            <span
              className="info-link"
              onClick={(e) => {
          ...
          <div className='logic-operators'>
            {logicalOperators.map((op) => (
              <div key={op.symbol} style={{ display: 'inline-block', margin: '5px', position: 'relative' }}>
                <button onClick={() => insertOperator(op.symbol)} style={{ padding: '10px', position: 'relative' }}>
                  {op.symbol}
                  <span className="tooltip">{op.description}</span>
                </button>
                <a href={`#${op.symbol.toLowerCase()}`} className="info-link">?</a>
              </div>
            ))}
          </div>

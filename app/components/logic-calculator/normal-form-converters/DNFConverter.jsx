...
// function DNFConverter({ explanations = {
...
//   const [dnfResult, setDnfResult] = useState('');
...
//       // Find rows where result is true
//       const trueRows = truthTableData.filter(row => row.result);
      
//       // For each true row, create a conjunction of literals with parentheses
//       const terms = trueRows.map(row => {
//         const literals = variables.map((variable, index) => {
//           return row.assignments[index] ? variable : `¬${variable}`;
//         });
//         const conjunction = literals.join(' ∧ ');
//         // Always wrap conjunctions in parentheses
//         return literals.length > 1 ? `(${conjunction})` : conjunction;
//       });
      
//       // Join all conjunctions with disjunction
//       let dnf = terms.join(' ∨ ');
      
//       // Handle special cases
//       if (terms.length === 0) {
//         dnf = 'false';  // Contradiction - no rows are true
//       } else if (terms.length === rows.length) {
//         dnf = 'true';   // Tautology - all rows are true
//       }
...
//       // we would use the parser to properly handle nesting and precedence
//       if (subExpr.includes('∧')) {
...
//     // For simplicity, this evaluator has limitations on complex expressions
//     // A real implementation would use a proper parser and evaluator
//     try {
...
//       <h1 style={{ textAlign: 'center', marginBottom: '20px' }}>DNF Converter using Truth Tables</h1>
...
//                     backgroundColor: row.result ? '#e8f5e9' : '#fff',
...
//           <h2 style={{ fontSize: '18px', marginBottom: '10px' }}>DNF Result:</h2>
//           <div style={{ 
//             padding: '12px', 
...
function DNFConverter({ explanations = {
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '100%', margin: '0 auto', padding: '20px' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '10px' ,marginTop:'-30px' }}>DNF Converter using Truth Tables</h2>

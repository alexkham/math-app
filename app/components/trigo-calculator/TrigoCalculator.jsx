...
// import './TrigoCalculator.css';
// import Link from 'next/link';
// import TrigoPanel from './TrigoPanel';
...
//       };
//       setTrigoData(fixedData);
//       // Show panel automatically after calculation
//       if (!showPanel) {
//         setShowPanel(true);
//       }
//     } catch (err) {
...
//                 style={{
//                   ...buttonStyle1,
//                   backgroundColor: showPanel ? '#28a745' : '#1d6bd8',
//                   marginLeft: '10px'
//                 }}
//               >
//                 {showPanel ? 'Hide' : 'Show'} Function Details
//               </button>
//             </form>
//             <div className="calculator-right">
//               {explanations && explanations[selectedFunction] ? (
...
//           {/* Integrated TrigoPanel */}
//           {showPanel && (
//             <TrigoPanel 
//               trigoData={trigoData}
//               selectedFunction={selectedFunction}
//               onFunctionSelect={handleFunctionClick}
//               angle={angle}
//               units={units}
//             />
//           )}
...
const TrigoCalculator = ({explanations}) => {
  ...
  return (
    <div>
      ...
      {/* TrigoPanel - Always visible below the calculator */}
      <TrigoPanel 
        trigoData={trigoData}
        selectedFunction={selectedFunction}
        onFunctionSelect={handleFunctionClick}

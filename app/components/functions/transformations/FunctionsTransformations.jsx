...
// //    Wrapper on VisualizerCore. Pick a base function, then
// //    isolate or combine the four affine transformations:
// //        g(x) = a · f(b(x − h)) + k

// //    PROPS (all optional)
// //      initialFamily      : string
// //      families           : object             — override built-in BASES
...
// // /* ---- general (function-agnostic) explanation for each transform ---- */
// // const GENERAL = {
// //   a: {
...
// //       '- $k > 0$ — slides the whole curve up\n' +
// //       '- $k < 0$ — slides it down\n\n' +
// //       'Shape is unchanged; horizontal features may move.',
// //   },
// //   b: {
...
// //     formula: 'g(x) = f(b · x)',
// //     body:
// //       'Scales the input. Curve compresses horizontally when $|b| > 1$ and stretches when $|b| < 1$ — the *opposite* of vertical scale.\n' +
...
// //     formula: 'g(x) = f(x − h)',
// //     body:
// //       'Slides the whole curve along the x-axis.\n' +
// //       '- $h > 0$ — moves **right** (note the minus sign)\n' +
// //       '- $h < 0$ — moves left\n\n' +
// //       'Shape and y-values are unchanged.',
// //   },
// // };

// // const PARAM_DEFS = {
// //   a: { label: 'vertical scale a',   short: 'Vertical scale',   min: -3, max: 3, step: 0.05, def: 1, animStep: 0.05 },
// //   k: { label: 'vertical shift k',   short: 'Vertical shift',   min: -6, max: 6, step: 0.1,  def: 0, animStep: 0.1  },
// //   b: { label: 'horizontal scale b', short: 'Horizontal scale', min: -3, max: 3, step: 0.05, def: 1, animStep: 0.05 },
// //   h: { label: 'horizontal shift h', short: 'Horizontal shift', min: -6, max: 6, step: 0.1,  def: 0, animStep: 0.1  },
// // };

// // const TAB_ORDER = ['a', 'k', 'b', 'h', 'custom'];

// // /* ---- built-in base families with function-specific notes ---- */
// // export const BASES = {
// //   linear: {
...
// //       k: v => v === 0 ? null : `Slides the line vertically by **${fmt(v)}** — same slope, just shifted ${v > 0 ? 'up' : 'down'}.`,
// //       b: v => v === 1 ? null : `For a line, **b** just rescales the slope: equivalent to slope \`${fmt(v)}\`.`,
// //       h: v => v === 0 ? null : `Shifts the line ${v > 0 ? 'right' : 'left'} by **${fmt(Math.abs(v))}** — indistinguishable from a vertical shift for a pure line.`,
// //     },
// //   },
// //   quadratic: {
...
// //   /* ---- transformed function for the engine ---- */
...
// //   /* ---- InfoPanel tabs (explanation per active transform) ---- */
...
// //     defaultWidth: 900, defaultHeight: 560,
// //     ...visualizerProps,
// //   };
...
// //             }}>
// //               <span style={{ fontSize: 16, letterSpacing: '-0.01em', color: c.ink }}>{fam.name}</span>
...
// //             {/* tab body */}
// //             <div style={{
// //               marginTop: 14, background: c.soft,
...
// // /* =====================================================
// //    FUNCTION TRANSFORMATIONS  (v2)
// //    Layout: [picker] [graph + status chips] [info panel + tabs/sliders]
// //    Tabs have native title tooltips.
// //    ===================================================== */
...
// //     tooltip: 'Multiplies output by a — stretches, compresses, or flips vertically.',
// //     body:
// //       'Multiplies every output by **a**.\n' +
// //       '- $|a| > 1$ — stretches vertically\n' +
// //       '- $0 < |a| < 1$ — compresses vertically\n' +
...
// //     tooltip: 'Adds k to output — slides the curve up or down.',
// //     body:
// //       'Adds a constant **k** to every output.\n' +
// //       '- $k > 0$ — slides up\n' +
// //       '- $k < 0$ — slides down\n\n' +
...
// //     tooltip: 'Scales input — squeezes, stretches, or flips horizontally (opposite to vertical scale).',
// //     body:
// //       'Scales the input. Squeezes when $|b| > 1$, stretches when $|b| < 1$ — *opposite* of vertical scale.\n' +
// //       '- $|b| > 1$ — squeezes horizontally\n' +
// //       '- $0 < |b| < 1$ — stretches horizontally\n' +
// //       '- $b < 0$ — reflects across the y-axis',
// //   },
...
// //       <button
// //         onClick={() => { stopAnim(); setActiveTab(tabKey); }}
// //         title={GENERAL[tabKey]?.tooltip || ''}
// //         style={{
// //           flex: 1, padding: '8px 8px', border: 'none', borderRadius: 6,
...
// //         {/* RIGHT: info panel ON TOP, tabs + sliders BELOW */}

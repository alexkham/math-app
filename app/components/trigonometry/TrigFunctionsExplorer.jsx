...
// //   sin: `**sin(θ)** is the y-coordinate of the point on the unit circle at angle θ.
// // - Range: [-1, 1]
// // - Period: 2π
// // - Zeros at integer multiples of π
// // - Maxima at π/2 + 2πk, minima at -π/2 + 2πk`,

// //   cos: `**cos(θ)** is the x-coordinate of the point on the unit circle at angle θ.
// // - Range: [-1, 1]
// // - Period: 2π
// // - Zeros at π/2 + πk
// // - Maxima at 2πk, minima at π + 2πk`,

// //   tan: `**tan(θ) = sin(θ) / cos(θ)**
// // - Period: π
// // - Vertical asymptotes where cos(θ) = 0, i.e. at π/2 + πk
...
// // - Period: π
// // - Vertical asymptotes where sin(θ) = 0, i.e. at πk
// // - Range: all real numbers
// // - Reciprocal of tan`,
// // };
...
// //   const [unit, setUnit] = useState(initialUnit === 'rad' ? 'rad' : 'deg');
// //   const [angleDeg, setAngleDeg] = useState(initialAngleDeg);

// //   // Merge defaults with passed-in explanations (per-function override)
...
// //                   <button
// //                     onClick={() => setUnit('deg')}
// //                     style={styles.unitButton(unit === 'deg')}
// //                   >
// //                     deg
// //                   </button>
// //                   <button
// //                     onClick={() => setUnit('rad')}
// //                     style={styles.unitButton(unit === 'rad')}
// //                   >
// //                     rad
// //                   </button>
// //                 </div>
...
// //                   {func}({unit === 'deg' ? `${angleDeg}°` : formatRad(angleRad)}) ={' '}
// //                   {(() => {
// //                     const fns = {
...
// //             <details>
// //               <summary style={styles.summary}>Quick angles</summary>

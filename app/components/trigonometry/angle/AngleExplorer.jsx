        ...
        <div style={styles.mainContent}>
          ...
          <div style={styles.leftSection}>
            ...
            <div style={styles.panel}>
              ...
              <div style={styles.controlGroup}>
                <h4 style={{ margin: '0 0 8px 0' }}>Quick Angles:</h4>
              ...
              <div style={styles.controlGroup}>
                <h4 style={{ margin: '0 0 8px 0' }}>Display Options:</h4>
            ...
            <div style={styles.diagramPanel}>
              <svg width="300" height="300" viewBox="0 0 400 400" style={styles.svgContainer}>

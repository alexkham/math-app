      ...
      columns: [
        {
          ...
          items: [
            ...
            { label: 'Visual Base Converter', href: '/arithmetic/visual-tools/base-converter' },
            { label: 'Square Root Visualizer', href: '/visual-tools/square-root' },
            { label: 'Determinant Visual Calculator', href: '/linear-algebra/visual-tools/matrix-determinant' },
            { label: 'Gauss Elimination Calculator', href: '/linear-algebra/visual-tools/gauss-elimination' },
            ...
            { label: 'Matrix Types Generator', href: '/linear-algebra/visual-tools/matrix-types' },

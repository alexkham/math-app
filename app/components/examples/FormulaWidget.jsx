...
//           <div className={styles.formulaContainer}>
//             <h3 className={styles.formulaTitle}>Formula:</h3>
//             <div className={styles.formula}>{renderMathContent(data.formula)}</div>
//           </div>
...
//   //                 name="tabs" 
//   //                 id={`tab${index}`} 
//   //                 className={`${styles.tabInput} ${index === 0 ? styles.defaultActiveTab : ''}`}
//   //                 defaultChecked={index === 0}
//   //               />
//   //               <label htmlFor={`tab${index}`} className={styles.tabLabel}>
//   //                 {renderMathContent(field)}
...
//   //     <br />
//   //     <br />
//   //    {title.length>0&& <div className={styles.header}>
//   //       <h4 className={`${styles.title} ${lora700.className}`}>{renderMathContent(title)}</h4>
//   //     </div>}
//   //     <div className={`${styles.content} ${poppins500.className}`}>
//   //       <div className={styles.formulaContainer}>
...
//   //               {processContent(description)}
//   //             </div> */}
//   //               <div className={`${styles.tabContent} ${index === 0 ? styles.defaultActiveTab : ''}`}>
//   //             {processContent(description)}
//   //           </div>
//   //           </React.Fragment>
//   //         ))}

...
// // //     color: '#475569',
// // //     lineHeight: '1.6',
// // //      overflowX: 'auto',  // horizontal scroll if formula still too wide
// // //   maxWidth: '100%',
// // //   },
// // //   navPanel: {
// // //     background: '#fff',
...
// // //   const tocGridStyle = useMemo(() => {
// // //   const colCount = categories.length <= 2 ? 2 : Math.min(categories.length, 2);
// // //   return { ...S.tocGrid, gridTemplateColumns: `repeat(${colCount}, 1fr)` };
// // // }, [categories]);
...
// // // ─── FitFormula ────────────────────────────────────────────────
// // // Auto-scales content down (never up) so it fits container width.
// // // Uses ResizeObserver + scrollWidth measurement; applies transform: scale().
// // // Wrapper height is adjusted so scaled content doesn't leave whitespace.

// // function FitFormula({ children, minScale = 0.5 }) {
...
// //     const measure = () => {
// //       // Reset transform to read true natural width
...
// //         next = Math.max(minScale, availableWidth / naturalWidth);
// //       }
// //       setScale(next);
...
// //     // KaTeX may finish rendering after mount — re-measure shortly after
...
// //         width: '100%',
// //         overflow: 'hidden',
// //         height: innerHeight != null ? `${innerHeight}px` : 'auto',
// //       }}
// //     >
// //       <div
// //         ref={innerRef}
...
// //             <FitFormula>{processContent(item.formula)}</FitFormula>
// //           </div>
// //           <a style={{ fontSize: '14px', color: ACCENT, cursor: 'pointer', textDecoration: 'none' }} onClick={(e) => { e.preventDefault(); onNavigate(id); }}>
// //             Learn More &#8595;
// //           </a>
...
// // ─── FitFormula ────────────────────────────────────────────────
// // Scales by adjusting font-size on a measurement child.
// // Measures the child's scrollWidth (which reflects nowrap content width)
// // and reduces font-size until it fits.

// function FitFormula({ children, baseFontSize = 16, minFontSize = 8 }) {
//   const outerRef = useRef(null);
//   const innerRef = useRef(null);
...
//       // Start at base font-size and measure
...
//       // Scale font-size proportionally; KaTeX scales linearly with font-size
//       const ratio = available / naturalWidth;
//       const newSize = Math.max(minFontSize, baseFontSize * ratio * 0.98); // 0.98 safety margin
//       setFontSize(newSize);
//     };

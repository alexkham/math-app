...
export default function NormalDistributionCDF({ explanation }) {
  ...
  return (
    <div className="container">
      ...
      <h1>Normal Distribution CDF</h1>
      <p className="subtitle">Visualizing probability accumulation for normal (Gaussian) distribution</p>

      <div className="main-layout">
        <div className="content">
          <div className="distribution-header">
            <h2 className="distribution-title">Normal (Gaussian) - CDF</h2>
            <p className="distribution-description">S-shaped curve, steepest at mean</p>
          </div>

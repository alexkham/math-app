...
//       data: uniformData,
//       explanation: 'The continuous uniform distribution has constant probability density over the interval [a, b]. The probability density function is f(x) = 1/(b-a) for a ≤ x ≤ b, and 0 otherwise. The expected value is E[X] = (a+b)/2 and the variance is Var(X) = (b-a)²/12. This distribution models situations where all values in an interval are equally likely, such as the position of a randomly thrown dart on a board, random arrival times within a time window, or measurement errors uniformly distributed within tolerances.',
//       controls: (
//         <>

...
// // // ===========================================================
// // // Default highlight theme (style name -> visual style)
// // // ===========================================================
...
// // // ===========================================================
// // // MatrixRenderer — renders ONE matrix from props/spec
// // // ===========================================================
...
// // // ===========================================================
// // // Operator — inline symbol between matrices
// // // ===========================================================
...
// // // ===========================================================
// // // SceneCanvas — composes matrices + SVG overlay arrows
// // // Supported overlay types:
// // //   - 'cell-arrow'        : straight line, cell-center to cell-center, arrowhead
// // //   - 'cell-arrow-curve'  : quadratic Bezier between cell centers, arrowhead
// // //   - 'diagonal-axis'     : NEW. Dashed/solid line from top-left corner of
// // //                           cell [0,0] to bottom-right corner of [k-1,k-1]
// // //                           where k = min(displayRows, displayCols). No arrowhead.
// // //                           Spec: { type: 'diagonal-axis', matrix: 'A',
// // //                                   style?: 'primary', color?: '#...',
// // //                                   dashed?: bool, width?: number }
// // // ===========================================================
...
// //           // Optional direction control. 'up' arcs above the matrices
// //           // (default), 'down' arcs below. Useful for spreading many
// //           // overlapping arrows in row/column-wide operations.
...
// //         // Walk diagonal until we run out of cells — gives us k = min(dispRows, dispCols).
// //         let k = 0;
...
// //   const usedColors = Array.from(new Set(overlayElements.map(e => e.color)));
...
// //             ))}
// //           </defs>
// //           {overlayElements.map((el, idx) => {
// //             // axis-line: no marker, custom dash array, lower opacity
...
// // // ===========================================================
// // // ScenePlayer — unchanged from previous version.
// // // ===========================================================
...
// //   const scrollbarHideClass = 'mc-no-scrollbar-' + useId().replace(/:/g, '');
...
// //
// // Diff vs v1:
// //   - Adds a new overlay type 'group-bracket' that visually
// //     groups one or more matrices under a labeled, dashed
// //     (or solid) rectangle. Used by PowerWrapper to render
// //     the bracket-and-collapse choreography.
// //
// //   Spec:
// //     {
// //       type: 'group-bracket',
// //       matrices: ['LEFT', 'RIGHT'],   // matrix IDs to enclose
// //       label: 'A^2',                  // string (HTML allowed); optional
// //       style: 'primary' | 'accent' | 'secondary' | 'muted',
// //       variant: 'dashed' | 'solid',   // default 'dashed'
// //       color: '#...',                 // optional explicit color override
// //       padding: 12,                   // optional px padding around contents
// //       labelOffset: 14                 // optional px above the rect's top
// //     }
// //
// //   Rendered as an HTML <div> with a CSS border (dashed/solid),
// //   semi-transparent fill, and a centered label pill on the top
// //   edge. Sits between the matrix layer and the SVG arrows
// //   layer (z-index 4).
// // ===========================================================

// // ===========================================================
// // Default highlight theme (unchanged)
// // ===========================================================
// export const DEFAULT_HIGHLIGHTS = {
//   primary:       { bg: '#dbeafe', border: '#3b82f6', borderWidth: 2 },
//   secondary:     { bg: '#e2e8f0', border: '#475569', borderWidth: 2 },
...
// // ===========================================================
// // MatrixRenderer — unchanged from v1
// // ===========================================================
// export function MatrixRenderer({
//   matrixId,
//   symbol = 'a',
...
// // ===========================================================
// // SceneCanvas — adds 'group-bracket' overlay support
// // ===========================================================
// export function SceneCanvas({
//   scene,
//   highlightStyles = DEFAULT_HIGHLIGHTS,
...
//     scene.overlays.forEach((ov) => {
//       // -----------------------------------------------------
//       // cell-arrow / cell-arrow-curve (unchanged)
//       // -----------------------------------------------------
//       if (ov.type === 'cell-arrow' || ov.type === 'cell-arrow-curve') {
//         const fromCell = containerRef.current.querySelector(
//           `[data-matrix-id="${ov.from.matrix}"] [data-row="${ov.from.row}"][data-col="${ov.from.col}"]`
...
//       // group-bracket (NEW)
//       // -----------------------------------------------------
//       // Enclose a set of matrices in a labeled rectangle. Padding
//       // is added around the union of their bounding boxes, with
//       // extra top padding to make room for the label pill.
//       // -----------------------------------------------------
...
//   // Hex with alpha for the bracket fill (very faint tint).
//   const tintColor = (hex) => `${hex}1A`; // 1A = ~10% alpha
...
//         {/* HTML overlay layer — group brackets sit ABOVE matrices
//             (so the user can see the dashed border around the group)
//             but BELOW the SVG (so arrows still draw on top). */}

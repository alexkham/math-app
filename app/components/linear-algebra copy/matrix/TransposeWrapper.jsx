...
//
// Control panel uses tabs: Size | Method
// ===========================================================
  ...
  const summary = (
    <div style={{
      ...
      <span style={mathInlineStyle}>
        A<span style={{ fontSize: '9px', verticalAlign: 'super', fontStyle: 'normal' }}>T</span>
      </span>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '18px' }}>
          ...
          {activeTab === 'method' && (
            <div>
              <FieldLabel>
                How A → A<span style={{ fontSize: '9px', verticalAlign: 'super' }}>T</span> is built — same result, different mental model
              </FieldLabel>
              <div style={{
                display: 'grid',
      ...
      <div style={{ marginTop: '18px' }}>
        <ScenePlayer
          ...
          sceneCanvasProps={{ highlightStyles: TRANSPOSE_HIGHLIGHTS , showCaption: false }}
        />
      </div>
    </div>
  );

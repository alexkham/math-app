...
// // // // // // // small primitives they share (Tooltip, FactorSpan, ValueChip, Segmented,
// // // // // // // ParamControl). Everything consumes a single `iq` prop returned by
// // // // // // // useInequality + a hover state lifted by the root.
...
// // // // // //   const onSlide = (v) => dispatch({ type: 'SET_PARAM', key: pr.key, value: v });
// // // // // //   const onInput = (v) => {
// // // // // //     if (v === '' || v === '-') return;
// // // // // //     dispatch({ type: 'SET_PARAM', key: pr.key, value: v });
// // // // // //   };
...
// // // // // //             <input type="number" min={pr.min} max={pr.max} step={pr.step} value={value}
// // // // // //                    onChange={e => onInput(e.target.value)} />
// // // // // //             <span className="range-hint">[{pr.min}, {pr.max}]</span>
// // // // // //           </div>
// // // // // //         )
// // // // // //         : <SliderBlock pr={pr} value={value} onChange={onSlide} />
// // // // // //       }
// // // // // //     </div>
// // // // // //   );
// // // // // // }

// // // // // // function SliderBlock({ pr, value, onChange }) {
...
// // // // // //       <input type="range" min={pr.min} max={pr.max} step={pr.step} value={value}
...
// // // // // // // ============================================================
// // // // // // // HERO  (inequality + number line + probe + readout)
// // // // // // // ============================================================
...
// // // // // //   ));
// // // // // //   // composeIneq returns either a joined string or an array; we render array of spans interleaved
// // // // // //   // with the type's separator (rational uses ' / '). We let the type tell us via composeIneq
// // // // // //   // on the *spans* themselves — but JSX needs nodes, so handle rational specially.
// // // // // //   let ineqBody;
...
// // // // // // // ----- Probe readout text under the SVG -----
...
// // // // // // // ----- Result pills (interval notation + set-builder) -----
...
// // // // // //         <div className="pill"><div className="k">Interval notation</div><div className="v">{intervalNotation}</div></div>
// // // // // //       </Tooltip>
...
// // // // // //         <div className="pill"><div className="k">Set-builder</div><div className="v">{setBuilder}</div></div>
// // // // // //       </Tooltip>
// // // // // //     </div>
// // // // // //   );
// // // // // // }
...
// // // // // //   // marble drag + endpoint drag — global mouse/touch handlers
...
// // // // // //   // trail (color decided by holds at midpoint)
...
// // // // // // // ============================================================
// // // // // // // CONTROLS (templates, generic form, parameters, toggles)
// // // // // // // ============================================================
...
// // // // // //       const cx = crit[i - 1];
// // // // // //       headerCells.push(
// // // // // //         <Tooltip key={`bh-${i}`} content={`Critical point. Click to jump the marble to x = ${cx}.`}>
// // // // // //           <th className="critc" onClick={() => jumpMarble(cx)}>{fmt(cx)}</th>
// // // // // //         </Tooltip>
// // // // // //       );
// // // // // //     }
// // // // // //     headerCells.push(
// // // // // //       <Tooltip key={`ih-${i}`} content={`Interval: ${label}. Click to jump to a test point inside.`}>
// // // // // //         <th data-col={i} className={'interval-cell' + (colFocus(i) ? ' col-focus' : '')}
// // // // // //             onClick={() => jumpMarble(sampleAt(i))}>{label}</th>
// // // // // //       </Tooltip>
// // // // // //     );
// // // // // //   });
...
// // // //         {mode === 'input'
// // // //           ? <input className="ctrl-num" type="number" min={pr.min} max={pr.max} step={pr.step}
...
// // // //       {mode === 'input' && <span className="ctrl-hint">[{pr.min}, {pr.max}]</span>}
// // // //     </div>
// // // //   );
// // // // }
...
// // }
// // function ParamControl({ pr, value, mode, dispatch }) {
// //   // Local draft so the user can type/clear/backspace freely without
// //   // every keystroke being clamped or coerced by the reducer.
// //   const [draft, setDraft] = useState(String(value));
// //   const focusedRef = useRef(false);

// //   // Sync draft when external value changes (slider, template switch),
// //   // but never overwrite while the user is actively editing.
// //   useEffect(() => {
...
// //     const clamped = Math.max(pr.min, Math.min(pr.max, n));
// //     dispatch({ type: 'SET_PARAM', key: pr.key, value: clamped, min: pr.min, max: pr.max });
// //     setDraft(String(clamped));
// //   };

// //   const onSlide = (v) =>
// //     dispatch({ type: 'SET_PARAM', key: pr.key, value: v, min: pr.min, max: pr.max });

// //   const onInputChange = (e) => setDraft(e.target.value);
// //   const onInputBlur = (e) => { focusedRef.current = false; commit(e.target.value); };
...
// //       <div className="ctrl-mid">
// //         {mode === 'input'
// //           ? <input className="ctrl-num" type="text" inputMode="numeric"
// //                    value={draft}

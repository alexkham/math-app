...
// //     const removeProgress = inS2 ? 1 : (inS1 ? subT : 0); // fades out top-right borders + erases b² fill area
...
// //     return (
// //       <g>
// //         {/* Blue fill of full a² (no stroke — borders drawn separately so we can fade segments) */}
// //         <rect x={sqX} y={sqY} width={aPx} height={aPx} fill={A_FILL} stroke="none"/>

// //         {/* Erase the b² area as it gets removed */}
// //         {removeProgress > 0 && (
// //           <rect x={b2X} y={b2Y} width={bPx} height={bPx}
// //             fill={BG} stroke="none" opacity={removeProgress}/>
// //         )}

// //         {/* a² borders drawn as 6 segments. Top-right segments fade with removeProgress. */}
// //         {/* Left edge */}
// //         <line x1={sqX} y1={sqY} x2={sqX} y2={sqY+aPx} stroke={A_STROKE} strokeWidth={2.5}/>
// //         {/* Bottom edge */}
// //         <line x1={sqX} y1={sqY+aPx} x2={sqX+aPx} y2={sqY+aPx} stroke={A_STROKE} strokeWidth={2.5}/>
// //         {/* Top edge — left part (over top strip) — always */}
// //         <line x1={sqX} y1={sqY} x2={b2X} y2={sqY} stroke={A_STROKE} strokeWidth={2.5}/>
// //         {/* Right edge — lower part (over bottom rect) — always */}
// //         <line x1={sqX+aPx} y1={b2Y+bPx} x2={sqX+aPx} y2={sqY+aPx} stroke={A_STROKE} strokeWidth={2.5}/>
// //         {/* Top edge — right part (over b² area) — fades as removed */}
// //         <line x1={b2X} y1={sqY} x2={sqX+aPx} y2={sqY} stroke={A_STROKE} strokeWidth={2.5} opacity={1 - removeProgress}/>
// //         {/* Right edge — upper part (over b² area) — fades as removed */}
// //         <line x1={sqX+aPx} y1={sqY} x2={sqX+aPx} y2={b2Y+bPx} stroke={A_STROKE} strokeWidth={2.5} opacity={1 - removeProgress}/>

// //         {/* Inner edges of the L-shape that are exposed when b² is removed */}
// //         {/* These are the right edge of top strip and the bottom edge of b² area, drawn fading IN as b² is removed */}
...
// //         {/* Internal divider between top strip and bottom rect (dashed) — visible in stage 2, fades in during 1→2 */}
// //         {(inS1 || inS2) && (
// //           <line x1={tx} y1={ty+th} x2={tx+tw} y2={ty+th}
// //             stroke={A_STROKE} strokeWidth={1} strokeDasharray="4 4" opacity={(inS2 ? 1 : subT) * 0.5}/>
// //         )}

// //         {/* b² solid (when present) */}
// //         {b2Opacity > 0.01 && (
// //           <rect x={b2X} y={b2Y} width={bPx} height={bPx}
...
// //         {/* b² label (visible while b² is solid) */}
// //         {b2Opacity > 0.01 && (
...
// //         {/* Faded b²/(removed) label in the empty corner — fades in during 1→2, full in stage 2 */}
// //         {(inS1 || inS2) && (
...
// //         {/* Dimensions */}
// //         <Dim x1={sqX} y1={sqY} x2={sqX} y2={sqY+aPx} label="a" offset={32} side={-1}/>

// //         {inS0 && b2Opacity < 0.5 && (
// //           <Dim x1={sqX} y1={sqY} x2={sqX+aPx} y2={sqY} label="a" offset={32} side={-1} opacity={1 - b2Opacity}/>
// //         )}
// //         {(b2Opacity > 0.3 || inS2) && (
// //           <>
...
// //   const titles = {
// //     1: <>A square with side <i>a</i>. Its area is <i>a</i>².</>,
// //     2: <>Mark a smaller square with side <i>b</i> inside it. Its area is <i>b</i>².</>,
// //     3: <>Throw away <i>b</i>². The L-shape that remains has area <i>a</i>² − <i>b</i>², split into two rectangles.</>,
// //     4: <>Lift the top strip, rotate it 90°, and slide it next to the bottom rectangle.</>,
// //   };

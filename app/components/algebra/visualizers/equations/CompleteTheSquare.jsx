...
// // // // // //    - Right: steps that appear one at a time as the animation advances.
// // // // // //             Already-revealed steps stay visible (pile up). Current step
// // // // // //             is highlighted. Clicking a previous step jumps the diagram
// // // // // //             back to that stage.
...
// // // // // //    - The "5 fills part of corner" stage uses sub-rectangle sizes
// // // // // //      proportional to c/a vs (b/(2a))² so the 5 piece and the missing
// // // // // //      piece have correct relative areas.
// // // // // //    ===================================================== */
...
// // // // // // /* =====================================================
// // // // // //    Build the algebra steps + per-stage caption / diagram pointer.

// // // // // //    Each entry:
// // // // // //      stageId   — index into the diagram stage list
// // // // // //      title     — short label
// // // // // //      explain   — prose explanation
// // // // // //      math      — LaTeX-ish line with the current expression
// // // // // //    ===================================================== */
// // // // // // function buildSteps(a, b, c) {
// // // // // //   const bm = b / a;         // monic b
// // // // // //   const cm = c / a;         // monic c
// // // // // //   const half = bm / 2;      // b/(2a)
// // // // // //   const halfSq = half * half;
// // // // // //   const gap = halfSq - cm;  // what's missing inside the corner; cm + gap = halfSq
// // // // // //                             // so the vertex form is a((x+half)² − gap) = a(x+half)² − a·gap
...
// // // // // //   // Vertex form
// // // // // //   const vertexH = -b / (2 * a);     // x-coordinate of vertex
...
// // // // // // /* =====================================================
// // // // // //    DIAGRAM — measured pixel layout

// // // // // //    x is rendered as X_PX pixels.
// // // // // //    half (= b/(2a)) is rendered proportional to |half| · UNIT_PX,
// // // // // //    so the 3x strips are exactly half the width of a stage-0 6x rectangle,
// // // // // //    and the c-piece inside the corner is sized so its area equals
// // // // // //    (cm / halfSq) of the corner — only when cm and halfSq have the
// // // // // //    same sign, which is the standard case in school problems.
// // // // // //    ===================================================== */
// // // // // // const X_PX = 180;        // fixed pixel side for "x"
// // // // // // const UNIT_PX = 28;      // 1 algebra unit = UNIT_PX pixels when scaling "half"
// // // // // // const ORIGIN_X = 90;     // top-left of the x² square
// // // // // // const ORIGIN_Y = 70;

// // // // // // function Diagram({ stageId, a, b, c, derived }) {
// // // // // //   const { half, halfSq, gap, bm, cm } = derived;

// // // // // //   // Visual size for the "half" side. Cap so the diagram fits.
// // // // // //   const halfPx = Math.max(20, Math.min(120, Math.abs(half) * UNIT_PX));
// // // // // //   const fullStripPx = 2 * halfPx;          // visual size of the original (bm)x rectangle = 2·half
...
// // // // // //   // The c-piece inside the corner: split the corner horizontally.
// // // // // //   // Its height is the fraction (cm / halfSq) of halfPx, IF cm and halfSq are both positive.
// // // // // //   // Otherwise we render it as a labeled box without claiming area correctness.
...
// // // // // //   // Stage 0: three pieces with x² already in its final position; the bm·x
// // // // // //   // rectangle and the cm piece sit to the right, vertically arranged.
// // // // // //   // The bm·x rectangle is (2·halfPx) wide × X_PX tall, so when it splits
// // // // // //   // in stage 3 we get two strips of (X_PX × halfPx) each — exactly the
// // // // // //   // strips that wrap around the x² square.
// // // // // //   if (stageId === 0) {
// // // // // //     const fullRectW = 2 * halfPx;
// // // // // //     const stage0xpos = sqX;
// // // // // //     const stage0ypos = sqY;

// // // // // //     // c-piece visual size: area proportional to its real value, capped to halfPx.
// // // // // //     let cSidePx;
// // // // // //     if (cm > 0 && halfSq > 0) {
...
// // // // // //     // Right-side stacked pieces position
// // // // // //     const sideX = stage0xpos + X_PX + 50;
// // // // // //     const bxY = stage0ypos;
// // // // // //     const cY = stage0ypos + X_PX + 24;

// // // // // //     return (
// // // // // //       <svg viewBox={`0 0 ${svgW + 80} ${svgH}`} xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', maxWidth: 560, display: 'block', margin: '0 auto' }}>
// // // // // //         {/* x² square — final position */}
...
// // // // // //         {/* bm·x rectangle, off to the right, 2·halfPx × X_PX */}
// // // // // //         <rect x={sideX} y={bxY} width={fullRectW} height={X_PX} fill="#fde68a" stroke="#d97706" strokeWidth={2.5} />
// // // // // //         <text x={sideX + fullRectW / 2} y={bxY + X_PX / 2 + 8} textAnchor="middle" fontSize="20" fontStyle="italic" fill="#1e3a5f" fontWeight="700">{fmt(bm)}x</text>

// // // // // //         {/* cm piece, below, area proportional to value */}
// // // // // //         <rect x={sideX} y={cY} width={cSidePx} height={cSidePx} fill={cm >= 0 ? "#d1fae5" : "#fee2e2"} stroke={cm >= 0 ? "#059669" : "#dc2626"} strokeWidth={2.5} />
// // // // // //         <text x={sideX + cSidePx / 2} y={cY + cSidePx / 2 + 6} textAnchor="middle" fontSize="16" fill={cm >= 0 ? "#065f46" : "#991b1b"} fontWeight="700">{fmt(cm)}</text>
// // // // // //       </svg>
// // // // // //     );
// // // // // //   }

// // // // // //   // Stage 1 (factor out a, monic message)
// // // // // //   if (stageId === 1) {
// // // // // //     return (
// // // // // //       <svg viewBox={`0 0 ${svgW} ${svgH}`} xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', maxWidth: 520, display: 'block', margin: '0 auto' }}>
...
// // // // // //   // Stage 4: x² + two strips + c-piece inside the corner (no gap revealed yet)
// // // // // //   if (stageId === 4) {
// // // // // //     return (
// // // // // //       <svg viewBox={`0 0 ${svgW} ${svgH}`} xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', maxWidth: 520, display: 'block', margin: '0 auto' }}>
// // // // // //         <rect x={sqX} y={sqY} width={X_PX} height={X_PX} fill="#dbeafe" stroke="#3b82f6" strokeWidth={2.5} />
...
// // // // // //         <text x={sqX + X_PX + halfPx / 2} y={sqY + X_PX + 16} textAnchor="middle" fontSize="11" fill="#64748b">corner needs</text>
// // // // // //         <text x={sqX + X_PX + halfPx / 2} y={sqY + X_PX + 32} textAnchor="middle" fontSize="13" fill="#64748b" fontWeight="700">{fmt(half)} × {fmt(half)} = {fmt(halfSq)}</text>
...
// // // // // //   // Stage 5: gap revealed (or excess if cm > halfSq, or exact fit if equal)
// // // // // //   if (stageId === 5) {
// // // // // //     return (
// // // // // //       <svg viewBox={`0 0 ${svgW} ${svgH}`} xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', maxWidth: 520, display: 'block', margin: '0 auto' }}>
// // // // // //         <rect x={sqX} y={sqY} width={X_PX} height={X_PX} fill="#dbeafe" stroke="#3b82f6" strokeWidth={2.5} />
...
// // // // // //         {/* Gap pulses on top, c-piece below */}
// // // // // //         {cornerHasFraction && cPiecePx > 0 && (
// // // // // //           <>
// // // // // //             <rect x={sqX + X_PX} y={sqY + X_PX + halfPx - cPiecePx} width={halfPx} height={cPiecePx} fill="#d1fae5" stroke="#059669" strokeWidth={2.5} />
...
// // // // // //   // Stage 6: labeled completed square with vertex form annotation
// // // // // //   if (stageId === 6) {
...
// // // // // //   // Derived steps and constants
// // // // // //   const derived = buildSteps(a, b, c);
// // // // // //   const totalSteps = derived.steps.length;

// // // // // //   // Current step index — 0 means "first step revealed", we always start with 1 step visible.
...
// // // // // //   // Auto-scroll right panel so the currently active step is in view.
// // // // // //   // When new steps are added at the bottom, the panel scrolls down so the
// // // // // //   // user always sees the latest step (and the final result when it appears).
// // // // // //   useEffect(() => {
// // // // // //     if (activeStepRef.current && rightPanelRef.current) {
// // // // // //       activeStepRef.current.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
// // // // // //     }
// // // // // //   }, [currentStep, totalSteps]);

// // // // // //   const currentStepObj = derived.steps[currentStep];
// // // // // //   const visibleSteps = derived.steps.slice(0, currentStep + 1);
...
// // // // // //           animation: cts-fade-in 0.4s ease;
// // // // // //         }
// // // // // //         .cts-step:hover {
// // // // // //           background: #e0e7ff;
...
// // // // // //           {/* RIGHT: steps appear one at a time, accumulating */}
...
// // // // //    same sign, which is the standard case in school problems.
// // // // //    ===================================================== */
// // // // // const X_PX = 140;        // fixed pixel side for "x"
// // // // // const UNIT_PX = 22;      // 1 algebra unit = UNIT_PX pixels when scaling "half"
// // // // // const ORIGIN_X = 60;     // top-left of the x² square (for stages 2-6)
// // // // // const ORIGIN_Y = 30;
...
// // // // //   // Stage 0: three pieces laid out horizontally — x² square on the left,
// // // // //   // bm·x rectangle in the middle, cm piece on the right. The x² square is
// // // // //   // already at its final position (sqX, sqY), so stages 0 and 2+ render
// // // // //   // it at the same coordinates and visual size.
// // // // //   if (stageId === 0) {
// // // // //     const fullRectW = 2 * halfPx;
// // // // //     const stage0xpos = sqX;
// // // // //     const stage0ypos = sqY;
...
// // // // //     return (
// // // // //       <svg viewBox={`0 0 ${svgW} ${svgH}`} xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', maxWidth: 600, display: 'block', margin: '0 auto' }}>
// // // // //         {/* x² square — final position */}
// // // // //         <rect x={stage0xpos} y={stage0ypos} width={X_PX} height={X_PX} fill="#dbeafe" stroke="#3b82f6" strokeWidth={2.5} />
// // // // //         <text x={stage0xpos + X_PX / 2} y={stage0ypos + X_PX / 2 + 8} textAnchor="middle" fontSize="24" fontStyle="italic" fill="#1e3a5f" fontWeight="700">x²</text>

// // // // //         {/* bm·x rectangle, 2·halfPx wide × X_PX tall */}
...
// // // // //         {/* cm piece, area proportional to value */}
...
// // // // //   // Auto-scroll right panel so the user always sees the active content.
// // // // //   // - On the last step: scroll to the very bottom so the blue result card
// // // // //   //   is fully visible (block: 'end' on the result, not the active step).
// // // // //   // - On earlier steps: keep the active step visible with breathing room
// // // // //   //   above and below by aligning to viewport center.
// // // // //   useEffect(() => {
// // // // //     if (!rightPanelRef.current) return;
// // // // //     if (currentStep === totalSteps - 1) {
// // // // //       // Scroll all the way to the bottom — final card included.
...
// //   // Auto-scroll the right panel ONLY — never the document.
// //   // Using scrollIntoView() scrolls every scrollable ancestor (including the
// //   // page itself), which is what caused the whole scene to jump on each step.
// //   // Here we compute the active step's offset relative to its scroll container
// //   // and call container.scrollTo(...) so the page itself is never touched.
// //   useEffect(() => {
// //     const container = rightPanelRef.current;
// //     if (!container) return;

// //     if (currentStep === totalSteps - 1) {
// //       // Last step: scroll the container all the way down so the blue final card
// //       // is fully visible.
// //       container.scrollTo({
...
// //     // Offset of the active step's top edge relative to the container's content top.
// //     const stepOffsetInContainer =
// //       stepEl.getBoundingClientRect().top
// //       - container.getBoundingClientRect().top
// //       + container.scrollTop;

// //     // Center the step within the container's visible area.
// //     const targetScroll =

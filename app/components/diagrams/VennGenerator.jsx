...
const VennGenerator = () => {
  ...
  //   const setPath = getSetPath(operations.complement.set);
  ...
  //                 A ${circle2.radius} ${circle2.radius} 0 1 0 ${circle2.x - circle2.radius} ${circle2.y}`;
  //       case 'A ∪ B':
  //         // For union complement, we use the union path directly
  //         return unionPath;
  //       case 'A ∩ B':
  //         // For intersection complement, we need to draw both circles
  ...
  //   // Draw the universe and cut out the set path
  //   return `
  //     M 0 0
  //     H ${universe.width}
  //     V ${universe.height}
  ...
  //     ${setPath}
  //   `;
  // }, [circle1, circle2, universe, operations.complement.set, unionPath]);
  ...
  //                 A ${circle2.radius} ${circle2.radius} 0 1 0 ${circle2.x - circle2.radius} ${circle2.y}`;
  //       case 'A ∪ B':
  //         // For union complement, we draw both circles
  //         return `${getSetPath('A')} ${getSetPath('B')}`;
  //       case 'A ∩ B':
  //         // For intersection complement, we need a more complex path
  //         const { x3, y3, x4, y4 } = calculateIntersection;
  //         return `
  //           M ${x3} ${y3}
  //           A ${circle1.radius} ${circle1.radius} 0 0 1 ${x4} ${y4}
  //           A ${circle2.radius} ${circle2.radius} 0 0 1 ${x3} ${y3}
  ...
  //                 A ${circle2.radius} ${circle2.radius} 0 1 0 ${circle2.x - circle2.radius} ${circle2.y}`;
  //       case 'A ∪ B':
  //         // For union complement, we draw both circles to be cut out from the universe
  //         return `${getSetPath('A')} ${getSetPath('B')}`;
  //       case 'A ∩ B':
  //         // Intersection complement logic remains the same
  //         const { x3, y3, x4, y4 } = calculateIntersection;
  //         return `
  //           M ${x3} ${y3}
  //           A ${circle1.radius} ${circle1.radius} 0 0 1 ${x4} ${y4}
  ...
  //                 A ${circle2.radius} ${circle2.radius} 0 0 1 ${x3} ${y3}`;
  //       case 'A ∩ B':
  //         // Intersection complement remains unchanged
  //         return `M ${x3} ${y3}
  //                 A ${circle1.radius} ${circle1.radius} 0 0 1 ${x4} ${y4}
  //                 A ${circle2.radius} ${circle2.radius} 0 0 1 ${x3} ${y3}`;
  //       default:

...
// //   const [circles, setCircles] = useState(scenario.circles);
...
// //     setStage(prev => Math.min(prev + 1, scenario.stages.length - 1));
...
// //                   exit={{ opacity: 0 }}
// //                   transition={{ duration: .5 }}
// //                   fill={item.category === 'set' ? scenario.setLabelColor : scenario.intersectionLabelColor}
// //                 >
// //                   {item.text}
// //                 </motion.text>
// //               );
...
// //     if (distance >= circle1.radius + circle2.radius) {
// //       // Circles don't overlap, return the whole of circle1
// //       return `M ${circle1.cx - circle1.radius} ${circle1.cy} 
// //               A ${circle1.radius} ${circle1.radius} 0 1 1 ${circle1.cx + circle1.radius} ${circle1.cy} 
// //               A ${circle1.radius} ${circle1.radius} 0 1 1 ${circle1.cx - circle1.radius} ${circle1.cy}`;
// //     }

// //     const angle = Math.acos((circle1.radius * circle1.radius + distance * distance - circle2.radius * circle2.radius) / (2 * circle1.radius * distance));
// //     const x1 = circle1.cx + circle1.radius * Math.cos(angle);
// //     const y1 = circle1.cy + circle1.radius * Math.sin(angle);
// //     const x2 = circle1.cx + circle1.radius * Math.cos(-angle);
// //     const y2 = circle1.cy + circle1.radius * Math.sin(-angle);

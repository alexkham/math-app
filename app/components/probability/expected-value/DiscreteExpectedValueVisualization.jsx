  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
        ...
        {/* Right side panel with controls and information */}
        <div style={{ flex: 1, minWidth: '400px' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <h3 style={{ color: '#333', marginBottom: '15px', marginTop: 0 }}>Adjust Probabilities:</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
              {values.map((val, idx) => (
                <div key={idx} style={{ 
                  ...
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: '#495057', fontSize: '13px' }}>
                    P(X = {val.x})
                  </label>
                  <input
                    type="range"
                  ...
                  <div style={{ textAlign: 'center', color: '#4A90E2', fontSize: '11px', marginTop: '5px' }}>
                    Contribution: {(val.x * val.p).toFixed(3)}
                  </div>
                </div>
              ))}
          ...
          <div style={{ 
            ...
            <h4 style={{ marginTop: 0, color: '#0066cc', fontSize: '16px' }}>Understanding Expected Value:</h4>

      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '30px' }}>
        ...
        <div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  <th style={getHeaderStyle(false)}>B<sup>c</sup></th>
              ...
              <tbody>
                ...
                <tr>
                  <td style={getHeaderStyle(false)}>A<sup>c</sup></td>
                  <td 
          ...
          <div style={{ background: '#f8fafc', padding: '20px', borderRadius: '8px' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600' }}>
                P(B|A<sup>c</sup>) = {pBGivenNotA.toFixed(3)}
              </label>
              <input
                type="range"
                min="0.01"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
              ...
              <tbody>
                ...
                <tr className="clickable-row"
                  onClick={() => handleConditionalClick('AnotB', 'A', {
                    formula: "P(B^c|A) = P(A ∩ B^c) / P(A)",
                    substitution: `P(B^c|A) = ${pAAndNotB.toFixed(4)} / ${pA.toFixed(4)}`,
                    result: `P(B^c|A) = ${(1 - pBGivenA).toFixed(4)}`
                  })}
                  style={{ 
                    cursor: 'pointer', 
                    transition: 'all 0.2s',
                ...
                >
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', fontWeight: 'bold', fontSize: '13px' }}>P(B<sup>c</sup>|A) = P(A∩B<sup>c</sup>) / P(A) = {pAAndNotB.toFixed(2)} / {pA.toFixed(2)}</td>
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', textAlign: 'center', fontSize: '13px' }}>
          ...
          {/* Given A^c */}
          <div style={{ background: 'white', border: '2px solid #e2e8f0', borderRadius: '8px', padding: '15px', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center' }}>Conditional on A<sup>c</sup></h3>
            <div style={{ background: '#dbeafe', padding: '6px 12px', borderRadius: '4px', marginBottom: '12px', textAlign: 'center' }}>
              <span style={{ fontSize: '13px', color: '#1e40af', fontWeight: '600' }}>Click rows to highlight paths</span>
            </div>
            <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0 8px", flexGrow: 1 }} className="conditional-table">
              <tbody>
                <tr className="clickable-row"
                  onClick={() => handleConditionalClick('notAB', 'notA', {
                    formula: "P(B|A^c) = P(A^c ∩ B) / P(A^c)",
                    substitution: `P(B|A^c) = ${pNotAAndB.toFixed(4)} / ${pNotA.toFixed(4)}`,
                    result: `P(B|A^c) = ${pBGivenNotA.toFixed(4)}`
                  })}
                  style={{ 
                    cursor: 'pointer', 
                    transition: 'all 0.2s',
                ...
                >
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', fontWeight: 'bold', fontSize: '13px' }}>P(B|A<sup>c</sup>) = P(A<sup>c</sup>∩B) / P(A<sup>c</sup>) = {pNotAAndB.toFixed(2)} / {pNotA.toFixed(2)}</td>
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', textAlign: 'center', fontSize: '13px' }}>
                ...
                <tr className="clickable-row"
                  onClick={() => handleConditionalClick('notAnotB', 'notA', {
                    formula: "P(B^c|A^c) = P(A^c ∩ B^c) / P(A^c)",
                    substitution: `P(B^c|A^c) = ${pNotAAndNotB.toFixed(4)} / ${pNotA.toFixed(4)}`,
                    result: `P(B^c|A^c) = ${(1 - pBGivenNotA).toFixed(4)}`
                  })}
                  style={{ 
                    cursor: 'pointer', 
                    transition: 'all 0.2s',
                ...
                >
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', fontWeight: 'bold', fontSize: '13px' }}>P(B<sup>c</sup>|A<sup>c</sup>) = P(A<sup>c</sup>∩B<sup>c</sup>) / P(A<sup>c</sup>) = {pNotAAndNotB.toFixed(2)} / {pNotA.toFixed(2)}</td>
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', textAlign: 'center', fontSize: '13px' }}>
              ...
              <tbody>
                ...
                <tr className="clickable-row"
                  onClick={() => handleConditionalClick('notAB', 'B', {
                    formula: "P(A^c|B) = P(A^c ∩ B) / P(B)",
                    substitution: `P(A^c|B) = ${pNotAAndB.toFixed(4)} / ${pB.toFixed(4)}`,
                    result: `P(A^c|B) = ${pB > 0 ? (pNotAAndB / pB).toFixed(4) : 'undefined'}`
                  })}
                  style={{ 
                    cursor: 'pointer', 
                    transition: 'all 0.2s',
                ...
                >
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', fontWeight: 'bold', fontSize: '13px' }}>P(A<sup>c</sup>|B) = P(A<sup>c</sup>∩B) / P(B) = {pNotAAndB.toFixed(2)} / {pB.toFixed(2)}</td>
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', textAlign: 'center', fontSize: '13px' }}>
          ...
          {/* Given B^c */}
          <div style={{ background: 'white', border: '2px solid #e2e8f0', borderRadius: '8px', padding: '15px', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center' }}>Conditional on B<sup>c</sup></h3>
            <div style={{ background: '#dbeafe', padding: '6px 12px', borderRadius: '4px', marginBottom: '12px', textAlign: 'center' }}>
              <span style={{ fontSize: '13px', color: '#1e40af', fontWeight: '600' }}>Click rows to highlight paths</span>
            </div>
            <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0 8px", flexGrow: 1 }} className="conditional-table">
              <tbody>
                <tr className="clickable-row"
                  onClick={() => handleConditionalClick('AnotB', 'notB', {
                    ...
                    substitution: `P(A|B^c) = ${pAAndNotB.toFixed(4)} / ${pNotB.toFixed(4)}`,
                    result: `P(A|B^c) = ${pNotB > 0 ? (pAAndNotB / pNotB).toFixed(4) : 'undefined'}`
                  })}
                  style={{ 
                    cursor: 'pointer', 
                    transition: 'all 0.2s',
                ...
                >
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', fontWeight: 'bold', fontSize: '13px' }}>P(A|B<sup>c</sup>) = P(A∩B<sup>c</sup>) / P(B<sup>c</sup>) = {pAAndNotB.toFixed(2)} / {pNotB.toFixed(2)}</td>
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', textAlign: 'center', fontSize: '13px' }}>
                ...
                <tr className="clickable-row"
                  onClick={() => handleConditionalClick('notAnotB', 'notB', {
                    formula: "P(A^c|B^c) = P(A^c ∩ B^c) / P(B^c)",
                    substitution: `P(A^c|B^c) = ${pNotAAndNotB.toFixed(4)} / ${pNotB.toFixed(4)}`,
                    result: `P(A^c|B^c) = ${pNotB > 0 ? (pNotAAndNotB / pNotB).toFixed(4) : 'undefined'}`
                  })}
                  style={{ 
                    cursor: 'pointer', 
                    transition: 'all 0.2s',
                ...
                >
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', fontWeight: 'bold', fontSize: '13px' }}>P(A<sup>c</sup>|B<sup>c</sup>) = P(A<sup>c</sup>∩B<sup>c</sup>) / P(B<sup>c</sup>) = {pNotAAndNotB.toFixed(2)} / {pNotB.toFixed(2)}</td>
                  <td style={{ padding: '10px', border: '1px solid #e2e8f0', textAlign: 'center', fontSize: '13px' }}>

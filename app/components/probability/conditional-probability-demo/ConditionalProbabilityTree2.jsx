...
//     notA: { x: level1X, y: startY + verticalSpacing, label: "A'", prob: pNotA },
//     AB: { x: level2X, y: startY - verticalSpacing - 64, label: 'A ∩ B', prob: pAAndB },
//     AnotB: { x: level2X, y: startY - verticalSpacing + 64, label: "A ∩ B'", prob: pAAndNotB },
//     notAB: { x: level2X, y: startY + verticalSpacing - 64, label: "A' ∩ B", prob: pNotAAndB },
//     notAnotB: { x: level2X, y: startY + verticalSpacing + 64, label: "A' ∩ B'", prob: pNotAAndNotB }
//   };
...
//     { from: 'start', to: 'notA', prob: pNotA, label: `P(A') = ${pNotA.toFixed(3)}`, path: 'notA', belongsTo: ['notAB', 'notAnotB', 'notA', 'B', 'notB', 'givenNotA', 'BgivenNotA', 'BnotgivenNotA'] },
//     { from: 'A', to: 'AB', prob: pBGivenA, label: `P(B|A) = ${pBGivenA.toFixed(3)}`, path: 'AB', belongsTo: ['AB', 'B', 'givenA', 'BgivenA'] },
//     { from: 'A', to: 'AnotB', prob: 1 - pBGivenA, label: `P(B'|A) = ${(1 - pBGivenA).toFixed(3)}`, path: 'AnotB', belongsTo: ['AnotB', 'notB', 'givenA', 'BnotgivenA'] },
//     { from: 'notA', to: 'notAB', prob: pBGivenNotA, label: `P(B|A') = ${pBGivenNotA.toFixed(3)}`, path: 'notAB', belongsTo: ['notAB', 'B', 'givenNotA', 'BgivenNotA'] },
//     { from: 'notA', to: 'notAnotB', prob: 1 - pBGivenNotA, label: `P(B'|A') = ${(1 - pBGivenNotA).toFixed(3)}`, path: 'notAnotB', belongsTo: ['notAnotB', 'notB', 'givenNotA', 'BnotgivenNotA'] }
//   ];
...
//     { key: 'AnotB', label: "A ∩ B'", prob: pAAndNotB, color: pathColors.AnotB, formula: "P(A) × P(B'|A)" },
//     { key: 'notAB', label: "A' ∩ B", prob: pNotAAndB, color: pathColors.notAB, formula: "P(A') × P(B|A')" },
//     { key: 'notAnotB', label: "A' ∩ B'", prob: pNotAAndNotB, color: pathColors.notAnotB, formula: "P(A') × P(B'|A')" }
//   ];
...
//                 <div>P(A'|B) = P(B|A') × P(A') / P(B) = {pB > 0 ? (pNotAAndB / pB).toFixed(4) : 'undefined'}</div>
//               </div>
//             </div>
//           </div>
//         </div>

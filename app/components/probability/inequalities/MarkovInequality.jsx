      ...
      <div style={{ display: 'flex', gap: '30px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ padding: '15px', background: '#f3f4f6', borderRadius: '8px', fontSize: '14px' }}>
            <p style={{ margin: '0 0 10px 0' }}><strong>Markov Inequality:</strong> For non-negative X and a &gt; 0: P(X ≥ a) ≤ E[X] / a</p>
            <p style={{ margin: '0' }}>{isDiscrete ? 'Red bars' : 'Red area'} show{isDiscrete ? '' : 's'} P(X ≥ a). Bound: {markovBoundPercent}%, Actual: {actualProbPercent}%</p>
          </div>
        </div>
      </div>
    </div>

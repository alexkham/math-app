      ...
      trEven: {
        ...
        royalBlueCards: {
          ...
          th: {
            ...
            fontSize: '12px',
            borderRadius: '8px',
            boxShadow: '0 2px 4px rgba(65, 105, 225, 0.3)'
          },
          td: {
            padding: '16px',
            backgroundColor: 'white',
          ...
          trEven: {
            ...
            azureCards: {
              ...
              th: {
                ...
                fontSize: '12px',
                borderRadius: '8px',
                boxShadow: '0 3px 5px rgba(79, 70, 229, 0.25)'
              },
              td: {
                padding: '16px',
                backgroundColor: '#f8fafc',
            ...
            darkBlueCardsFix: {
               ...
               vibrantBlueCards: {
                ...
                th: {
                  ...
                  fontSize: '12px',
                  borderRadius: '8px',
                  boxShadow: '0 3px 5px rgba(29, 78, 216, 0.3)'
                },
                td: {
                  padding: '16px',
                  backgroundColor: 'white',
               ...
               electricBlueCards: {
                ...
                th: {
                  ...
                  fontSize: '12px',
                  borderRadius: '8px',
                  boxShadow: '0 2px 4px rgba(55, 48, 163, 0.3)'
                },
                td: {
                  padding: '16px',
                  backgroundColor: 'white',
               ...
               lightBgBlueCards: {
                ...
                th: {
                  ...
                  fontSize: '12px',
                  borderRadius: '8px',
                  boxShadow: '0 3px 5px rgba(30, 64, 175, 0.3)'
                },
                td: {
                  padding: '16px',
                  backgroundColor: '#2563eb',
               ...
               creamBgDustyBlue: {
                ...
                th: {
                  ...
                  fontSize: '12px',
                  borderRadius: '8px',
                  boxShadow: '0 2px 4px rgba(87, 83, 78, 0.2)'
                },
                td: {
                  padding: '16px',

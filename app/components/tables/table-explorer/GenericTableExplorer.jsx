...
// // // // // }
// // // // // .ge-input-btn:hover { background: ${C.primaryDark} !important; }
...
// // // // //   .ge-input-block { flex-direction: column !important; align-items: stretch !important; }
// // // // //   .ge-input-block input, .ge-input-block button { width: 100% !important; }
// // // // //   .ge-mode-tab { padding: 9px 14px !important; font-size: 13px !important; }
// // // // // }
// // // // // `;

// // // // // const GenericTableExplorer = ({
...
// // // // //   const handleSearchModeChange = (next) => { setSearchMode(next); hideStatus(); };
...
// // // // //       const d = matches[0];
// // // // //       setStatus('success', '\u2713', processContent(`Found: **${templates.full(d)}**. Card highlighted below.`));
...
// // // // //   const currentSearchMode = searchModes.find((m) => m.id === searchMode);
...
// // // // //                     <input
// // // // //                       type="text" className="ge-input-field" style={S.inputField}
// // // // //                       placeholder={currentSearchMode.placeholder || ''}
// // // // //                       value={inputs[currentSearchMode.id] || ''}
// // // // //                       onChange={(e) => setInputs({ ...inputs, [currentSearchMode.id]: e.target.value })}
// // // // //                       onKeyDown={(e) => { if (e.key === 'Enter') runFind(currentSearchMode.id); }}
// // // // //                     />
// // // // //                     <button type="button" className="ge-input-btn" style={S.inputBtn}
// // // // //                       onClick={() => runFind(currentSearchMode.id)}>Find</button>
// // // // //                   </div>
// // // // //                 )}
// // // // //                 {statusKind && (
...
// // // // // export default GenericTableExplorer;
...
// // //     transition: 'border-color 0.15s, box-shadow 0.15s',
// // //   },
// // //   inputFieldWithReset: { paddingRight: '44px' },
// // //   inputReset: {
...
// // // }
// // // .ge-input-btn:hover { background: ${C.primaryDark} !important; }
// // // .ge-input-reset:hover { background: ${C.error} !important; color: white !important; }
// // // .ge-mode-tab:not(.active):hover { color: ${C.primary} !important; }
// // // .ge-view-btn:not(.active):hover { color: ${C.primary}; }
...
// // //       const catId = inputs[modeId] || '';
// // //       if (!catId) { setStatus('error', '!', 'Please choose a category.'); return; }
// // //       if (viewMode === 'puzzle') setViewMode('reference');
// // //       setActiveFilter(null);
// // //       setDetailsId(null);
// // //       const matches = items.filter((d) => d.cat === catId);
// // //       setHighlightedIds(new Set(matches.map((d) => d.id)));
// // //       const catLabel = (categories[catId] && categories[catId].label) || catId;
// // //       if (matches.length === 0) {
// // //         setStatus('info', '\u2211', `No entries in ${catLabel}.`);
// // //       } else {
// // //         setStatus('success', '\u2211', `${matches.length} ${catLabel} entr${matches.length === 1 ? 'y' : 'ies'} highlighted below.`);
// // //         setPendingScroll({ type: 'section', id: 'sec-table' });
// // //       }
// // //       return;
// // //     }
...
// // //     setHighlightedIds(new Set(matches.map((d) => d.id)));
// // //     if (matches.length === 0) {
// // //       setStatus('info', '\u2211', `No entries match "${query}". Try another expression.`);
// // //     } else if (matches.length === 1) {
// // //       const d = matches[0];
// // //       const label = d.title || `entry #${d.id}`;
// // //       setStatus('success', '\u2713', `Found: ${label}. Card highlighted below.`);
// // //       setPendingScroll({ type: 'card', id: d.id });
// // //     } else {
...
// //     background: 'linear-gradient(135deg, #eef2ff 0%, #f0f9ff 100%)',
// //     border: `1px solid ${C.border}`, borderRadius: '20px',
// //     padding: '28px 32px 44px', marginBottom: '36px',
// //   },
// //   toolH2: {
// //     fontFamily: "'Crimson Pro', serif", fontSize: '26px',
// //     color: C.primaryDark, margin: '0 0 4px', fontWeight: 700,
...
// //     border: '2px solid transparent', borderRadius: '11px',
// //     fontWeight: 600, fontSize: '15px', cursor: 'pointer',
// //     fontFamily: 'inherit', whiteSpace: 'nowrap',
// //     transition: 'background 0.15s',
// //   },

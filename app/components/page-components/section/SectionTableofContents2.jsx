...
// // //                           aria-label={`Expand ${link} submenu`}
// // //                         >
// // //                           <ChevronDown 
...
// // //     // For non-sticky mode - SEO friendly navigation with proper heading structure
// // //     return (
// // //       <div className="secondary-nav">
// // //         <div className="secondary-nav-header">
// // //           <h3 className="secondary-nav-title-main">{secondaryNavTitle}</h3>
// // //           <button 
...
// // //         <div className={`secondary-nav-content ${secondaryNavOpen ? 'open' : ''}`}>
// // //           <ul className="secondary-nav-list">
// // //             {secondaryNavLinks.map((link) => {
// // //               const linkPath = `${currentPath}${currentPath === '/' ? '' : '/'}${link}`;
// // //               return (
// // //                 <li key={link} className="secondary-nav-item">
// // //                   <Link 
// // //                     href={linkPath}
...
// // // export default SectionTableOfContents2;
...
// //         >
// //           <h3 className="secondary-nav-title-main">{secondaryNavTitle}</h3>
// //           <span className="secondary-nav-toggle">
// //             <ChevronDown 
// //               className={`accordion-arrow ${secondaryNavOpen ? 'expanded' : ''}`}
// //               size={28}
// //               strokeWidth={3}
...
//           <h3 className="secondary-nav-title-sticky">
//             {secondaryNavTitle}
//           </h3>
//           <div className="secondary-nav-sticky-content">
//             <ul className="secondary-nav-list">
//               {secondaryNavLinks.map((link) => {
//                 const hasChildren = !useProvidedLinks && urlStructure[`${currentPath}${currentPath === '/' ? '' : '/'}${link}`] && 
//                                    urlStructure[`${currentPath}${currentPath === '/' ? '' : '/'}${link}`].length > 0;
...
//                           onClick={() => toggleSecondaryItem(itemPath)}
//                           aria-label={`Expand ${link} submenu`}
//                           aria-expanded={expandedSecondaryItems[itemPath]}
//                         >
//                           <ChevronDown 
//                             className={`secondary-arrow ${expandedSecondaryItems[itemPath] ? 'expanded' : ''}`}
//                             size={16}

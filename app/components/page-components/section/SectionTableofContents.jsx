...
// //     const setInitialThreshold = () => {
// //       if (boxRef.current) {
// //         setTocHeight(boxRef.current.offsetHeight);
...
//   maxWidth = null,
//   stickyWidth = null,
//   stickyOffset = 600 // NEW: how much to scroll past TOC before it becomes sticky (default 600px)
// }) => {
//   const [isSticky, setIsSticky] = useState(false);
//   const [expandedSection, setExpandedSection] = useState(null);
//   const [urlStructure, setUrlStructure] = useState({});
...
//       if (boxRef.current) {
//         setTocHeight(boxRef.current.offsetHeight);
//         // UPDATED: Use stickyOffset prop to control when sticky activates
//         // This allows scrolling well past the TOC before it becomes sticky

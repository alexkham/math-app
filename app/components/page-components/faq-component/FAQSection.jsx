...
function FAQItem({ question, answer, sectionId, theme, isLast, defaultOpen }) {
  ...
  return (
    <details
      ...
      onToggle={(e) => setIsOpen(e.target.open)}
    >
      <summary className="faq-summary" style={summaryStyle}>
        <h3 style={questionHeadingStyle}>{processContent(question)}</h3>
        <span style={iconStyle}>{icon}</span>
      </summary>
      <div style={t.answer}>
        {processContent(answer)}

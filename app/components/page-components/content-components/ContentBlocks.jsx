...
// // // // // // // // //   const mainItems = tocItems.filter(item => !item.link); // Only main titles

// // // // // // // // //   return (
// // // // // // // // //     <div className={styles.contentBlocks}>
// // // // // // // // //       {mainItems.map((item, index) => {
// // // // // // // // //         const prevSlug = index > 0 ? createSlug(mainItems[index - 1].title) : null;
// // // // // // // // //         const nextSlug = index < mainItems.length - 1 ? createSlug(mainItems[index + 1].title) : null;
...
// // // // // // // const processContentLinks = (content, subItems) => {
...
// // // // // // //       const subItemWords = subItem.title.split(/\s+/);
// // // // // // //       if (words.slice(i, i + subItemWords.length).join(' ').toLowerCase() === subItem.title.toLowerCase()) {
// // // // // // //         if (subItem.link) {
// // // // // // //           result.push(<a key={i} href={subItem.link} className={styles.inlineLink}>{words.slice(i, i + subItemWords.length).join(' ')}</a>);
// // // // // // //           i += subItemWords.length - 1;
// // // // // // //         } else {
// // // // // // //           result.push(words.slice(i, i + subItemWords.length).join(' '));
// // // // // // //           i += subItemWords.length - 1;
// // // // // // //         }
// // // // // // //         matched = true;
// // // // // // //         break;
...
// // // // // // //         const processedContent = processContentLinks(item.content, item.subItems);

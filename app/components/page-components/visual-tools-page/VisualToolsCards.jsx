// // // // /**
// // // //  * VisualToolsPage v19 — file 1 of 3 (visualToolsCards.jsx)
// // // //  * Constants, inline utilities, hooks, card variants, grid.
// // // //  */
...
// // // /**
// // //  * VisualToolsPage v20 — file 1 of 3 (visualToolsCards.jsx)
// // //  * Constants, inline utilities, hooks, card variants, grid.
// // //  *
// // //  * Change from v19:
// // //  *   - BigB1 title marginBottom: 10 → 30 (more space between title and description).
// // //  */
...
// // //       <Visual item={item} height={visualHeight} mode="banner" />
// // //       <div style={{ padding: '14px 18px 14px', display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
// // //         <h3 style={{ fontSize: '1.05rem', fontWeight: 600, margin: 0, marginBottom: 30, color: theme.cardText, lineHeight: 1.3, flexShrink: 0 }}>{item.title}</h3>
// // //         {item.description && (
// // //           <FadingDescription fontSize="0.85rem" lineHeight={1.5} color={theme.cardText} opacity={0.88}>{item.description}</FadingDescription>
// // //         )}
// // //         <div style={{ marginTop: 10, ...ctaTextStyle(theme) }}>{CTA_OPEN}</div>
...
// // //     </div>
// // //     <div style={{ padding: '22px 26px', display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
// // //       <h3 style={{ fontSize: '1.4rem', fontWeight: 600, margin: 0, marginBottom: 30, color: theme.cardText, lineHeight: 1.3, flexShrink: 0 }}>{item.title}</h3>
// // //       {item.description && (
// // //         <FadingDescription fontSize="0.95rem" lineHeight={1.55} color={theme.cardText} opacity={0.9}>{item.description}</FadingDescription>
// // //       )}
// // //       <div style={{ marginTop: 14, ...ctaPillStyle(theme) }}>{CTA_VIEW}</div>
...
// //  *   - MiniV3 title row: added marginBottom: 14 to separate title from description.
// //  *   - BigB1 title marginBottom: 10 → 30 (more space between title and description).
// //  *   - MiniV1 title marginBottom: 6 → 30 (more space between title and description).
// //  */
...
// /**
//  * VisualToolsPage v21 — file 1 of 3 (visualToolsCards.jsx)
//  *
//  * Change from v20:
//  *   - MiniV3 title row: minHeight ~2 lines so descriptions always start at the same vertical position
//  *     regardless of whether the title is one line or two.
//  *   - BigB1 title: minHeight ~2 lines for the same reason.
//  *   - MiniV1 title: minHeight ~2 lines for the same reason.
//  */
...
//       <div style={{ padding: '14px 18px 14px', display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
//         <h3 style={{
//           fontSize: '1.05rem', fontWeight: 600, margin: 0, marginBottom: 14,
...
//     <div style={{ padding: '22px 26px', display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
//       <h3 style={{
//         fontSize: '1.4rem', fontWeight: 600, margin: 0, marginBottom: 18,
//         color: theme.cardText, lineHeight: 1.3, flexShrink: 0,
...
/**
 * VisualToolsPage v22 — file 1 of 3 (visualToolsCards.jsx)
 *
 * Change from v21:
 *   - MiniV3 outer gap: 14 → 22 (more space between title row and description).
 */

...
// /**
//  * VisualToolsPage v24 — file 1 of 3 (visualToolsCards.jsx)
//  *
//  * Change from v23:
...
//   const svgSource =
//     isValidSvg(item && item.svg) ? item.svg
//       : (item && isValidSvg(item.icon) ? item.icon : null);
//   const showIcon = !svgSource && isValidIcon(item && item.icon);

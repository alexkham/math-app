  ...
  return (
    <div style={styles.card}>
      <div style={styles.cardHeader}>
        <h2 style={styles.cardTitle}>Variations with Repetition (3 items, 2 cells)</h2>
        <p style={styles.instructions}>
          Watch as we build variations with 3 items in 2 cells.<br />
...
export default VariationsVisualizer3x2;
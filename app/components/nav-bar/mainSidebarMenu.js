...
const CustomConvert=()=>(
  ...
  { id: 1, icon: CustomVisual, tooltip: 'Visual Tools', 
    content: [
        { text: 'Visual Base Converter', url: '/arithmetic/visual-tools/base-converter' },
        { text: 'Square Root Visualizer', url: '/visual-tools/square-root' },
        { text: 'Determinant Visual Calculator', url: '/linear-algebra/visual-tools/matrix-determinant' },
        { text: 'Gauss Elimination Calculator', url: '/linear-algebra/visual-tools/gauss-elimination' },
        { text: 'Matrix Multiplication Visualizer', url: '/visual-tools/matrix-multiplication' },
        // { text: 'Matric Transposition', url: '/linear-algebra/visual-tools/matrix-transpose' },
        ...
        { text: 'Angle Quadrants Visualizer', url: '/trigonometry/visual-tools/functions-signs' },
        { text: 'Matrix Types Generator', url: '/linear-algebra/visual-tools/matrix-types' },
        ...
        { text: 'Discrete Distributions Visualizer', url: '/probability/visual-tools/distributions/binomial' },
        { text: 'Continuous Distributions Visualizer', url: '/probability/visual-tools/distributions/normal' },
    ] },
  { id: 2, icon: CustomCalculator, tooltip: 'Calculators', content:[
    { text: 'Statistics Calculator', url: '/calculators/statistics-calculator' },
    { text: 'Probability Calculator', url: '/probability/calculators' },
    { text: 'Trigonometry Calculator', url: '/calculators/trigonometry-calculator' },
    { text: 'Quadratic Equations  Calculator', url: '/algebra/calculators/equations/quadratic' },
    { text: 'Root Calculator', url: '/calculators/root-calculator' },
    { text: 'Logarithm Calculator', url: '/calculators/log-calculator' },
    { text: 'Exponent Calculator', url: '/calculators/exponent-calculator' },
    { text: 'Factoring Calculator', url: '/algebra/calculators/factoring' },
    { text: 'Polynomial Calculator', url: '/algebra/calculators/polynomial' },
    ...
    { text: 'Conditional Probability Calculator', url: '/probability/calculators/conditional-probability' },
    { text: 'Joint Probability Calculator', url: '/probability/calculators/joint-probability' },
    { text: 'Linear Equations Solver', url: '/algebra/calculators/equations/linear' },
  ...
  { id: 3, icon: CustomTable, tooltip: 'Tables', 
    content:[ 
        { text: 'Probability Tables', url: '/tables' },
        { text: 'Arithmetics Tables', url: '/tables' },
        ...
        { text: 'Trigonometry Tables', url: '/tables' },

...
// import { useState, useEffect } from 'react'
// import { PermutationFull } from './PermutationsFull'
// import { PermutationWithIdentical } from './PermutationWithIdentical'
...
//     { id: 3, name: 'Permutation with Identical Items', component: PermutationWithIdentical, key: 'PermutationWithIdentical' },
...
//   const scenarios = [
//     { id: 1, name: 'Permutation (Full)', component: PermutationFull, key: 'PermutationFull' },
//     { id: 2, name: 'Permutation with Identical Items', component: PermutationWithIdentical, key: 'PermutationWithIdentical' },
//     { id: 3, name: 'Partial Permutation without Repetition', component: PermutationWithoutRepetition, key: 'PermutationWithoutRepetition' },
//     { id: 4, name: 'Permutation with Repetition', component: PermutationWithRepetition, key: 'PermutationWithRepetition' },
//     { id: 5, name: 'Circular Permutation', component: CircularPermutation, key: 'CircularPermutation' },
//     { id: 6, name: 'Simple Combination', component: Combination, key: 'Combination' },
//     { id: 7, name: 'Partition into Groups', component: PartitionIntoGroups, key: 'PartitionIntoGroups' },
//     { id: 8, name: 'Weak Composition', component: WeakComposition, key: 'WeakComposition' },
//     { id: 9, name: 'Strong Composition', component: StrongComposition, key: 'StrongComposition' },
//     { id: 10, name: 'Distribution into Cells', component: DistributionIntoCells, key: 'DistributionIntoCells' },
//   ]
...
export default function CombinatoricsCalculator({ explanations = {}, initialScenario = 1 }) {
  const [activeScenario, setActiveScenario] = useState(initialScenario)
  
  useEffect(() => {
    const validScenario = initialScenario >= 1 && initialScenario <= 10 ? initialScenario : 1

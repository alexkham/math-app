...
//   // Local calculation for reasonable sizes
//   const localPower = (base, exponent) => {
//     if (base < 0 || exponent < 0) return null
//     if (exponent === 0) return 1
//     if (base === 0) return 0
//     if (base === 1) return 1
...
//     if (rNum === 1) return { simplified: true, result: nNum }
...
//       // Use local calculation for reasonable sizes
//       const localResult = localPower(nNum, rNum)
//       if (localResult !== null) {
//         setResult({
//           n: nNum,
//           r: rNum,
...
//       const apiResult = await CombinatoricsAPI.calculate('permutation-with-repetition', { 
//         n: nNum, 
//         r: rNum 
//       })
//       setResult({

...
//   // Tick labels (every 2 for readability)
//   const ticks = [];
//   for (let i = -range; i <= range; i++) {
...
//         <span style={styles.subtitle}>Drag the point to explore z, z̄, and |z|</span>
//       </div>

//       <div style={styles.mainLayout}>
//         {/* Left column: plane + presets */}
...
//             {/* Mirror line (real axis highlight) */}
//             <line
//               x1={margin}
//               y1={oy}
//               x2={W - margin}
...
//             {/* Right triangle: conjugate */}
//             <line x1={reSvg.x} y1={reSvg.y} x2={conjSvg.x} y2={conjSvg.y} stroke="#f89838" strokeWidth="1.5" opacity="0.4" />

//             {/* Vector: origin → z */}
//             <line x1={originSvg.x} y1={originSvg.y} x2={zSvg.x} y2={zSvg.y} stroke="#304090" strokeWidth="2.5" />

//             {/* Vector: origin → conjugate */}
//             <line x1={originSvg.x} y1={originSvg.y} x2={conjSvg.x} y2={conjSvg.y} stroke="#f89838" strokeWidth="2.5" strokeDasharray="7,4" />

//             {/* Dashed vertical symmetry line between z and z̄ */}
//             <line x1={zSvg.x} y1={zSvg.y} x2={conjSvg.x} y2={conjSvg.y} stroke="#9060c0" strokeWidth="1" strokeDasharray="4,3" opacity="0.6" />

//             {/* Modulus label on the z vector */}
//             {modulus > 0.5 && (
//               <text
...
//                 onClick={() => {
//                   const re = clamp(Math.random() * 20 - 10);
//                   const im = clamp(Math.random() * 20 - 10);
//                   setZ({ re, im });
//                 }}
//                 onMouseEnter={(e) => { e.target.style.backgroundColor = '#e0ecff'; e.target.style.borderColor = palette.navy; }}
//                 onMouseLeave={(e) => { e.target.style.backgroundColor = palette.white; e.target.style.borderColor = palette.border; }}
...
//                 style={styles.numInput}
//               />
//               <span style={styles.limitHint}>limit: ±10</span>
//             </div>
//             {warning && (
//               <div style={styles.warningMsg}>Values greater than 10 (or less than −10) are not allowed. Input was clamped to ±10.</div>
//             )}
//           </div>
...
//             <div className="info-row" style={styles.infoRow}>
//               <span style={styles.infoKey}>z̄</span>
...
//             <div className="info-row" style={styles.infoRow}>
//               <span style={styles.infoKey}>z · z̄</span>
//               <span style={{ ...styles.infoVal, color: palette.green }}>
...
//                 z · z̄ = {fmtNum(z.re)}² + {fmtNum(Math.abs(z.im))}² = {fmtNum(Math.round((z.re * z.re) * 100) / 100)} + {fmtNum(Math.round((z.im * z.im) * 100) / 100)} = <strong style={{ color: palette.green }}>{fmtNum(Math.round(modulusSq * 100) / 100)}</strong>
//               </div>
//               <div style={styles.proofLine}>
//                 |z|² = ({fmtNum(Math.round(modulus * 1000) / 1000)})² = <strong style={{ color: palette.green }}>{fmtNum(Math.round(modulusSq * 100) / 100)}</strong>
//               </div>
...
//               <span>The <strong>conjugate</strong> z̄ reflects z across the real axis — same real part, negated imaginary part.</span>
//             </div>
//             <div style={styles.explainItem}>
//               <span style={{ ...styles.dot, backgroundColor: palette.blue }}></span>
//               <span>The <strong>modulus</strong> |z| is the distance from the origin. Both z and z̄ share the same modulus.</span>
//             </div>
//             <div style={styles.explainItem}>
//               <span style={{ ...styles.dot, backgroundColor: palette.green }}></span>
//               <span>Multiplying z · z̄ always gives a <strong>real number</strong> equal to |z|². This is why we multiply by the conjugate to rationalize complex denominators.</span>
//             </div>
//           </div>
...
//     marginTop: '4px',
//     paddingTop: '6px',
//     borderTop: `1px solid ${palette.green}30`,
//   },

...
// //         <p className={styles.explanationContent}>{currentExplanation.content}</p>
// //       </div>
// //     </div>
// //   );
// // }
...
//         return (
//           <div>
//             <p><strong>{op.name} {n1}/{d1} {op.symbol} {n2}/{d2}:</strong></p>
//             <p>Step 1: Find common denominator → {d1} × {d2} = {commonDen}</p>
//             <p>Step 2: Convert fractions:</p>
//             <p style={{paddingLeft: '20px'}}>• {n1}/{d1} = {newNum1}/{commonDen}</p>
//             <p style={{paddingLeft: '20px'}}>• {n2}/{d2} = {newNum2}/{commonDen}</p>
//             <p>Step 3: {fractionOp === 'add' ? 'Add' : 'Subtract'} numerators → {newNum1} {op.symbol} {newNum2} = {resultNum}</p>
//             <p>Step 4: Result = {resultNum}/{commonDen} (then simplify)</p>
//           </div>
//         );
...
//         return (
//           <div>
//             <p><strong>Dividing {n1}/{d1} ÷ {n2}/{d2}:</strong></p>
//             <p>Step 1: Flip second fraction → {d2}/{n2}</p>
//             <p>Step 2: Multiply → {n1}/{d1} × {d2}/{n2}</p>
//             <p>Step 3: Numerator → {n1} × {d2} = {resultNum}</p>
//             <p>Step 4: Denominator → {d1} × {n2} = {resultDen}</p>
//             <p>Step 5: Result = {resultNum}/{resultDen} (then simplify)</p>
//           </div>
//         );
//       }
//       break;
...
//           <p>Step 2: Multiply by 10^{decimalPlaces} → {num} × {denominator} = {numerator}</p>
//           <p>Step 3: Create fraction → {numerator}/{denominator}</p>
...
//           <p>Step 3: Convert to fraction → {numer}/{denom}</p>
//           <p>Step 4: Combine → {isNegative ? '-' : ''}{wholePart} {numer}/{denom} (then simplify)</p>
//         </div>
//       );
...
//       return (
//         <div>
//           <p><strong>Converting {n}/{d} to decimal:</strong></p>
...
//           <p>Step 1: Use formula 1/x</p>
//           <p>Step 2: Calculate → 1/{input1} = {inverseValue}</p>
...
//         return (
//           <div>
//             <p><strong>Converting {input1} to decimal:</strong></p>
//             <p>Step 1: Whole number part → {whole}</p>
//             <p>Step 2: Fraction part → {n}/{d} = {fracValue.toFixed(6)}</p>
...
//           <p style={{paddingLeft: '20px'}}>• {input1} = ({Math.abs(whole1)} × {den1Val} + {num1Val})/{den1Val} = {improper1}/{den1Val}</p>
//           <p style={{paddingLeft: '20px'}}>• {input2} = ({Math.abs(whole2)} × {den2Val} + {num2Val})/{den2Val} = {improper2}/{den2Val}</p>
...
//               <p style={{paddingLeft: '20px'}}>• {improper1}/{den1Val} = {improper1 * den2Val}/{den1Val * den2Val}</p>
//               <p style={{paddingLeft: '20px'}}>• {improper2}/{den2Val} = {improper2 * den1Val}/{den1Val * den2Val}</p>
...
//               <p>Step 5: Result = {operation === 'add_mixed' ? improper1 * den2Val + improper2 * den1Val : improper1 * den2Val - improper2 * den1Val}/{den1Val * den2Val} (then simplify)</p>
//             </>
...
//               <p>Step 4: Result = {improper1 * improper2}/{den1Val * den2Val} (then simplify)</p>
//             </>
//           ) : (
//             <>
//               <p>Step 2: Flip second fraction → {den2Val}/{improper2}</p>
//               <p>Step 3: Multiply → {improper1}/{den1Val} × {den2Val}/{improper2}</p>
//               <p>Step 4: Numerator → {improper1} × {den2Val} = {improper1 * den2Val}</p>
//               <p>Step 5: Denominator → {den1Val} × {improper2} = {den1Val * improper2}</p>
//               <p>Step 6: Result = {improper1 * den2Val}/{den1Val * improper2} (then simplify)</p>
//             </>
//           )}
//         </div>
//       );
...
// //       // Parse first number
// //       let whole1 = 0, num1Val = 0, den1Val = 1;
// //       const match1Mixed = input1.match(mixedPattern);
// //       const match1Frac = input1.match(fractionPattern);
...
// //       // Parse second number
// //       let whole2 = 0, num2Val = 0, den2Val = 1;
// //       const match2Mixed = input2.match(mixedPattern);
// //       const match2Frac = input2.match(fractionPattern);
...
// //       // Convert to improper fractions
// //       const improper1Num = whole1 * den1Val + num1Val;
// //       const improper2Num = whole2 * den2Val + num2Val;
...
// //       const op = opNames[operation];
      
// //       return (
// //         <div>
// //           <p><strong>{op.name} {input1} {op.symbol} {input2}:</strong></p>
// //           <p>Step 1: Convert to improper fractions</p>
// //           <p style={{paddingLeft: '20px'}}>• {input1} = ({whole1} × {den1Val} + {num1Val})/{den1Val} = {improper1Num}/{den1Val}</p>
// //           <p style={{paddingLeft: '20px'}}>• {input2} = ({whole2} × {den2Val} + {num2Val})/{den2Val} = {improper2Num}/{den2Val}</p>
// //           {operation === 'add_mixed' || operation === 'subtract_mixed' ? (
// //             <>
// //               <p>Step 2: Find common denominator → {den1Val} × {den2Val} = {den1Val * den2Val}</p>
// //               <p>Step 3: Convert fractions</p>
// //               <p style={{paddingLeft: '20px'}}>• {improper1Num}/{den1Val} = {improper1Num * den2Val}/{den1Val * den2Val}</p>
// //               <p style={{paddingLeft: '20px'}}>• {improper2Num}/{den2Val} = {improper2Num * den1Val}/{den1Val * den2Val}</p>
// //               <p>Step 4: {operation === 'add_mixed' ? 'Add' : 'Subtract'} numerators → {improper1Num * den2Val} {op.symbol} {improper2Num * den1Val}</p>
// //             </>
// //           ) : operation === 'multiply_mixed' ? (
// //             <>
// //               <p>Step 2: Multiply numerators → {improper1Num} × {improper2Num} = {improper1Num * improper2Num}</p>
// //               <p>Step 3: Multiply denominators → {den1Val} × {den2Val} = {den1Val * den2Val}</p>
// //               <p>Step 4: Result = {improper1Num * improper2Num}/{den1Val * den2Val}</p>
// //             </>
// //           ) : (
// //             <>
// //               <p>Step 2: Flip second fraction → {den2Val}/{improper2Num}</p>
// //               <p>Step 3: Multiply → {improper1Num}/{den1Val} × {den2Val}/{improper2Num}</p>
// //               <p>Step 4: Result = {improper1Num * den2Val}/{den1Val * improper2Num}</p>
// //             </>
// //           )}
// //           <p>Step {operation === 'multiply_mixed' || operation === 'divide_mixed' ? '5' : '5'}: Simplify and convert back to mixed number</p>
// //         </div>
// //       );
...
//   //       if (fractionOp === 'add' || fractionOp === 'subtract') {
//   //         const commonDen = parseInt(den1) * parseInt(den2);
//   //         const newNum1 = parseInt(num1) * parseInt(den2);
//   //         const newNum2 = parseInt(num2) * parseInt(den1);
//   //         const resultNum = fractionOp === 'add' ? newNum1 + newNum2 : newNum1 - newNum2;
          
//   //         return (
//   //           <div>
//   //             <p><strong>{op.name} {num1}/{den1} {op.symbol} {num2}/{den2}:</strong></p>
//   //             <p>Step 1: Find common denominator → {den1} × {den2} = {commonDen}</p>
//   //             <p>Step 2: Convert fractions:</p>
//   //             <p style={{paddingLeft: '20px'}}>• {num1}/{den1} = {newNum1}/{commonDen}</p>
//   //             <p style={{paddingLeft: '20px'}}>• {num2}/{den2} = {newNum2}/{commonDen}</p>
//   //             <p>Step 3: {fractionOp === 'add' ? 'Add' : 'Subtract'} numerators → {newNum1} {op.symbol} {newNum2} = {resultNum}</p>
//   //             <p>Step 4: Result = {resultNum}/{commonDen} (then simplify)</p>
//   //           </div>
//   //         );
//   //       } else if (fractionOp === 'multiply') {
//   //         const resultNum = parseInt(num1) * parseInt(num2);
//   //         const resultDen = parseInt(den1) * parseInt(den2);
          
//   //         return (
//   //           <div>
//   //             <p><strong>Multiplying {num1}/{den1} × {num2}/{den2}:</strong></p>
//   //             <p>Step 1: Multiply numerators → {num1} × {num2} = {resultNum}</p>
//   //             <p>Step 2: Multiply denominators → {den1} × {den2} = {resultDen}</p>
//   //             <p>Step 3: Result = {resultNum}/{resultDen} (then simplify)</p>
//   //           </div>
//   //         );
//   //       } else if (fractionOp === 'divide') {
//   //         const resultNum = parseInt(num1) * parseInt(den2);
//   //         const resultDen = parseInt(den1) * parseInt(num2);
          
//   //         return (
//   //           <div>
//   //             <p><strong>Dividing {num1}/{den1} ÷ {num2}/{den2}:</strong></p>
//   //             <p>Step 1: Flip second fraction → {den2}/{num2}</p>
//   //             <p>Step 2: Multiply → {num1}/{den1} × {den2}/{num2}</p>
//   //             <p>Step 3: Numerator → {num1} × {den2} = {resultNum}</p>
//   //             <p>Step 4: Denominator → {den1} × {num2} = {resultDen}</p>
//   //             <p>Step 5: Result = {resultNum}/{resultDen} (then simplify)</p>
//   //           </div>
//   //         );
//   //       }
...
//   //       const decimalResult = parseInt(num1) / parseInt(den1);
        
//   //       return (
//   //         <div>
//   //           <p><strong>Converting {num1}/{den1} to decimal:</strong></p>
//   //           <p>Step 1: Divide numerator by denominator</p>
//   //           <p>Step 2: {num1} ÷ {den1} = {decimalResult}</p>
//   //         </div>
//   //       );
...
//   //           <p>Step 1: Use formula 1/x</p>
//   //           <p>Step 2: Calculate → 1/{input1} = {inverseValue}</p>
//   //           <p>Step 3: Verify → {input1} × {inverseValue.toFixed(4)} ≈ 1</p>
//   //         </div>
//   //       );
...
//   //       const mixedPattern = /^(-?\d+)\s+(\d+)\/(\d+)$/;
//   //       const match = input1.match(mixedPattern);
...
//   //             <p><strong>Converting {input1} to decimal:</strong></p>
//   //             <p>Step 1: Whole number part → {whole}</p>
//   //             <p>Step 2: Fraction part → {n}/{d} = {fracValue.toFixed(4)}</p>
//   //             <p>Step 3: Add together → {whole} + {fracValue.toFixed(4)} = {total.toFixed(4)}</p>
//   //           </div>
//   //         );
//   //       }
//   //       return <p style={{color: '#64748b', fontStyle: 'italic'}}>Enter a mixed number (e.g., 1 1/2) to see steps</p>;
...
//   //       const opNames = {
//   //         add_mixed: 'Adding',
//   //         subtract_mixed: 'Subtracting',
//   //         multiply_mixed: 'Multiplying',
//   //         divide_mixed: 'Dividing'
//   //       };
        
//   //       return (
//   //         <div>
//   //           <p><strong>{opNames[operation]} {input1} and {input2}:</strong></p>
//   //           <p>Step 1: Convert to improper fractions</p>
//   //           <p>Step 2: Perform the operation</p>
//   //           <p>Step 3: Simplify the result</p>
//   //           <p>Step 4: Convert back to mixed number if needed</p>
//   //         </div>
//   //       );

...
// // const operations = [
// //   { name: 'Add', handler: (value) => handleScalarOperation('add', value) },
// //   { name: 'Subtract', handler: (value) => handleScalarOperation('subtract', value) },
// //   { name: 'Multiply', handler: (value) => handleScalarOperation('multiply', value) },
// //   { name: 'Transpose', handler: () => handleTranspose() }
// // ];


// const operations = [
//   { name: 'Add', handler: (value) => console.log('add', value) },
//   { name: 'Subtract', handler: (value) => console.log('subtract', value) }
// ];
...
//     // Update dimensions after matrix is set
//     setTimeout(() => setDimensions({ rows, cols }), 0);
//   };
...
//           case 'subtract': return cell - value;

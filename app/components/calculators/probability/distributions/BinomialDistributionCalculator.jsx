...
// // //       pmfValues.push({
// // //         k: k,
// // //         probability: binomialPMF(nVal, k, pVal)
// // //       });
// // //     }
...
// // //     const barWidth = Math.min(chartWidth / (n + 1), 30);
...
// // //         {pmf.map((item, i) => {
// // //           const barHeight = (item.probability / maxProb) * (chartHeight - 20);
...
// // //             Enter n (trials) and p (success probability)
// // //           </p>
// // //         </div>
...
//                     textAlign: 'center'
//                   }}>
//                     <div style={{ fontSize: '13px', color: '#718096', marginBottom: '5px' }}>q = 1 - p</div>
//                     <div style={{ fontSize: '24px', fontWeight: '700', color: '#245de1' }}>
//                       {results.q.toFixed(4)}
//                     </div>
//                   </div>
//                   <div style={{
...
//                     textAlign: 'center'
//                   }}>
//                     <div style={{ fontSize: '13px', color: '#718096', marginBottom: '5px' }}>Mean (μ)</div>
//                     <div style={{ fontSize: '24px', fontWeight: '700', color: '#245de1' }}>
//                       {results.mean.toFixed(4)}
//                     </div>
//                   </div>
...
//                     textAlign: 'center'
//                   }}>
//                     <div style={{ fontSize: '13px', color: '#718096', marginBottom: '5px' }}>Variance (σ²)</div>
//                     <div style={{ fontSize: '24px', fontWeight: '700', color: '#245de1' }}>
//                       {results.variance.toFixed(4)}
//                     </div>
//                   </div>
...
//                     textAlign: 'center'
//                   }}>
//                     <div style={{ fontSize: '13px', color: '#718096', marginBottom: '5px' }}>Std Dev (σ)</div>
//                     <div style={{ fontSize: '24px', fontWeight: '700', color: '#245de1' }}>
//                       {results.stdDev.toFixed(4)}
//                     </div>
//                   </div>
...
//                   </h3>
//                   <p style={{ margin: '3px 0', fontSize: '11px', color: '#2d3748', lineHeight: '1.4' }}>
//                     {processContent('$PMF: P(X = k) = C(n,k) × p^k × (1-p)^(n-k)$')}
//                   </p>
//                 </div>
//               )}
//             </div>

...
function FactorialCalculator({ explanations = factorialExplanations }) {
  ...
  return (
    <>
      ...
      {explanations && explanations[factorialType] && (
        <div className={styles.explanationContainer}>
          <div className={styles.explanationContent}>
            ...
            {explanations[factorialType].links && (
              <div className={styles.explanationLinks}>
                ...
                <ul className={styles.linksList}>
                  {explanations[factorialType].links.map((link, index) => (
                    <li key={index}>
            ...
            {explanations[factorialType].externalLinks && (
              <div className={styles.explanationLinks}>
                <p className={styles.linksTitle}>Learn more:</p>
                <ul className={styles.linksList}>
                  {explanations[factorialType].externalLinks.map((link, index) => (
                    <li key={index}>

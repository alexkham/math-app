...
const s = {
  ...
  threeColLayout: {
    display: 'grid',
    gridTemplateColumns: '220px 2fr 1fr',
    gap: '24px',
    alignItems: 'start',
  },
  leftPanel: {
  ...
  /* — sub-operation items in left panel — */
  opSubList: {
    display: 'flex',
    flexDirection: 'column',
    gap: '2px',
      ...
      <div style={step === 'input' ? s.mainWide : s.mainNarrow}>
        ...
        {step === 'input' && (
          <div style={s.threeColLayout}>
            ...
            {/* ▸ LEFT — category buttons + sub-operations */}
            <div style={s.leftPanel}>
              <div style={s.leftPanelTitle}>Category</div>
              {operationTypes.map((type) => (
                <div key={type.id}>
                  ...
                  {/* ── sub-operation list, only shown for active category ── */}
                    ...
                    <div style={s.opSubList}>
                      {getAvailableOperations().map((op) => {
                        ...
                        return (
                          <button
                            key={op}
                            onClick={() => !dis && handleOperationSelect(op)}
                            disabled={dis}
                            style={{
                              ...s.opSubItem,

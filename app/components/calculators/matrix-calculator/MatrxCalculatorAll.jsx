...
//     // Initialize matrices based on operation type
//     let matrixCount = 1;
//     if (operationType === 'two') matrixCount = 2;
//     if (operationType === 'system') matrixCount = 2; // A and B for Ax=B

//     const initialMatrices = Array(matrixCount).fill(null).map((_, index) => ({
//       id: index,
//       rows: dimensions.rows,
//       cols: operationType === 'system' && index === 1 ? 1 : dimensions.cols, // B vector for systems
//       data: new Array(dimensions.rows * (operationType === 'system' && index === 1 ? 1 : dimensions.cols)).fill('')
//     }));
...
//         {step === 'dimensions' && (
//           <div>
//             <h2 className={styles.stepTitle}>Set Matrix Dimensions</h2>
//             {errors.length > 0 && (
...
//               <div className={styles.dimensionsInputGroup}>
//                 <div className={styles.dimensionInput}>
//                   <label className={styles.dimensionLabel}>Rows:</label>
//                   <input
//                     type="number"
//                     min="1"
//                     max="10"
...
//                 </div>
//                 <div className={styles.dimensionInput}>
//                   <label className={styles.dimensionLabel}>Columns:</label>
//                   <input
//                     type="number"
//                     min="1"
//                     max="10"
...
//                 <div className={styles.dimensionConstraint}>
...
//         {/* Step 3: Matrix Input and Operations */}
//         {step === 'input' && (
//           <div>
